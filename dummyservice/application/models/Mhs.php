...
class Mhs extends CI_Model {
    ...
    function read($param){
        ...
        part_name_customs AS partcname,
        hs_code AS hscode,
        bm AS bm,
        cek_price AS cekprice,
        part_no2 AS partno2,
        kode_barang AS kodebarang,
        part_no_sap AS nosap,
        order_number AS ponumber,
        new_part AS newpart,
        shipment_term AS shipmentterm,
        supplier AS supp,
        supplier_kode AS suppcode,
        currency AS curr,
        part_name_added AS pnadd,
        jenis_tarif_bm AS jtrfbm,
        jenis_tarif_cukai AS jtrfcukai,
        kode_satuan_bm AS ksbm,
        kode_satuan_cukai AS kscukai,
        tarif_bm AS trfbm,
        tarif_cukai AS trfcukai,
        tarif_pph AS trfpph,
        tarif_ppn AS trfppn,
        tarif_ppnbm AS trfppnbm,
        create_date AS createdate,
        create_by AS createby,
        modify_date AS moddate,
        modify_by AS modby,
        uom AS uom        

            ",false);
        $this->db->from("mst_part_hs");
