<?php
class Mbcin_40 extends CI_Model {
    ...
    function read($param){
        ...
        $this->db->where("A.KODE_DOKUMEN_PABEAN='40'" );
    ...
    function proses_edit_item_dokumen ($param){
        $this->load->database();
        $this->db->select("
         A.*, (ISNULL(A.HARGA_PENYERAHAN,0) / ISNULL(A.JUMLAH_SATUAN,0)) AS HARGA_SATUAN
            ",false);
    ...
    function proses_update_bcin_40($param){
        $this->load->database();
