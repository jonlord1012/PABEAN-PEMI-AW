<?php
Class Mbcout_p3bet extends CI_Model {
    ...
    function read_dokumen_barang($param){
        ...
        $this->db->select('
        *,
        HARGAPENYERAHAN AS HARGA_PENYERAHAN,
        HARGAPEROLEHAN AS HARGA_PEROLEHAN,
        JUMLAHKEMASAN AS JUMLAH_KEMASAN,
        JUMLAHSATUAN AS JUMLAH_SATUAN,
        KODEKEMASAN AS KODE_KEMASAN,
        KODENEGARAASAL AS KODE_NEGARA_ASAL,
        KODESATUAN AS KODE_SATUAN_BARANG, 
        KODEASALBARANG AS KODE_ASAL_BARANG,
        NILAIBARANG AS NILAI_BARANG,
        NILAIJASA AS NILAI_JASA,
        TARIFCUKAI AS POS_TARIF,
        SPESIFIKASILAIN AS SPESIFIKASI_LAIN 
        ');
