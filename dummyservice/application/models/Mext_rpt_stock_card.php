<?php
class Mext_rpt_stock_card extends CI_Model
{
   ...
   {
      $this->load->database();
      $SQL_CALLSP = "EXEC SP_RPT_STOCK_CARD  '" . $param['VFROMDATE'] . "' , '" . $param['VTODATE'] . "' , '" . $param['VARTICLECODE'] . "' ;";
   ...
   function read_detail($param)
   {
      ...
      /*
      $SQL_CALLSP = "
         SELECT * FROM VW_TR_STOCK_CARD_DETAIL WHERE ARTICLE_CODE =  '" . $param['ARTICLE_CODE'] . "' 
         AND (LAST_IN_DATE BETWEEN '" . $param['VFROMDATE'] . "' AND  '" . $param['VTODATE'] . "' 
         OR LAST_OUT_DATE BETWEEN '" . $param['VFROMDATE'] . "' AND  '" . $param['VTODATE'] . "' )
         ; ";
         */
      $SQL_CALLSP = "EXEC SP_RPT_STOCK_CARD_DETAILS '" . $param['VFROMDATE'] . "' , '" . $param['VTODATE'] . "' , '" . $param['ARTICLE_CODE'] . "'  ; ";
      $result = $this->db->query($SQL_CALLSP);
      $row = $result->result_array();

      if (!($row)) {
         $sql = "SELECT *, '" . $param['VTODATE'] . "' as LAST_TRANS_DATE FROM VW_TR_STOCK_CARD_DETAILS WHERE ARTICLE_CODE = '" . $param['ARTICLE_CODE'] . "' ; ";
