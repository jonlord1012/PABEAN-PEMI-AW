<?php
class Mmaster_negara extends CI_Model {
    ...
    function definition(){
        $model1= array(
            ...
            'definition'=>array(
                array('name'=>'idnegara','dbname'=> 'id_negara','type'=> 'bigint','max_length'=>'' ,'nullable'=> false,'format'=> ''),
                array('name'=>'ccode','dbname'=> 'country_code','type'=> 'varchar','max_length'=> 50,'nullable'=> false,'format'=> ''),
