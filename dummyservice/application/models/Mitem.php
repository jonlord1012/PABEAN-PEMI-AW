...
class Mitem extends CI_Model {
    ...
    function create($param){
        ...
        $this->db->insert('njc.mst_suppliers', array_filter($vinput));
    ...
    function update($param){
        ...
        $this->db->update('njc.mst_suppliers', array_filter($vinput));
    ...
    function delete($param){
        ...
        $this->db->where('mst_supplier_customer_id', $vform["mst_supplier_customer_id"]);
        $this->db->delete('njc.mst_suppliers');
