<?php
class Mjenis_dokumen extends CI_Model {
    ...
    function read($param){
        ...
        URAIAN_DOKUMEN,
            ",false);
        $this->db->from("referensi_dokumen");
    ...
    function create($param){
        ...
        $this->db->insert('mst_tarif', array_filter($vinput));
    ...
    function update($param){
        ...
        $this->db->update('mst_tarif', array_filter($vinput));
    ...
    function definition(){
        $model1= array(
            ...
            'definition'=>array(
                array('name'=>'KODE_DOKUMEN','dbname'=> 'KODE_DOKUMEN','type'=> 'bigint','max_length'=>'' ,'nullable'=> false,'format'=> ''),
                array('name'=>'TIPE_DOKUMEN','dbname'=> 'TIPE_DOKUMEN','type'=> 'varchar','max_length'=> 50,'nullable'=> false,'format'=> ''),
                array('name'=>'URAIAN_DOKUMEN','dbname'=> 'URAIAN_DOKUMEN','type'=> 'varchar','max_length'=> 150,'nullable'=> true,'format'=> ''),
