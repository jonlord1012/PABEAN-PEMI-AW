<?php
class Mreferensi_negara extends CI_Model {
    ...
    function read($param){
        ...
        *
            ",false);
        $this->db->from("dbo.referensi_negara");
    ...
    function create($param){
        ...
        $this->db->insert('dbo.mst_tarif', array_filter($vinput));
    ...
    function update($param){
        ...
        $this->db->update('dbo.mst_tarif', array_filter($vinput));
    ...
    function delete($param){
        ...
        $this->db->delete('dbo.referensi_negara');
    ...
    function definition(){
        $model1= array(
            'TableName'=>'referensi_negara',
            'definition'=>array(
                array('name'=>'country_code2','dbname'=> 'country_code2','type'=> 'bigint','max_length'=>'' ,'nullable'=> false,'format'=> ''),
                array('name'=>'country_name2','dbname'=> 'country_name2','type'=> 'varchar','max_length'=> 50,'nullable'=> false,'format'=> ''),
                array('name'=>'country_code','dbname'=> 'country_code','type'=> 'varchar','max_length'=> 150,'nullable'=> true,'format'=> ''),
