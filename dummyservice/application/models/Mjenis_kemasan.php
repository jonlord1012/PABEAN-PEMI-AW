<?php
class Mjenis_kemasan extends CI_Model {
    ...
    function read($param){
        ...
        URAIAN_KEMASAN
            ",false);
        $this->db->from("njc.referensi_kemasan");
    ...
    function definition(){
        $model1= array(
            ...
            'definition'=>array(
                array('name'=>'KODE_KEMASAN','dbname'=> 'KODE_KEMASAN','type'=> 'bigint','max_length'=>'' ,'nullable'=> false,'format'=> ''),
                array('name'=>'URAIAN_KEMASAN','dbname'=> 'URAIAN_KEMASAN','type'=> 'varchar','max_length'=> 50,'nullable'=> false,'format'=> ''),
