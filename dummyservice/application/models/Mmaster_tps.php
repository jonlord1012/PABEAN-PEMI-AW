<?php
class Mmaster_tps extends CI_Model {
    ...
    function read($param){
      ...
      *
        ...
        $this->db->order_by("A.KODE_TPS", "ASC");
        $query = $this->db->get();
    ...
    function definition(){
        $model1= array(
            ...
            'definition'=>array(
                array('name'=>'KD_KANTOR','dbname'=> 'KD_KANTOR','type'=> 'bigint','max_length'=>'' ,'nullable'=> false,'format'=> ''),
                array('name'=>'KODE_TPS','dbname'=> 'KODE_TPS','type'=> 'varchar','max_length'=> 50,'nullable'=> false,'format'=> ''),
                array('name'=>'URAIAN_TPS','dbname'=> 'URAIAN_TPS','type'=> 'varchar','max_length'=> 150,'nullable'=> true,'format'=> ''),
