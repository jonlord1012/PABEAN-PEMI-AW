...
class PortalApiPlb extends MY_Controller
{
   ...
   public function __construct()
   {
      ...
      $this->idUser = "235043f0-b868-4509-b9bc-e54b8fc198f5";
   }
   ...
   public function login()
   {
      ...
      try {
         ...
         $request->setBody('{"username":"seiwabalaraja1", "password":"SINERGI@2024"}');
...
*/
   ...
   function getFileResponse($param)
   {
      ...
      if (isset($param)) {
         ...
         #die($noAju);
         $data = array("idUser" => '235043f0-b868-4509-b9bc-e54b8fc198f5', 'type' => 'download', 'filename' => $filename, "NOMORAJU" => $noAju,);
         if ($BCType === '27') {
            $url = "https://apis-gw.beacukai.go.id/excel-service/v1/ekspor-xml/Xlsx?idUser=235043f0-b868-4509-b9bc-e54b8fc198f5&nomorAju=" . $noAju;
         } else {
            $url = "https://apis-gw.beacukai.go.id/excel-service/v1/ekspor-xml/Xlsx?nomorAju=" . $noAju . "&idUser=" . $idUser;
         }
   ...
   function getAll27Docs($param)
   {
      ...
      if (isset($param)) {
         ...
         $url = "https://apis-gw.beacukai.go.id/v2/browse-service/v1/browse/dokumen-pabean-portal?nomorIdentitas=032959983008000&kodeJalur=&namaPerusahaan=&namaPpjk=&kodeKantor=&nomorAju=&nomorDaftar=&page=" . $page . "&size=30&idUser=235043f0-b868-4509-b9bc-e54b8fc198f5";
         #die($url);
