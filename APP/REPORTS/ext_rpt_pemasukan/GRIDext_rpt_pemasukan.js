Ext.define("TDK.REPORTS.ext_rpt_pemasukan.GRIDext_rpt_pemasukan", {
      ...
      store: {
        ...
        listeners: {
          beforeload: function (store, operation, eOpts) {
            try {
              var VIDCOMPANY = Ext.ComponentQuery.query("ext_rpt_pemasukan combobox[name=CBO_SOURCE]")[0];
              var VBCTYPE = Ext.ComponentQuery.query("ext_rpt_pemasukan combobox[name=CBO_BCTYPE]")[0];
