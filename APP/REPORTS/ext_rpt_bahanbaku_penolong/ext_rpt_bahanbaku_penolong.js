Ext.define("TDK.REPORTS.ext_rpt_bahanbaku_penolong.ext_rpt_bahanbaku_penolong", {
  extend: "Ext.form.Panel",
  alias: "widget.ext_rpt_bahanbaku_penolong",
  reference: "ext_rpt_bahanbaku_penolong",
  config: {},
  requires: ["TDK.REPORTS.ext_rpt_bahanbaku_penolong.Cext_rpt_bahanbaku_penolong", "TDK.REPORTS.ext_rpt_bahanbaku_penolong.GRIDext_rpt_bahanbaku_penolong"],
  constructor: function (config) {
    return this.callParent(arguments);
  },
  //untuk include controller
  controller: "Cext_rpt_bahanbaku_penolong",
  initComponent: function () {
    Ext.apply(this, {
      xtype: "panel",
      pid: "panelext_rpt_bahanbaku_penolong",
      layout: "card",
      frame: false,
      border: false,
      items: [{ xtype: "GRIDext_rpt_bahanbaku_penolong" }],
      dockedItems: [
        {
          xtype: "toolbar",
          dock: "top",
