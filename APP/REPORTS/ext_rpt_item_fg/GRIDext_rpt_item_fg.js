Ext.define("TDK.REPORTS.ext_rpt_item_fg.GRIDext_rpt_item_fg", {
  extend: "Ext.form.Panel",
  alias: "widget.GRIDext_rpt_item_fg",
  reference: "GRIDext_rpt_item_fg",
  frame: false,
  border: true,
  autoScroll: true,
  ...
  items: [
    {
      ...
      store: {
        ...
        proxy: {
          ...
          url: vconfig.service_api + "ext_rpt_item_fg/ext_rpt_item_fgs",
          extraParams: {
            method: "read_to_grid",
          },
          reader: {
        ...
        listeners: {
          beforeload: function (store, operation, eOpts) {
            try {
              var VIDCOMPANY = Ext.ComponentQuery.query("ext_rpt_item_fg combobox[name=CBO_SOURCE]")[0];
              var VFROMDATE = Ext.ComponentQuery.query("ext_rpt_item_fg datefield[name=tfromdate]")[0];
              var VTODATE = Ext.ComponentQuery.query("ext_rpt_item_fg datefield[name=ttodate]")[0];
