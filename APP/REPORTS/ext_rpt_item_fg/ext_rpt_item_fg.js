Ext.define("TDK.REPORTS.ext_rpt_item_fg.ext_rpt_item_fg", {
  extend: "Ext.form.Panel",
  alias: "widget.ext_rpt_item_fg",
  reference: "ext_rpt_item_fg",
  config: {},
  requires: ["TDK.REPORTS.ext_rpt_item_fg.Cext_rpt_item_fg", "TDK.REPORTS.ext_rpt_item_fg.GRIDext_rpt_item_fg"],
  constructor: function (config) {
    return this.callParent(arguments);
  },
  //untuk include controller
  controller: "Cext_rpt_item_fg",
  initComponent: function () {
    Ext.apply(this, {
      xtype: "panel",
      pid: "panelext_rpt_item_fg",
      layout: "card",
      frame: false,
      border: false,
      items: [{ xtype: "GRIDext_rpt_item_fg" }],
      dockedItems: [
        {
          xtype: "toolbar",
          dock: "top",
