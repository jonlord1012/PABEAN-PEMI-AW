Ext.define("TDK.REPORTS.int_rpt_pemasukan.int_rpt_pemasukan", {
  extend: "Ext.form.Panel",
  alias: "widget.int_rpt_pemasukan",
  reference: "int_rpt_pemasukan",
  config: {},
  requires: ["TDK.REPORTS.int_rpt_pemasukan.Cint_rpt_pemasukan", "TDK.REPORTS.int_rpt_pemasukan.GRIDint_rpt_pemasukan"],
