...
Ext.define("TDK.SYNCHRONIZE.sync_mat_wt.FRMsync_mat_wt_cancel", {
  extend: "Ext.window.Window",
  alias: "widget.FRMsync_mat_wt_cancel",
  reference: "FRMsync_mat_wt_cancel",
  title: "Proses Cancel Synchronize MAT WT",
  modal: true,
  closeAction: "destroy",
  centered: true,
  autoScroll: true,
  ...
  items: [
    {
      ...
      listeners: {
        afterrender: "GRIDsync_mat_wt_cancel_load",
      },
    },
  ],
});
