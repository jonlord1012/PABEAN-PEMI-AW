Ext.define("NJC.SYNCHRONIZE.sync_doc_aw.GRIDsync_doc_aw", {
  ...
  items: [
    {
      ...
      columns: [
        ...
        { sortable: true, flex: 1, filter: { xtype: "textfield" }, header: "VENDOR", dataIndex: "VENDOR" },
        { sortable: true, flex: 1, filter: { xtype: "textfield" }, header: "INVOICE_NO", dataIndex: "INVOICE_NO" },
        { sortable: true, flex: 1, filter: { xtype: "textfield" }, header: "INV DATE", dataIndex: "INVOICE_DATE" },
        { sortable: true, flex: 1, filter: { xtype: "textfield" }, header: "BC TYPE", dataIndex: "BC_TYPE" },
        { sortable: true, width: 300, filter: { xtype: "textfield" }, header: "NOMOR AJU", dataIndex: "NOMOR_AJU" },
        { sortable: true, flex: 1, filter: { xtype: "textfield" }, header: "TGL AJU", dataIndex: "TANGGAL_AJU" },
        { sortable: true, width: 200, filter: { xtype: "textfield" }, header: "NOMOR DAFTAR", dataIndex: "NOMOR_DAFTAR" },
        { sortable: true, flex: 1, filter: { xtype: "textfield" }, header: "TGL DAFTAR", dataIndex: "TANGGAL_DAFTAR" },
