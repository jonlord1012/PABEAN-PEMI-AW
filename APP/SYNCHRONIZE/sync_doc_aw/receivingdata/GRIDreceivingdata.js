Ext.define("NJC.SYNCHRONIZE.sync_doc_aw.receivingdata.GRIDreceivingdata", {
  extend: "Ext.form.Panel",
  alias: "widget.GRIDreceivingdata_aw",
  ...
  items: [
    {
      ...
      columns: [
        ...
        { header: "QTY INVOICE", dataIndex: "QTY_INVOICE", sortable: true, width: 100, align: "right", renderer: "formatqty", filter: { xtype: "textfield" } },
        { header: "QTY RECEIVED", dataIndex: "QTY_RECEIVED", sortable: true, width: 100, align: "right", renderer: "formatqty", filter: { xtype: "textfield" } },
        /*
    ...
    },
    {
      ...
      columns: [
        ...
        { header: "QTY RECEIVED", dataIndex: "QTY_RECEIVED", sortable: true, width: 100, filter: { xtype: "textfield" } },
