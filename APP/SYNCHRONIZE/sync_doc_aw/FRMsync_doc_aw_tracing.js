...
Ext.define("NJC.SYNCHRONIZE.sync_doc_aw.FRMsync_doc_aw_tracing", {
  extend: "Ext.window.Window",
  alias: "widget.FRMsync_doc_aw_tracing",
  reference: "FRMsync_doc_aw_tracing",
                ...
                data: {
                  ...
                  children: [
                    ...
                    },
                    {
                      text: "<b>Receiving</b>",
                      expanded: true,
                      children: [{ leaf: true, text: "Get Data Receiving", icon: vconfig.getstyle + "icon/doc.png", allowclick: true, controlname: "receivingdata", modulename: "receivingdata" }],
                    },
                  ],
                },
              },
              listeners: {
                itemclick: "FRMsync_doc_aw_tracing_linkclick",
              },
            },
          ],
        },
  ...
  dockedItems: [
    {
      ...
      items: [
        ...
        { xtype: "button", pid: "btget_from_ceisa", text: "Mapp This Document", icon: vconfig.getstyle + "icon/database.ico", tooltip: "Mapp This Document" },
        { xtype: "component", html: "***" },
        //batas,
      ],
      // other options....
  ...
  listeners: {
    afterrender: "FRMsync_doc_aw_load",
  },
});
