Ext.define("NJC.SYNCHRONIZE.sync_doc_aw.dokumen_draft.Cdokumen_draft", {
  extend: "Ext.app.ViewController",
  alias: "controller.Cdokumen_draft",
  init: function (view) {
    this.control({
      "aw_dokumen_draft button[pid=btsearch]": { click: this.btsearch_click },
      "aw_dokumen_draft button[pid=btsearch_invoice]": { click: this.btsearch_invoice_click },
      "aw_dokumen_draft button[pid=bttambah_dokumen]": { click: this.bttambah_dokumen_click },

      "aw_dokumen_draft combobox[name=CBO_BC]": { select: this.CBO_BC_select },
      "aw_dokumen_draft button[pid=btsavedokumendraft]": { click: this.btsavedokumendraft_click },
  ...
  btsearch_click: function (btn) {
    try {
      ...
      var popup = Ext.define("TDK.SYNCHRONIZE.sync_doc_aw.dokumen_draft.popup_btsearch", {
  ...
  btsearch_invoice_click: function () {
    try {
      ...
      var mainpanel = Ext.ComponentQuery.query("mainpage")[0];
      var popup = Ext.define("NJC.SYNCHRONIZE.sync_doc_aw.dokumen_draft.popup_invoice", {
        extend: "Ext.window.Window",
  ...
  bttambah_dokumen_click: function () {
    try {
      ...
      var mainpanel = Ext.ComponentQuery.query("mainpage")[0];
      var popup = Ext.define("NJC.SYNCHRONIZE.sync_doc_aw.dokumen_draft.popup_btadddokumen", {
        extend: "Ext.window.Window",
  ...
  CBO_BC_select: function (cmp, rec) {
    try {
      var tbpanel = Ext.ComponentQuery.query("aw_dokumen_draft FRMdokumen_draft tabpanel[pid=tabpanel_dokumendraft]")[0];
  ...
  awFRMdokumen_draft_load: function (FRM) {
    try {
      FRM.getForm().reset();
