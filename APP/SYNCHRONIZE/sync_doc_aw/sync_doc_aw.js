Ext.define("NJC.SYNCHRONIZE.sync_doc_aw.sync_doc_aw", {
  extend: "Ext.form.Panel",
  alias: "widget.sync_doc_aw",
  reference: "sync_doc_aw",
  config: {},
  requires: ["NJC.SYNCHRONIZE.sync_doc_aw.GRIDsync_doc_aw", "NJC.SYNCHRONIZE.sync_doc_aw.Csync_doc_aw"],
  ...
  initComponent: function () {
    Ext.apply(this, {
      xtype: "panel",
      pid: "panelsync_doc_aw",
      layout: "card",
      frame: false,
      border: false,
      items: [{ xtype: "GRIDsync_doc_aw" }],
      dockedItems: [
        {
          xtype: "toolbar",
          dock: "top",
          items: [
            ...
            "-",
            { xtype: "button", text: "Invoice AW", pid: "btprocess_sync", icon: vconfig.getstyle + "icon/table_refresh.png", tooltip: "Sinkronisasi Data AW" },
            "-",
            { xtype: "button", text: "Data Portal", pid: "btprocess_syncportal", icon: vconfig.getstyle + "icon/replace.ico", tooltip: "Sinkronisasi dari Portal" },
            "->",
            {
              xtype: "button",
              text: "Export to",
