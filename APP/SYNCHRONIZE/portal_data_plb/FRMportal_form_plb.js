...
Ext.define("NJC.SYNCHRONIZE.portal_data_plb.FRMportal_form_plb", {
   extend: "Ext.window.Window",
   alias: "widget.FRMportal_form_plb",
   pid: "FRMportal_form_plb",
   ...
   items: [
      {
         ...
         store: {
            ...
            proxy: {
               ...
               url: vconfig.service_portalplb + "main/testBrowse",
               extraParams: {
                  method: "read",
               },
               reader: {
