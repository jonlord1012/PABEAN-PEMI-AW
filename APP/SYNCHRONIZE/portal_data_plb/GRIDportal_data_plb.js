Ext.define("NJC.SYNCHRONIZE.portal_data_plb.GRIDportal_data_plb", {
  extend: "Ext.form.Panel",
  alias: "widget.GRIDportal_data_plb",
  reference: "GRIDportal_data_plb",
  ...
  items: [
    {
      ...
      store: {
        ...
        listeners: {
          beforeload: function (store, operation, eOpts) {
            try {
              var CBO_FILTERKEY = Ext.ComponentQuery.query("portal_data_plb combobox[name=CBO_FILTERKEY]")[0];
              operation.setParams({
      ...
      columns: [
        ...
        { sortable: true, width: 180, filter: { xtype: "textfield" }, header: "VENDOR", dataIndex: "VENDOR" },
