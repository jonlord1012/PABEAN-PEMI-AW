Ext.define("NJC.SYNCHRONIZE.portal_data.mapping_itempart.Cmapping_itempart", {
  ...
  btpilihpart_mapping: function (grid, rowIndex) {
    try {
      ...
      var popup = Ext.define("NJC.SYNCHRONIZE.portal_data.mapping_itempart.popup_selectpart", {
