Ext.define("NJC.SYNCHRONIZE.portal_data_plb.mappingdata.GRIDmappingdata", {
  ...
  items: [
    {
      ...
      store: {
        ...
        proxy: {
          ...
          extraParams: {
            method: "read_mappingdata_supplier_plb",
            module: "aw",
          },
          reader: {
            type: "json",
      ...
      columns: [
        ...
        { header: "INVOICE_DATE", dataIndex: "INVOICE_DATE", sortable: true, width: 100, renderer: "formatDate" },
    ...
    { xtype: "tbspacer", height: 5 },
    {
      ...
      store: {
        ...
        proxy: {
          ...
          url: vconfig.service_api + "portal_data/portal_datas",
          extraParams: {
            method: "read_mappingdata_part_plb",
            module: "aw",
          },
          reader: {
            type: "json",
