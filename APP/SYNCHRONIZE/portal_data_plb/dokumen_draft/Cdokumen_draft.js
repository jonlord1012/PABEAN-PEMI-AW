Ext.define("NJC.SYNCHRONIZE.portal_data.dokumen_draft.Cdokumen_draft", {
  extend: "Ext.app.ViewController",
  alias: "controller.Cdokumen_draft",
  init: function (view) {
    this.control({
      "coo_dokumen_draft button[pid=btsearch]": { click: this.btsearch_click },
      "coo_dokumen_draft button[pid=btsearch_invoice]": { click: this.btsearch_invoice_click },
      "coo_dokumen_draft button[pid=bttambah_dokumen]": { click: this.bttambah_dokumen_click },

      "coo_dokumen_draft combobox[name=CBO_BC]": { select: this.CBO_BC_select },
      "coo_dokumen_draft button[pid=btsavedokumendraft]": { click: this.btsavedokumendraft_click },
  ...
  btsearch_click: function (btn) {
    try {
      ...
      var popup = Ext.define("NJC.SYNCHRONIZE.portal_data.dokumen_draft.popup_btsearch", {
            ...
            listeners: {
              itemdblclick: function (grid, rec) {
                switch (btn.vdata.modulename) {
                  case "supplier":
                    var FRM = Ext.ComponentQuery.query("coo_dokumen_draft FRMdokumen_draft")[0];
  ...
  btsearch_invoice_click: function () {
    try {
      ...
      var mainpanel = Ext.ComponentQuery.query("mainpage")[0];
      var popup = Ext.define("NJC.SYNCHRONIZE.portal_data.dokumen_draft.popup_invoice", {
        extend: "Ext.window.Window",
        ...
        items: [
          {
            ...
            columns: [
              ...
              { header: "TRANSPORT WAY", dataIndex: "TRANSPORT_WAY", sortable: true, width: 100, filter: { xtype: "textfield" } },
            ],
  ...
  btselect_invoice_draft_click: function () {
    try {
      ...
      var FRM = Ext.ComponentQuery.query("coo_dokumen_draft FRMdokumen_draft")[0];
      var GRIDsumberdata = Ext.ComponentQuery.query("coo_dokumen_draft FRMdokumen_draft grid[pid=GRIDsumberdata]")[0];
      var GRIDinvoicedata = Ext.ComponentQuery.query("coo_dokumen_draft FRMdokumen_draft grid[pid=GRIDinvoice_dokumen_draft]")[0];
      var GRIDhasilgenerate = Ext.ComponentQuery.query("coo_dokumen_draft FRMdokumen_draft grid[pid=GRIDhasilgenerate]")[0];
      var MAIN_dtval = FRM.getValues(false, false, false, true);
      ...
      var params = Ext.encode({
        method: "SP_COO_DRAFT_SELECT_INVOICE",
        module: "coo",
  ...
  bttambah_dokumen_click: function () {
    try {
      ...
      var griddokumen = Ext.ComponentQuery.query("coo_dokumen_draft FRMdokumen_draft grid[pid=GRIDinvoice_dokumen_draft]")[0];
      ...
      var mainpanel = Ext.ComponentQuery.query("mainpage")[0];
      var popup = Ext.define("NJC.SYNCHRONIZE.portal_data.dokumen_draft.popup_btadddokumen", {
        extend: "Ext.window.Window",
  ...
  CBO_BC_select: function (cmp, rec) {
    try {
      var tbpanel = Ext.ComponentQuery.query("coo_dokumen_draft FRMdokumen_draft tabpanel[pid=tabpanel_dokumendraft]")[0];
      var panel_bc_custom = Ext.ComponentQuery.query("coo_dokumen_draft FRMdokumen_draft container[pid=BC_CUSTOM]")[0];
      var arrbc = ["23 Kurir", "20 Kurir", "271"];
      if (arrbc.find((e) => e === rec.data.DEFCODE)) {
        tbpanel.items.getAt(1).setDisabled(true);
        var panel_bc_custom = Ext.ComponentQuery.query("coo_dokumen_draft FRMdokumen_draft [pid=BC_CUSTOM]");
  ...
  btsavedokumendraft_click: function () {
    try {
      var me = this;
      var popup = Ext.ComponentQuery.query("plb_dokumen_draft")[0];
      var FRM = Ext.ComponentQuery.query("plb_dokumen_draft FRMdokumen_draft")[0];
      ...
      var griddokumen = Ext.ComponentQuery.query("plb_dokumen_draft FRMdokumen_draft grid[pid=GRIDinvoice_dokumen_draft]")[0];
      var GRIDdokumen_draft_kontainer = Ext.ComponentQuery.query("plb_dokumen_draft FRMdokumen_draft grid[pid=GRIDdokumen_draft_kontainer]")[0];
      ...
      var GRIDdokumen_draft_kemasan = Ext.ComponentQuery.query("coo_dokumen_draft FRMdokumen_draft grid[pid=GRIDdokumen_draft_kemasan]")[0];
      var vdraft_kemasan = [];
      ...
      /*
      var gridinvoicedata = Ext.ComponentQuery.query("coo_dokumen_draft FRMdokumen_draft grid[pid=GRIDsumberdata]")[0];
  ...
  btsavedokumendraft_click: function () {
    try {
      var me = this;
      var popup = Ext.ComponentQuery.query("aw_dokumen_draft")[0];
      ...
      var GRIDdokumen_draft_kontainer = Ext.ComponentQuery.query("aw_dokumen_draft FRMdokumen_draft grid[pid=GRIDdokumen_draft_kontainer]")[0];
      var vdraft_kontainer = [];
      GRIDdokumen_draft_kontainer.getStore()
        .getDataSource()
        .each(function (record, index, count) {
      ...
      var GRIDdokumen_draft_kemasan = Ext.ComponentQuery.query("aw_dokumen_draft FRMdokumen_draft grid[pid=GRIDdokumen_draft_kemasan]")[0];
      var vdraft_kemasan = [];
      GRIDdokumen_draft_kemasan.getStore()
        .getDataSource()
        .each(function (record, index, count) {
      ...
      var griddokumen = Ext.ComponentQuery.query("aw_dokumen_draft FRMdokumen_draft grid[pid=GRIDinvoice_dokumen_draft]")[0];
