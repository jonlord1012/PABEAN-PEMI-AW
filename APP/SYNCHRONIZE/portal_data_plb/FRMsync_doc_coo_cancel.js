...
Ext.define("NJC.SYNCHRONIZE.portal_data_plb.FRMsync_doc_coo_cancel", {
  extend: "Ext.window.Window",
  alias: "widget.FRMsync_doc_coo_cancel",
  reference: "FRMsync_doc_coo_cancel",
  title: "Proses Cancel Synchronize COO",
  modal: true,
  closeAction: "destroy",
  centered: true,
  autoScroll: false,
  ...
  items: [
    {
      ...
      listeners: {
        afterrender: "GRIDsync_doc_coo_cancel_load",
      },
    },
  ],
});
