Ext.define("NJC.SYNCHRONIZE.portal_data_plb.dokumenpabean.dokumenpabean_detail", {
  extend: "Ext.form.Panel",
  alias: "widget.dokumenpabean_detail_plb",
  reference: "dokumenpabean_detail_plb",
  frame: false,
  border: true,
  autoScroll: false,
  closeAction: "destroy",
  layout: { type: "vbox", pack: "start", align: "stretch" },
  requires: ["NJC.SYNCHRONIZE.portal_data_plb.dokumenpabean.Cdokumenpabean_plb"],
  controller: "Cdokumenpabean_plb",
  fieldDefaults: {
    labelAlign: "left",
    labelWidth: 90,
    margin: "0 10 5 0",
