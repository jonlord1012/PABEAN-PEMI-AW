...
Ext.define("NJC.SYNCHRONIZE.portal_data_plb.FRMsync_doc_coo_mapping_itempart", {
  extend: "Ext.window.Window",
  alias: "widget.FRMsync_doc_coo_mapping_itempart",
  reference: "FRMsync_doc_coo_mapping_itempart",
  ...
  items: [
    {
      xtype: "grid",
      pid: "GRID_FRMsync_doc_coo_mapping_itempart",
      ...
      listeners: {
        afterrender: "GRID_FRMsync_doc_coo_mapping_itempart_load",
      },
    },
  ],
  dockedItems: [
