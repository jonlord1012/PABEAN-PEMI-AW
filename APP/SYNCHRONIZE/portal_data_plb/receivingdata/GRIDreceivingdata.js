Ext.define("NJC.SYNCHRONIZE.portal_data_plb.receivingdata.GRIDreceivingdata", {
  ...
  items: [
    {
      ...
      columns: [
        ...
        { header: "TRANS NO", dataIndex: "TRANS_NO", sortable: true, width: 200 },
        { header: "TRANS DATE", dataIndex: "TRANS_DATE", sortable: true, width: 100, renderer: "formatDate" },
        { header: "INVOICE NO", dataIndex: "INVOICE_NO", sortable: true, width: 100 },
        { header: "ARTICLE CODE", dataIndex: "ARTICLE_CODE", sortable: true, width: 100 },
        /*
    ...
    },
    {
      ...
      columns: [
        ...
        { header: "INVOICE NO", dataIndex: "INVOICE_NO", sortable: true, width: 100 },
        { header: "ARTICLE CODE", dataIndex: "ARTICLE_CODE", sortable: true, width: 100 },
        { header: "PARTNO", dataIndex: "PART_NO", sortable: true, width: 150 },
        { header: "LOT NO", dataIndex: "LOT_NO", sortable: true, width: 150 },
        { header: "QTY RECEIVED", dataIndex: "QTY_RECEIVED", sortable: true, width: 100 },
        { header: "QTY INVOICE", dataIndex: "QTY_INVOICE", sortable: true, width: 100 },
        { header: "RECEIVED RACK", dataIndex: "CURRENT_RACK", sortable: true, width: 200 },
        /*
