Ext.define("TDK.SYNCHRONIZE.sync_doc_sa.dokumen_detail.dokumen_detail_sp_invoice", {
  extend: "Ext.form.Panel",
  alias: "widget.dokumen_detail_sp_invoice",
  reference: "dokumen_detail_sp_invoice",
  frame: false,
  border: true,
  autoScroll: true,
  ...
  items: [
    {
      xtype: "grid",
      pid: "GRIDdokumen_detail_sp_inventory",
