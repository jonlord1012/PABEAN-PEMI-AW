Ext.define("TDK.SYNCHRONIZE.sync_doc_sa.dokumen_detail.dokumen_detail_wp_produksi", {
  extend: "Ext.form.Panel",
  alias: "widget.dokumen_detail_wp_produksi",
  reference: "dokumen_detail_wp_produksi",
  frame: false,
  border: true,
  autoScroll: true,
  ...
  items: [
    {
      xtype: "grid",
      pid: "GRIDdokumen_detail_wp_produksi",
