Ext.define("TDK.SYNCHRONIZE.sync_doc_sa.GRIDsync_doc_sa", {
  extend: "Ext.form.Panel",
  alias: "widget.GRIDsync_doc_sa",
  reference: "GRIDsync_doc_sa",
      ...
      store: {
        ...
        listeners: {
          beforeload: function (store, operation, eOpts) {
            try {
              var CBO_FILTERKEY = Ext.ComponentQuery.query("sync_doc_sa combobox[name=CBO_FILTERKEY]")[0];
              operation.setParams({
