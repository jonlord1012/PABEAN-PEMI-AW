Ext.define("TDK.SYNCHRONIZE.sync_doc_sa.sa_dokumen_draft.Csa_dokumen_draft", {
  ...
  btsearch_click: function (btn) {
    try {
      ...
      var popup = Ext.define("TDK.SYNCHRONIZE.sync_doc_sa.sa_dokumen_draft.popup_btsearch", {
  ...
  btsearch_invoice_click: function () {
    try {
      ...
      var mainpanel = Ext.ComponentQuery.query("mainpage")[0];
      var popup = Ext.define("TDK.SYNCHRONIZE.sync_doc_sa.sa_dokumen_draft.popup_invoice", {
        extend: "Ext.window.Window",
  ...
  bttambah_dokumen_click: function () {
    try {
      ...
      var mainpanel = Ext.ComponentQuery.query("mainpage")[0];
      var popup = Ext.define("TDK.SYNCHRONIZE.sync_doc_sa.sa_dokumen_draft.popup_btadddokumen", {
        extend: "Ext.window.Window",
