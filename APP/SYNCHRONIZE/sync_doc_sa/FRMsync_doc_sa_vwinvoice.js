...
Ext.define("TDK.SYNCHRONIZE.sync_doc_sa.FRMsync_doc_sa_vwinvoice", {
  extend: "Ext.window.Window",
  alias: "widget.FRMsync_doc_sa_vwinvoice",
  reference: "FRMsync_doc_sa_vwinvoice",
      ...
      store: {
        ...
        listeners: {
          beforeload: function (store, operation, eOpts) {
            try {
              var CBO_PERIOD = Ext.ComponentQuery.query("FRMsync_doc_sa_vwinvoice combobox[name=CBO_PERIOD]")[0];
              operation.setParams({
