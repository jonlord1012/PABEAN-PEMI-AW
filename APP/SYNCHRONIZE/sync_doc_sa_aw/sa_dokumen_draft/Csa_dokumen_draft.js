Ext.define("TDK.SYNCHRONIZE.sync_doc_sa_aw.sa_dokumen_draft.Csa_dokumen_draft", {
  extend: "Ext.app.ViewController",
  alias: "controller.Csa_dokumen_draft",
  init: function (view) {
    this.control({
      "sa_dokumen_draft button[pid=btsearch]": { click: this.btsearch_click },
      "sa_dokumen_draft button[pid=btsearch_invoice]": { click: this.btsearch_invoice_click },
      "sa_dokumen_draft button[pid=bttambah_dokumen]": { click: this.bttambah_dokumen_click },

      "sa_dokumen_draft combobox[name=CBO_BC]": { select: this.CBO_BC_select },
      "sa_dokumen_draft button[pid=btsavedokumendraft]": { click: this.btsavedokumendraft_click },
  ...
  btsearch_click: function (btn) {
    try {
      ...
      var popup = Ext.define("TDK.SYNCHRONIZE.sync_doc_sa_aw.sa_dokumen_draft.popup_btsearch", {
            ...
            listeners: {
              itemdblclick: function (grid, rec) {
                switch (btn.vdata.modulename) {
                  case "supplier":
                    var FRM = Ext.ComponentQuery.query("sa_dokumen_draft FRMsa_dokumen_draft")[0];
  ...
  btsearch_invoice_click: function () {
    try {
      ...
      var mainpanel = Ext.ComponentQuery.query("mainpage")[0];
      var popup = Ext.define("TDK.SYNCHRONIZE.sync_doc_sa_aw.sa_dokumen_draft.popup_invoice", {
        extend: "Ext.window.Window",
  ...
  btselect_invoice_draft_click: function () {
    try {
      ...
      var FRM = Ext.ComponentQuery.query("sa_dokumen_draft FRMsa_dokumen_draft")[0];
      var GRIDsumberdata = Ext.ComponentQuery.query("sa_dokumen_draft FRMsa_dokumen_draft grid[pid=GRIDsumberdata]")[0];
      var GRIDinvoicedata = Ext.ComponentQuery.query("sa_dokumen_draft FRMsa_dokumen_draft grid[pid=GRIDinvoice_dokumen_draft]")[0];
      var GRIDhasilgenerate = Ext.ComponentQuery.query("sa_dokumen_draft FRMsa_dokumen_draft grid[pid=GRIDhasilgenerate]")[0];
      var MAIN_dtval = FRM.getValues(false, false, false, true);
      ...
      var params = Ext.encode({
        method: "SP_SA_DRAFT_SELECT_INVOICE",
        module: "sa",
        invoice: Ext.encode(list_invoice),
        vendor: MAIN_dtval.KODE_INTERNAL,
      });
      var hasil = COMP.run.getservice(vconfig.service_api + "sync_doc_sa_aw/sync_doc_sa_aw", params, "POST", me.var_global.jwt);
  ...
  bttambah_dokumen_click: function () {
    try {
      ...
      var griddokumen = Ext.ComponentQuery.query("sa_dokumen_draft FRMsa_dokumen_draft grid[pid=GRIDinvoice_dokumen_draft]")[0];
      ...
      var mainpanel = Ext.ComponentQuery.query("mainpage")[0];
      var popup = Ext.define("TDK.SYNCHRONIZE.sync_doc_sa_aw.sa_dokumen_draft.popup_btadddokumen", {
        extend: "Ext.window.Window",
  ...
  CBO_BC_select: function (cmp, rec) {
    try {
      var tbpanel = Ext.ComponentQuery.query("sa_dokumen_draft FRMsa_dokumen_draft tabpanel[pid=tabpanel_dokumendraft]")[0];
      var panel_bc_custom = Ext.ComponentQuery.query("sa_dokumen_draft FRMsa_dokumen_draft container[pid=BC_CUSTOM]")[0];
      var arrbc = ["40", "271"];
      if (arrbc.find((e) => e === rec.data.DEFCODE)) {
        tbpanel.items.getAt(1).setDisabled(true);
        var panel_bc_custom = Ext.ComponentQuery.query("sa_dokumen_draft FRMsa_dokumen_draft [pid=BC_CUSTOM]");
  ...
  btsavedokumendraft_click: function () {
    try {
      var me = this;
      var popup = Ext.ComponentQuery.query("sa_dokumen_draft")[0];
      var FRM = Ext.ComponentQuery.query("sa_dokumen_draft FRMsa_dokumen_draft")[0];
      ...
      var griddokumen = Ext.ComponentQuery.query("sa_dokumen_draft FRMsa_dokumen_draft grid[pid=GRIDinvoice_dokumen_draft]")[0];
      var GRIDdokumen_draft_kontainer = Ext.ComponentQuery.query("sa_dokumen_draft FRMsa_dokumen_draft grid[pid=GRIDdokumen_draft_kontainer]")[0];
      ...
      var GRIDdokumen_draft_kemasan = Ext.ComponentQuery.query("sa_dokumen_draft FRMsa_dokumen_draft grid[pid=GRIDdokumen_draft_kemasan]")[0];
      var vdraft_kemasan = [];
  ...
  FRMsa_dokumen_draft_load: function (FRM) {
    try {
      FRM.getForm().reset();
