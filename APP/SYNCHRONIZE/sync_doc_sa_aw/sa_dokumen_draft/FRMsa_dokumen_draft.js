Ext.define("TDK.SYNCHRONIZE.sync_doc_sa_aw.sa_dokumen_draft.FRMsa_dokumen_draft", {
  extend: "Ext.form.Panel",
  alias: "widget.FRMsa_dokumen_draft",
  reference: "FRMsa_dokumen_draft",
  frame: false,
  border: true,
  autoScroll: true,
                    ...
                    /*{
                      ...
                      items: [
                        { xtype: "tbspacer", height: 5 },
                        {
                          xtype: "component",
                          pid: "BC_CUSTOM",
                          html: "<b>== Khusus BC40 dan BC271 ==</b>",
                        },
                        { xtype: "tbspacer", height: 5 },
                        {
                          xtype: "container",
                      ...
                      tbar: [
                        {
                          ...
                          handler: function () {
                            var GRID = Ext.ComponentQuery.query("sa_dokumen_draft FRMsa_dokumen_draft grid[pid=GRIDdokumen_draft_kontainer]")[0];
                            var rec = {
                          ...
                          editor: {
                            ...
                            listeners: {
                              select: function (cmp, rec) {
                                var GRID = Ext.ComponentQuery.query("sa_dokumen_draft FRMsa_dokumen_draft grid[pid=GRIDdokumen_draft_kemasan]")[0];
  ...
  listeners: {
    afterrender: "FRMsa_dokumen_draft_load",
  },
});
