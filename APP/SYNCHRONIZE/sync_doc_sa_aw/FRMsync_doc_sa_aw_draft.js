...
Ext.define("TDK.SYNCHRONIZE.sync_doc_sa_aw.FRMsync_doc_sa_aw_draft", {
  extend: "Ext.window.Window",
  alias: "widget.FRMsync_doc_sa_aw_draft",
  reference: "FRMsync_doc_sa_aw_draft",
  modal: true,
          ...
          store: {
            ...
            listeners: {
              beforeload: function (store, operation, eOpts) {
                try {
                  var vsano = Ext.ComponentQuery.query("FRMsync_doc_sa_aw_draft textfield[name=SANO]")[0];
                  operation.setParams({
                    method: "process_data",
              ...
              store: {
                ...
                listeners: {
                  ...
                  load: function (store, operation, eOpts) {
                    try {
                      var GRIDinvoice_item_impor = Ext.ComponentQuery.query("FRMsync_doc_sa_aw_draft grid[pid=GRIDinvoice_item_impor]")[0];
