...
Ext.define("TDK.SYNCHRONIZE.sync_fg_out.FRMsync_fg_out_cancel", {
  extend: "Ext.window.Window",
  alias: "widget.FRMsync_fg_out_cancel",
  reference: "FRMsync_fg_out_cancel",
  title: "Proses Cancel Synchronize FG OUT",
  modal: true,
  closeAction: "destroy",
  centered: true,
  autoScroll: true,
  ...
  items: [
    {
      ...
      listeners: {
        afterrender: "GRIDsync_fg_out_cancel_load",
      },
    },
  ],
});
