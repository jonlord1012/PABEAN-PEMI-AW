Ext.define("NJC.SYNCHRONIZE.portal_data.sumberdata.GRIDsumberdata", {
  ...
  items: [
    {
      ...
      columns: [
        ...
        { header: "INVOICE_DATE", dataIndex: "INVOICE_DATE", sortable: true, width: 100, filter: { xtype: "textfield" }, renderer: "formatDate" },
        { header: "BC TYPE", dataIndex: "BC_TYPE", sortable: true, width: 80, filter: { xtype: "textfield" } },
        { header: "TANGGAL AJU", dataIndex: "TANGGAL_AJU", sortable: true, width: 100, filter: { xtype: "textfield" }, renderer: "formatDate" },
        { header: "NOMOR DAFTAR", dataIndex: "NOMOR_DAFTAR", sortable: true, width: 100, filter: { xtype: "textfield" } },
        { header: "TANGGAL DAFTAR", dataIndex: "TANGGAL_DAFTAR", sortable: true, width: 100, filter: { xtype: "textfield" }, renderer: "formatDate" },
        { header: "KODE BARANG", dataIndex: "KODE_BARANG", sortable: true, width: 100, filter: { xtype: "textfield" } },
        { header: "JUMLAH SATUAN", dataIndex: "JUMLAH_SATUAN", sortable: true, width: 100, align: "right", renderer: "formatqty", filter: { xtype: "textfield" } },
