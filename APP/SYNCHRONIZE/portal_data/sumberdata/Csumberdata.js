Ext.define("NJC.SYNCHRONIZE.portal_data.sumberdata.Csumberdata", {
  ...
  btsumberdata_download: function (btn) {
    try {
      var GRIDINV = Ext.ComponentQuery.query("portal_data GRIDportal_data grid[pid=GRIDportal_data]")[0];
