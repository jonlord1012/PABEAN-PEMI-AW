Ext.define("NJC.SYNCHRONIZE.portal_data.mapping_supplier.Cmapping_supplier", {
  ...
  btpilihsupplier_mapping: function (grid, rowIndex) {
    try {
      ...
      var popup = Ext.define("NJC.SYNCHRONIZE.portal_data.mapping_supplier.popup_selectvendor", {
