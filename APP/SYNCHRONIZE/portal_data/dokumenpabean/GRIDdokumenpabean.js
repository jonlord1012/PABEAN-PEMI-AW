Ext.define("NJC.SYNCHRONIZE.sync_doc_coo.dokumenpabean.GRIDdokumenpabean", {
  ...
  items: [
    {
      ...
      columns: [
        ...
        { header: "TANGGAL_AJU", dataIndex: "TANGGAL_AJU", sortable: true, width: 150, renderer: "formatDate" },
        ...
        { header: "TANGGAL_DAFTAR", dataIndex: "TANGGAL_DAFTAR", sortable: true, width: 150, renderer: "formatDate" },
        ...
        { header: "TANGGAL_BC11", dataIndex: "TANGGAL_BC11", sortable: true, width: 150, renderer: "formatDate" },
        { header: "TANGGAL_BERANGKAT", dataIndex: "TANGGAL_BERANGKAT", sortable: true, width: 150, renderer: "formatDate" },
        { header: "TANGGAL_BILLING", dataIndex: "TANGGAL_BILLING", sortable: true, width: 150, renderer: "formatDate" },
        { header: "TANGGAL_IJIN_BPK_PEMASOK", dataIndex: "TANGGAL_IJIN_BPK_PEMASOK", sortable: true, width: 150, renderer: "formatDate" },
        { header: "TANGGAL_IJIN_BPK_PENGUSAHA", dataIndex: "TANGGAL_IJIN_BPK_PENGUSAHA", sortable: true, width: 150, renderer: "formatDate" },
        { header: "TANGGAL_IJIN_TPB", dataIndex: "TANGGAL_IJIN_TPB", sortable: true, width: 150, renderer: "formatDate" },
        { header: "TANGGAL_NPPPJK", dataIndex: "TANGGAL_NPPPJK", sortable: true, width: 150, renderer: "formatDate" },
        { header: "TANGGAL_TIBA", dataIndex: "TANGGAL_TIBA", sortable: true, width: 150, renderer: "formatDate" },
        { header: "TANGGAL_TTD", dataIndex: "TANGGAL_TTD", sortable: true, width: 150, renderer: "formatDate" },
        { header: "TGL_JATUH_TEMPO_BILLING", dataIndex: "TGL_JATUH_TEMPO_BILLING", sortable: true, width: 150, renderer: "formatDate" },
        ...
        { header: "TANGGAL_MUAT", dataIndex: "TANGGAL_MUAT", sortable: true, width: 150, renderer: "formatDate" },
        { header: "TEMPAT_STUFFING", dataIndex: "TEMPAT_STUFFING", sortable: true, width: 150, renderer: "formatDate" },
        ...
        { header: "TANGGAL_STUFFING", dataIndex: "TANGGAL_STUFFING", sortable: true, width: 150, renderer: "formatDate" },
