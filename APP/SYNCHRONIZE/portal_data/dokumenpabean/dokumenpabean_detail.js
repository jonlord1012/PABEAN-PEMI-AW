Ext.define("NJC.SYNCHRONIZE.portal_data.dokumenpabean.dokumenpabean_detail", {
  ...
  requires: ["NJC.SYNCHRONIZE.portal_data.dokumenpabean.Cdokumenpabean"],
  ...
  items: [
    {
      ...
      columns: [
        ...
        { sortable: true, width: 100, filter: { xtype: "textfield" }, header: "NDPBM", align: "right", renderer: "formatQty", dataIndex: "NDPBM" },
