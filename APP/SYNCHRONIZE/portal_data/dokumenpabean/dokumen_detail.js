Ext.define("NJC.SYNCHRONIZE.sync_doc_coo.dokumenpabean.dokumen_detail", {
  extend: "Ext.form.Panel",
  alias: "widget.dokumen_detail",
  reference: "dokumen_detail",
  frame: false,
  closeAction: "destroy",
  ...
  items: [
    {
      ...
      columns: [
        ...
        { sortable: true, width: 100, filter: { xtype: "textfield" }, header: "CIF", dataIndex: "CIF" },
        { sortable: true, width: 100, filter: { xtype: "textfield" }, header: "CIF_RUPIAH", dataIndex: "CIF_RUPIAH" },
        { sortable: true, width: 100, filter: { xtype: "textfield" }, header: "DISKON", dataIndex: "DISKON" },
        { sortable: true, width: 100, filter: { xtype: "textfield" }, header: "FLAG_KENDARAAN", dataIndex: "FLAG_KENDARAAN" },
        { sortable: true, width: 100, filter: { xtype: "textfield" }, header: "FOB", dataIndex: "FOB" },
        { sortable: true, width: 100, filter: { xtype: "textfield" }, header: "FREIGHT", dataIndex: "FREIGHT" },
        { sortable: true, width: 100, filter: { xtype: "textfield" }, header: "HARGA_BARANG_LDP", dataIndex: "HARGA_BARANG_LDP" },
        { sortable: true, width: 100, filter: { xtype: "textfield" }, header: "HARGA_INVOICE", dataIndex: "HARGA_INVOICE" },
        { sortable: true, width: 100, filter: { xtype: "textfield" }, header: "HARGA_PENYERAHAN", dataIndex: "HARGA_PENYERAHAN" },
        { sortable: true, width: 100, filter: { xtype: "textfield" }, header: "HARGA_SATUAN", dataIndex: "HARGA_SATUAN" },
        { sortable: true, width: 100, filter: { xtype: "textfield" }, header: "JENIS_KENDARAAN", dataIndex: "JENIS_KENDARAAN" },
        { sortable: true, width: 100, filter: { xtype: "textfield" }, header: "JUMLAH_BAHAN_BAKU", dataIndex: "JUMLAH_BAHAN_BAKU" },
        { sortable: true, width: 100, filter: { xtype: "textfield" }, header: "JUMLAH_KEMASAN", dataIndex: "JUMLAH_KEMASAN" },
        { sortable: true, width: 100, filter: { xtype: "textfield" }, header: "JUMLAH_SATUAN", dataIndex: "JUMLAH_SATUAN" },
        ...
        { sortable: true, width: 100, filter: { xtype: "textfield" }, header: "NETTO", dataIndex: "NETTO" },
        { sortable: true, width: 100, filter: { xtype: "textfield" }, header: "NILAI_INCOTERM", dataIndex: "NILAI_INCOTERM" },
        { sortable: true, width: 100, filter: { xtype: "textfield" }, header: "NILAI_PABEAN", dataIndex: "NILAI_PABEAN" },
