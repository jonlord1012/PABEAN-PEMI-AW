Ext.define("TDK.SYNCHRONIZE.sync_bc_out.ceisa_data.dokumen_kontainer", {
  extend: "Ext.form.Panel",
  alias: "widget.dokumen_kontainer",
  reference: "dokumen_kontainer",
  frame: false,
  border: true,
  autoScroll: true,
  ...
  dockedItems: [
    {
      ...
      items: [
        "-",
        {
          ...
          handler: function () {
            var GRID = Ext.ComponentQuery.query("dokumen_kontainer grid[pid=GRIDdokumen_kontainer]")[0];
            GRID.getStore().load();
          },
        },
      ],
