Ext.define("TDK.SYNCHRONIZE.sync_bc_out.ceisa_data.dokumen_jaminan", {
  extend: "Ext.form.Panel",
  alias: "widget.dokumen_jaminan",
  reference: "dokumen_jaminan",
  frame: false,
  border: true,
  autoScroll: true,
  ...
  dockedItems: [
    {
      ...
      items: [
        "-",
        {
          ...
          handler: function () {
            var GRID = Ext.ComponentQuery.query("dokumen_jaminan grid[pid=GRIDdokumen_jaminan]")[0];
            GRID.getStore().load();
          },
        },
      ],
