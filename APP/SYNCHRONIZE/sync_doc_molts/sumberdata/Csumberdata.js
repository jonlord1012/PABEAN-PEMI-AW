Ext.define("TDK.SYNCHRONIZE.sync_doc_molts.sumberdata.Csumberdata", {
  ...
  btsumberdata_download: function (btn) {
    try {
      var GRIDINV = Ext.ComponentQuery.query("sync_doc_molts GRIDsync_doc_molts grid[pid=GRIDsync_doc_molts]")[0];
