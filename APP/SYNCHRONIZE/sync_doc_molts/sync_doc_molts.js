Ext.define("TDK.SYNCHRONIZE.sync_doc_molts.sync_doc_molts", {
  extend: "Ext.form.Panel",
  alias: "widget.sync_doc_molts",
  reference: "sync_doc_molts",
  config: {},
  requires: [
    //
    "TDK.SYNCHRONIZE.sync_doc_molts.Csync_doc_molts",
    "TDK.SYNCHRONIZE.sync_doc_molts.GRIDsync_doc_molts",
    "TDK.SYNCHRONIZE.sync_doc_molts.molts_FRMdraft_dokumen"
  ],
  ...
  initComponent: function () {
    Ext.apply(this, {
      xtype: "panel",
      pid: "panelsync_doc_molts",
      layout: "card",
      frame: false,
      border: false,
      items: [
        {
          xtype: "GRIDsync_doc_molts",
        },
      ],
      dockedItems: [
        {
          ...
          items: [
            ...
            { xtype: "button", pid: "btprocess_sync", icon: vconfig.getstyle + "icon/table_refresh.png", tooltip: "Sinkronisasi Data MOLTS" },
            ...
            "-",
            "->",
            { xtype: "button", text: "Log", pid: "btlog_molts", icon: vconfig.getstyle + "icon/Book%201.ico", tooltip: "Log Dokumen MOLTS" },
          ],
          // other options....
        },
      ],
