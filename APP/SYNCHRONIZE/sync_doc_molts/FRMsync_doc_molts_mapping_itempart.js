...
Ext.define("TDK.SYNCHRONIZE.sync_doc_molts.FRMsync_doc_molts_mapping_itempart", {
  extend: "Ext.window.Window",
  alias: "widget.FRMsync_doc_molts_mapping_itempart",
  reference: "FRMsync_doc_molts_mapping_itempart",
  ...
  items: [
    {
      xtype: "grid",
      pid: "GRID_FRMsync_doc_molts_mapping_itempart",
      ...
      listeners: {
        afterrender: "GRID_FRMsync_doc_molts_mapping_itempart_load",
      },
    },
  ],
  dockedItems: [
