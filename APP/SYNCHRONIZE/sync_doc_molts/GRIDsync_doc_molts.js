Ext.define("TDK.SYNCHRONIZE.sync_doc_molts.GRIDsync_doc_molts", {
  extend: "Ext.form.Panel",
  alias: "widget.GRIDsync_doc_molts",
  reference: "GRIDsync_doc_molts",
  ...
  items: [
    {
      ...
      store: {
        ...
        listeners: {
          beforeload: function (store, operation, eOpts) {
            try {
              var CBO_FILTERKEY = Ext.ComponentQuery.query("sync_doc_molts combobox[name=CBO_FILTERKEY]")[0];
              operation.setParams({
      ...
      columns: [
          ...
          items: [
            {
              ...
              handler: "molts_show_tracingdocument_rowclick",
              tooltip: "Detail Dokumen",
            },
          ],
        },
        { sortable: true, width: 150, filter: { xtype: "textfield" }, header: "VENDOR", dataIndex: "SHIPPER" },
        ...
        { sortable: true, width: 300, filter: { xtype: "textfield" }, header: "SUPPLIER NAME", dataIndex: "MAPP_SUPPLIERNAME" },
      ],
      bbar: {
        xtype: "pagingtoolbar",
        displayInfo: true,
