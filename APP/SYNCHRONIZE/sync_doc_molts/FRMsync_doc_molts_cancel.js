...
Ext.define("TDK.SYNCHRONIZE.sync_doc_molts.FRMsync_doc_molts_cancel", {
  extend: "Ext.window.Window",
  alias: "widget.FRMsync_doc_molts_cancel",
  reference: "FRMsync_doc_molts_cancel",
  title: "Proses Cancel Synchronize MOLTS",
  modal: true,
  closeAction: "destroy",
  centered: true,
  autoScroll: true,
  ...
  items: [
    {
      ...
      listeners: {
        afterrender: "GRIDsync_doc_molts_cancel_load",
      },
    },
  ],
});
