Ext.define("TDK.SYNCHRONIZE.sync_doc_molts.mapping_supplier.FRMmapping_supplier", {
  extend: "Ext.form.Panel",
  alias: "widget.FRMmapping_supplier",
  reference: "FRMmapping_supplier",
  frame: false,
  border: true,
  autoScroll: true,
  ...
  items: [
    {
      ...
      columns: [
        ...
        { header: "VENDOR", dataIndex: "SHIPPER", sortable: true, width: 100, filter: { xtype: "textfield" } },
