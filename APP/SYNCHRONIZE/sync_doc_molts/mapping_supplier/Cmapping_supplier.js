Ext.define("TDK.SYNCHRONIZE.sync_doc_molts.mapping_supplier.Cmapping_supplier", {
  ...
  btpilihsupplier_mapping: function (grid, rowIndex) {
    try {
      ...
      var popup = Ext.define("TDK.SYNCHRONIZE.sync_doc_molts.mapping_supplier.popup_selectvendor", {
