                          ...
                          tbar: [
                            {
                              ...
                              handler: function () {
                                var GRID = Ext.ComponentQuery.query("molts_FRMdraft_dokumen grid[pid=GRIDdokumen_draft_kontainer]")[0];
                                var rec = {
                              ...
                              editor: {
                                ...
                                listeners: {
                                  select: function (cmp, rec) {
                                    var GRID = Ext.ComponentQuery.query("molts_FRMdraft_dokumen grid[pid=GRIDdokumen_draft_kemasan]")[0];
              ...
              items: [
                {
                  ...
                  columns: [
                    { xtype: "rownumberer", width: 40 },
                    { header: "SUPPLIER", dataIndex: "SUPPLIER", sortable: true, width: 75, filter: { xtype: "textfield" } },
                    ...
                    { header: "SHIPPING", dataIndex: "SHIPPING_MODE", sortable: true, width: 80, filter: { xtype: "textfield" } },
                    { header: "INV TERM", dataIndex: "INVOICE_TERM", sortable: true, width: 80, filter: { xtype: "textfield" } },
                    { header: "PART NO", dataIndex: "MAPP_PARTNO", sortable: true, width: 120, filter: { xtype: "textfield" } },
                    { header: "QTY", dataIndex: "QTY", sortable: true, width: 80, align: "right", renderer: "formatAmount", filter: { xtype: "textfield" } },
                    { header: "UOM", dataIndex: "UNIT", sortable: true, width: 50, filter: { xtype: "textfield" } },
                    { header: "UNIT PRICE", dataIndex: "UNIT_PRICE", sortable: true, width: 80, align: "right", filter: { xtype: "textfield" } },
                    { header: "TOTAL PRICE", dataIndex: "TOTAL_PRICE", sortable: true, width: 80, align: "right", filter: { xtype: "textfield" } },
                    { header: "CURRENCY", dataIndex: "CURRENCY", sortable: true, width: 50, filter: { xtype: "textfield" } },
                    { header: "WEIGHT UNIT", dataIndex: "NET_WEIGHT_UNIT", sortable: true, width: 80, align: "right", renderer: "formatAmount", filter: { xtype: "textfield" } },
                    { header: "WEIGHT TOTAL", dataIndex: "NET_WEIGHT_TOTAL", sortable: true, width: 80, align: "right", renderer: "formatAmount", filter: { xtype: "textfield" } },
                    { header: "COUNTRY OF", dataIndex: "CONTRY_OF_ORIGIN", sortable: true, width: 80, filter: { xtype: "textfield" } },
                  ],
                  bbar: {
                    xtype: "pagingtoolbar",
                    displayInfo: true,
