Ext.define("TDK.SYNCHRONIZE.sync_doc_coo.dokumen_draft.Cdokumen_draft", {
  ...
  btsearch_click: function (btn) {
    try {
      ...
      var popup = Ext.define("TDK.SYNCHRONIZE.sync_doc_coo.dokumen_draft.popup_btsearch", {
  ...
  btsearch_invoice_click: function () {
    try {
      ...
      var mainpanel = Ext.ComponentQuery.query("mainpage")[0];
      var popup = Ext.define("TDK.SYNCHRONIZE.sync_doc_coo.dokumen_draft.popup_invoice", {
        extend: "Ext.window.Window",
  ...
  bttambah_dokumen_click: function () {
    try {
      ...
      var mainpanel = Ext.ComponentQuery.query("mainpage")[0];
      var popup = Ext.define("TDK.SYNCHRONIZE.sync_doc_coo.dokumen_draft.popup_btadddokumen", {
        extend: "Ext.window.Window",
  ...
  btsavedokumendraft_click: function () {
    try {
      var me = this;
      var popup = Ext.ComponentQuery.query("coo_dokumen_draft")[0];
      var FRM = Ext.ComponentQuery.query("coo_dokumen_draft FRMdokumen_draft")[0];
      ...
      var griddokumen = Ext.ComponentQuery.query("coo_dokumen_draft FRMdokumen_draft grid[pid=GRIDinvoice_dokumen_draft]")[0];
      var GRIDdokumen_draft_kontainer = Ext.ComponentQuery.query("coo_dokumen_draft FRMdokumen_draft grid[pid=GRIDdokumen_draft_kontainer]")[0];
