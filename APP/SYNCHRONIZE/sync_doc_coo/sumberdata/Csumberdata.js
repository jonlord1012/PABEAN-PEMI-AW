Ext.define("TDK.SYNCHRONIZE.sync_doc_coo.sumberdata.Csumberdata", {
  ...
  btsumberdata_download: function (btn) {
    try {
      var GRIDINV = Ext.ComponentQuery.query("sync_doc_coo GRIDsync_doc_coo grid[pid=GRIDsync_doc_coo]")[0];
