Ext.define("TDK.SYNCHRONIZE.sync_doc_coo.GRIDsync_doc_coo", {
  extend: "Ext.form.Panel",
  alias: "widget.GRIDsync_doc_coo",
  reference: "GRIDsync_doc_coo",
      ...
      store: {
        ...
        listeners: {
          beforeload: function (store, operation, eOpts) {
            try {
              var CBO_FILTERKEY = Ext.ComponentQuery.query("sync_doc_coo combobox[name=CBO_FILTERKEY]")[0];
              operation.setParams({
