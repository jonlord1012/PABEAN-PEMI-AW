...
Ext.define("TDK.SYNCHRONIZE.sync_doc_kurir23.FRMsync_doc_kurir23_cancel", {
  extend: "Ext.window.Window",
  alias: "widget.FRMsync_doc_kurir23_cancel",
  reference: "FRMsync_doc_kurir23_cancel",
  title: "Proses Cancel Synchronize KURIR23",
  modal: true,
  closeAction: "destroy",
  centered: true,
  autoScroll: true,
  ...
  items: [
    {
      xtype: "grid",
      pid: "GRIDsync_doc_kurir23_cancel",
          ...
          items: [
            {
              ...
              handler: "kurir23_cancel_dokumen",
            },
          ],
        },
      ...
      listeners: {
        afterrender: "GRIDsync_doc_kurir23_cancel_load",
      },
    },
  ],
});
