Ext.define("TDK.SYNCHRONIZE.sync_doc_kurir23.dokumen_draft.Cdokumen_draft", {
  ...
  btsearch_click: function (btn) {
    try {
      ...
      var popup = Ext.define("TDK.SYNCHRONIZE.sync_doc_kurir23.dokumen_draft.popup_btsearch", {
  ...
  btsearch_invoice_click: function () {
    try {
      ...
      var mainpanel = Ext.ComponentQuery.query("mainpage")[0];
      var popup = Ext.define("TDK.SYNCHRONIZE.sync_doc_kurir23.dokumen_draft.popup_invoice", {
        extend: "Ext.window.Window",
