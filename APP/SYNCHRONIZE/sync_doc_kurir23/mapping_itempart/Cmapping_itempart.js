Ext.define("TDK.SYNCHRONIZE.sync_doc_kurir23.mapping_itempart.Cmapping_itempart", {
  ...
  btpilihpart_mapping: function (grid, rowIndex) {
    try {
      ...
      var popup = Ext.define("TDK.SYNCHRONIZE.sync_doc_kurir23.mapping_itempart.popup_selectpart", {
