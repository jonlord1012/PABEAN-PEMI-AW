Ext.define("TDK.SYNCHRONIZE.sync_doc_kurir23.sync_doc_kurir23", {
  extend: "Ext.form.Panel",
  alias: "widget.sync_doc_kurir23",
  reference: "sync_doc_kurir23",
  config: {},
  requires: ["TDK.SYNCHRONIZE.sync_doc_kurir23.GRIDsync_doc_kurir23", "TDK.SYNCHRONIZE.sync_doc_kurir23.Csync_doc_kurir23"],
  ...
  initComponent: function () {
    Ext.apply(this, {
      xtype: "panel",
      pid: "panelsync_doc_kurir23",
      layout: "card",
      frame: false,
      border: false,
      items: [{ xtype: "GRIDsync_doc_kurir23" }],
      dockedItems: [
        {
          xtype: "toolbar",
          dock: "top",
          items: [
            ...
            { xtype: "button", pid: "btprocess_sync", icon: vconfig.getstyle + "icon/table_refresh.png", tooltip: "Sinkronisasi Data KURIR23" },
            ...
            "-",
            "->",
            { xtype: "button", text: "Log", pid: "btlog_kurir23", icon: vconfig.getstyle + "icon/Book%201.ico", tooltip: "Log Dokumen KURIR23" },
          ],
          // other options....
        },
      ],
