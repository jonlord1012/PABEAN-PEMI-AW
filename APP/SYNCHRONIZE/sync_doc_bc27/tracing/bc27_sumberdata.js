Ext.define("TDK.SYNCHRONIZE.sync_doc_bc27.tracing.bc27_sumberdata", {
  extend: "Ext.form.Panel",
  alias: "widget.bc27_sumberdata",
  reference: "bc27_sumberdata",
  frame: false,
  border: true,
  autoScroll: true,
      ...
      store: {
        ...
        listeners: {
          beforeload: function (store, operation, eOpts) {
            try {
              var GRID = Ext.ComponentQuery.query("GRIDsync_doc_bc27 grid[pid=GRIDsync_doc_bc27]")[0];
  ...
  dockedItems: [
    {
      ...
      items: [
        ...
        "->",
        {
          ...
          handler: function () {
            try {
              var GRIDINV = Ext.ComponentQuery.query("GRIDsync_doc_bc27 grid[pid=GRIDsync_doc_bc27]")[0];
              ...
              var GRID = Ext.ComponentQuery.query("bc27_sumberdata grid[pid=GRIDbc27_sumberdata]")[0];
