Ext.define("TDK.SYNCHRONIZE.sync_doc_bc27.GRIDsync_doc_bc27", {
  extend: "Ext.form.Panel",
  alias: "widget.GRIDsync_doc_bc27",
  reference: "GRIDsync_doc_bc27",
      ...
      store: {
        ...
        listeners: {
          beforeload: function (store, operation, eOpts) {
            try {
              var CBO_FILTERKEY = Ext.ComponentQuery.query("sync_doc_bc27 combobox[name=CBO_FILTERKEY]")[0];
              operation.setParams({
          ...
          items: [
            {
              ...
              handler: "bc27_show_tracingdocument_rowclick",
