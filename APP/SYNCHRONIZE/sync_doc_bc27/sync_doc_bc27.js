Ext.define("TDK.SYNCHRONIZE.sync_doc_bc27.sync_doc_bc27", {
  extend: "Ext.form.Panel",
  alias: "widget.sync_doc_bc27",
  reference: "sync_doc_bc27",
  config: {},
  requires: [
    //
    "TDK.SYNCHRONIZE.sync_doc_bc27.GRIDsync_doc_bc27",
    "TDK.SYNCHRONIZE.sync_doc_bc27.Csync_doc_bc27",
  ],
  ...
  initComponent: function () {
    Ext.apply(this, {
      xtype: "panel",
      pid: "panelsync_doc_bc27",
      layout: "card",
      frame: false,
      border: false,
      items: [
        {
          xtype: "GRIDsync_doc_bc27",
        },
      ],
      dockedItems: [
        {
          ...
          items: [
            ...
            { xtype: "button", pid: "btprocess_sync", icon: vconfig.getstyle + "icon/table_refresh.png", tooltip: "Sinkronisasi Data BC 27" },
            ...
            "-",
            "->",
            { xtype: "button", text: "Log", pid: "btlog_bc27", icon: vconfig.getstyle + "icon/Book%201.ico", tooltip: "Log Dokumen BC 27" },
          ],
          // other options....
        },
      ],
