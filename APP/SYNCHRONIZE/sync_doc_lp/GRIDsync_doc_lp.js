Ext.define("TDK.SYNCHRONIZE.sync_doc_lp.GRIDsync_doc_lp", {
  extend: "Ext.form.Panel",
  alias: "widget.GRIDsync_doc_lp",
  reference: "GRIDsync_doc_lp",
      ...
      store: {
        ...
        listeners: {
          beforeload: function (store, operation, eOpts) {
            try {
              var CBO_FILTERKEY = Ext.ComponentQuery.query("sync_doc_lp combobox[name=CBO_FILTERKEY]")[0];
              operation.setParams({
          ...
          items: [
            {
              ...
              handler: "lp_show_tracingdocument_rowclick",
