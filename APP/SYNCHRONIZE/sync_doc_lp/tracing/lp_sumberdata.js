Ext.define("TDK.SYNCHRONIZE.sync_doc_lp.tracing.lp_sumberdata", {
  extend: "Ext.form.Panel",
  alias: "widget.lp_sumberdata",
  reference: "lp_sumberdata",
  frame: false,
  border: true,
  autoScroll: true,
      ...
      store: {
        ...
        listeners: {
          beforeload: function (store, operation, eOpts) {
            try {
              var GRID = Ext.ComponentQuery.query("GRIDsync_doc_lp grid[pid=GRIDsync_doc_lp]")[0];
  ...
  dockedItems: [
    {
      ...
      items: [
        ...
        "->",
        {
          ...
          handler: function () {
            try {
              var GRIDINV = Ext.ComponentQuery.query("GRIDsync_doc_lp grid[pid=GRIDsync_doc_lp]")[0];
              ...
              var GRID = Ext.ComponentQuery.query("lp_sumberdata grid[pid=GRIDlp_sumberdata]")[0];
