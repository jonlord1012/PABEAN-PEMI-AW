...
Ext.define("TDK.SYNCHRONIZE.sync_doc_lp.lp_popupmapping_itempart", {
  extend: "Ext.window.Window",
  alias: "widget.lp_popupmapping_itempart",
  reference: "lp_popupmapping_itempart",
  title: "Mapping Item/Part Material [LP]",
  modal: true,
  closeAction: "hidden",
  centered: true,
  autoScroll: true,
