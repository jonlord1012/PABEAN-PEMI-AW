...
Ext.define("TDK.SYNCHRONIZE.sync_doc_lp.lp_FRMdraft_dokumen", {
  extend: "Ext.window.Window",
  alias: "widget.lp_FRMdraft_dokumen",
  reference: "lp_FRMdraft_dokumen",
  title: "Draft Dokumen [LP]",
  modal: true,
  closeAction: "hidden",
  centered: true,
  autoScroll: true,
  ...
  dockedItems: [
    {
      ...
      items: [
        //
        "-",
        { xtype: "button", pid: "btlp_savedokumendraft", text: "Simpan Dokumen Draft", icon: vconfig.getstyle + "icon/save.ico", tooltip: "Simpan Dokumen Draft" },
      ],
    },
  ],
  listeners: {
