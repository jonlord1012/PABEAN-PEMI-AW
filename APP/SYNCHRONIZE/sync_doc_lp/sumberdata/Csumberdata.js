Ext.define("TDK.SYNCHRONIZE.sync_doc_lp.sumberdata.Csumberdata", {
  ...
  btsumberdata_download: function (btn) {
    try {
      var GRIDINV = Ext.ComponentQuery.query("sync_doc_lp GRIDsync_doc_lp grid[pid=GRIDsync_doc_lp]")[0];
