...
Ext.define("TDK.SYNCHRONIZE.sync_doc_lp.lp_popupmapping_supplier", {
  extend: "Ext.window.Window",
  alias: "widget.lp_popupmapping_supplier",
  reference: "lp_popupmapping_supplier",
  title: "Mapping Supplier [LP]",
  modal: true,
  closeAction: "hidden",
  centered: true,
  autoScroll: true,
