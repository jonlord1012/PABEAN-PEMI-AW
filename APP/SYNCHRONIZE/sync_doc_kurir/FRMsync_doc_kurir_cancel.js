...
Ext.define("TDK.SYNCHRONIZE.sync_doc_kurir.FRMsync_doc_kurir_cancel", {
  extend: "Ext.window.Window",
  alias: "widget.FRMsync_doc_kurir_cancel",
  reference: "FRMsync_doc_kurir_cancel",
  title: "Proses Cancel Synchronize KURIR",
  modal: true,
  closeAction: "destroy",
  centered: true,
  autoScroll: true,
  ...
  items: [
    {
      ...
      listeners: {
        afterrender: "GRIDsync_doc_kurir_cancel_load",
      },
    },
  ],
});
