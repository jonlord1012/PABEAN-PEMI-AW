Ext.define("TDK.SYNCHRONIZE.sync_doc_kurir.sumberdata.Csumberdata", {
  ...
  btsumberdata_download: function (btn) {
    try {
      var GRIDINV = Ext.ComponentQuery.query("sync_doc_kurir GRIDsync_doc_kurir grid[pid=GRIDsync_doc_kurir]")[0];
