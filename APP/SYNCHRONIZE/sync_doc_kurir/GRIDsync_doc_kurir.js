Ext.define("TDK.SYNCHRONIZE.sync_doc_kurir.GRIDsync_doc_kurir", {
  extend: "Ext.form.Panel",
  alias: "widget.GRIDsync_doc_kurir",
  reference: "GRIDsync_doc_kurir",
      ...
      store: {
        ...
        listeners: {
          beforeload: function (store, operation, eOpts) {
            try {
              console.log("proses");
              var CBO_FILTERKEY = Ext.ComponentQuery.query("sync_doc_kurir combobox[name=CBO_FILTERKEY]")[0];
              operation.setParams({
