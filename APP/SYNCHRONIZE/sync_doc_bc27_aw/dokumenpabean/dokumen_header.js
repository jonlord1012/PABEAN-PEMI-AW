Ext.define("TDK.SYNCHRONIZE.sync_doc_bc27_aw.dokumenpabean.dokumen_header", {
      ...
      items: [
        "-",
        {
          ...
          handler: function () {
            var me = this;
            console.log(me);
            var GRID = Ext.ComponentQuery.query("dokumenpabean dokumen_header grid[pid=GRIDdokumen_header]")[0];
            GRID.getStore().load();
          },
        },
      ],
