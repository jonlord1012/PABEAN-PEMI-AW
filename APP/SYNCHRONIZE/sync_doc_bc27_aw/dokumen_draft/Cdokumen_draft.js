Ext.define("TDK.SYNCHRONIZE.sync_doc_bc27_aw.dokumen_draft.Cdokumen_draft", {
  ...
  btsearch_click: function (btn) {
    try {
      ...
      var popup = Ext.define("TDK.SYNCHRONIZE.sync_doc_bc27_aw.dokumen_draft.popup_btsearch", {
        ...
        case "supplier":
          return {
            ...
            proxy: {
              ...
              url: vconfig.service_api + "sync_doc_bc27_aw/sync_doc_bc27_aws",
              extraParams: {
  ...
  btsearch_invoice_click: function () {
    try {
      ...
      var mainpanel = Ext.ComponentQuery.query("mainpage")[0];
      var popup = Ext.define("TDK.SYNCHRONIZE.sync_doc_bc27_aw.dokumen_draft.popup_invoice", {
        extend: "Ext.window.Window",
  ...
  bttambah_dokumen_click: function () {
    try {
      ...
      var mainpanel = Ext.ComponentQuery.query("mainpage")[0];
      var popup = Ext.define("TDK.SYNCHRONIZE.sync_doc_bc27_aw.dokumen_draft.popup_btadddokumen", {
        extend: "Ext.window.Window",
