Ext.define("TDK.SYNCHRONIZE.sync_doc_bc27_aw.dokumen_draft.FRMdokumen_draft", {
                      ...
                      tbar: [
                        {
                          ...
                          handler: function () {
                            var GRID = Ext.ComponentQuery.query("aw_dokumen_draft FRMdokumen_draft grid[pid=GRIDdokumen_draft_kontainer]")[0];
                            var rec = {
                          ...
                          editor: {
                            ...
                            listeners: {
                              select: function (cmp, rec) {
                                var GRID = Ext.ComponentQuery.query("aw_dokumen_draft FRMdokumen_draft grid[pid=GRIDdokumen_draft_kemasan]")[0];
  ...
  listeners: {
    afterrender: "awFRMdokumen_draft_load",
  },
});
