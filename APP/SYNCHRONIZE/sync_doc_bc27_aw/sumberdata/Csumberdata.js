Ext.define("TDK.SYNCHRONIZE.sync_doc_bc27_aw.sumberdata.Csumberdata", {
  ...
  btsumberdata_download: function (btn) {
    try {
      var GRIDINV = Ext.ComponentQuery.query("sync_doc_bc27_aw GRIDsync_doc_bc27_aw grid[pid=GRIDsync_doc_bc27_aw]")[0];
