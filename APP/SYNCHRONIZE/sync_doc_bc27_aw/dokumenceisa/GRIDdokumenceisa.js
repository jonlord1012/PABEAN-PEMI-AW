Ext.define("TDK.SYNCHRONIZE.sync_doc_bc27_aw.dokumenceisa.GRIDdokumenceisa", {
  extend: "Ext.form.Panel",
  alias: "widget.GRIDdokumenceisa",
  reference: "GRIDdokumenceisa",
  frame: false,
  border: true,
  autoScroll: true,
  ...
  items: [
    {
      ...
      store: {
        ...
        proxy: {
          ...
          extraParams: {
            method: "read_dokumenceisa_header",
            module: "aw",
          },
          reader: {
            type: "json",
      ...
      items: [
        {
          ...
          store: {
            ...
            proxy: {
              ...
              url: vconfig.service_api + "sync_doc_bc27_aw/sync_doc_bc27_aws",
              extraParams: {
                method: "read_dokumenceisa_detail",
                module: "aw",
              },
              reader: {
                type: "json",
        ...
        { xtype: "tbspacer", width: 5 },
        {
          ...
          store: {
            ...
            proxy: {
              ...
              url: vconfig.service_api + "sync_doc_bc27_aw/sync_doc_bc27_aws",
              extraParams: {
                method: "read_dokumenceisa_lampiran",
                module: "aw",
              },
              reader: {
                type: "json",
