Ext.define("TDK.SYNCHRONIZE.sync_doc_bc27_aw.sync_doc_bc27_aw", {
  extend: "Ext.form.Panel",
  alias: "widget.sync_doc_bc27_aw",
  reference: "sync_doc_bc27_aw",
  config: {},
  requires: ["TDK.SYNCHRONIZE.sync_doc_bc27_aw.GRIDsync_doc_bc27_aw", "TDK.SYNCHRONIZE.sync_doc_bc27_aw.Csync_doc_bc27_aw"],
  constructor: function (config) {
    return this.callParent(arguments);
  },
  //untuk include controller
  controller: "Csync_doc_bc27_aw",
  initComponent: function () {
    Ext.apply(this, {
      xtype: "panel",
      pid: "panelsync_doc_bc27_aw",
      layout: "card",
      frame: false,
      border: false,
      items: [{ xtype: "GRIDsync_doc_bc27_aw" }],
      dockedItems: [
        {
          xtype: "toolbar",
          dock: "top",
          items: [
            ...
            { xtype: "button", pid: "btprocess_sync", icon: vconfig.getstyle + "icon/table_refresh.png", tooltip: "Sinkronisasi Data AW" },
            { xtype: "button", pid: "btprocess_syncaju", icon: vconfig.getstyle + "icon/split%20cells.ico", tooltip: "Sinkronisasi Nomor Aju" },
            { xtype: "button", pid: "btprocess_syncceisa", icon: vconfig.getstyle + "icon/replace.ico", tooltip: "Sinkronisasi dari CEISA" },
            "-",
