Ext.define("TDK.SYNCHRONIZE.sync_doc_bc27_aw.mapping_itempart.FRMmapping_itempart", {
  ...
  items: [
    {
      ...
      columns: [
        ...
        { header: "PART", dataIndex: "PART_CODE", sortable: true, width: 200 , filter: { xtype: "textfield" }},
        { header: "DESC", dataIndex: "PART_NUMBER", sortable: true, width: 250 },
        { header: "UOM", dataIndex: "PART_UNIT", sortable: true, width: 75 }, 
      ],
      bbar: {
        xtype: "pagingtoolbar",
        displayInfo: true,
