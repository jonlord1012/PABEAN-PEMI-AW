Ext.define("TDK.SYNCHRONIZE.sync_doc_aw.Csync_doc_aw", {
  ...
  btdetail_rows_click: function (xgrid, rowIndex) {
    try {
      ...
      COMP.run.getmodulepopup("FRMsync_doc_aw_tracing", "TDK.SYNCHRONIZE.sync_doc_aw.FRMsync_doc_aw_tracing", mainpanel);
    } catch (ex) {
      COMP.TipToast.toast("Error", ex.message, { cls: "danger", delay: 2000 });
    }
  },
  ...
  FRMsync_doc_aw_tracing_linkclick: function (cmp, dt) {
    try {
      ...
      var cls = "TDK.SYNCHRONIZE.sync_doc_aw." + vmodulename + "." + vmodulecontrol;
  ...
  btmapping_supplier_click: function () {
    try {
      ...
      COMP.run.getmodulepopup("mapping_supplier", "TDK.SYNCHRONIZE.sync_doc_aw.mapping_supplier.mapping_supplier", mainpanel);
    } catch (ex) {
      COMP.TipToast.toast("Error", ex.message, { cls: "danger", delay: 2000 });
    }
  },
  btmapping_itempart_click: function () {
    try {
      ...
      COMP.run.getmodulepopup("mapping_itempart", "TDK.SYNCHRONIZE.sync_doc_aw.mapping_itempart.mapping_itempart", mainpanel);
    } catch (ex) {
      COMP.TipToast.toast("Error", ex.message, { cls: "danger", delay: 2000 });
    }
  },
  btdokumen_draft_click: function () {
    try {
      ...
      COMP.run.getmodulepopup("aw_dokumen_draft", "TDK.SYNCHRONIZE.sync_doc_aw.dokumen_draft.dokumen_draft", mainpanel);
    } catch (ex) {
      COMP.TipToast.toast("Error", ex.message, { cls: "danger", delay: 2000 });
    }
  },
