Ext.define("TDK.SYNCHRONIZE.sync_doc_kurir20.GRIDsync_doc_kurir20", {
  extend: "Ext.form.Panel",
  alias: "widget.GRIDsync_doc_kurir20",
  reference: "GRIDsync_doc_kurir20",
      ...
      store: {
        ...
        listeners: {
          beforeload: function (store, operation, eOpts) {
            try {
              console.log("proses");
              var CBO_FILTERKEY = Ext.ComponentQuery.query("sync_doc_kurir20 combobox[name=CBO_FILTERKEY]")[0];
              operation.setParams({
