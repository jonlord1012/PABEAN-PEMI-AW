Ext.define("TDK.SYNCHRONIZE.sync_doc_kurir20.sumberdata.Csumberdata", {
  ...
  btsumberdata_download: function (btn) {
    try {
      var GRIDINV = Ext.ComponentQuery.query("sync_doc_kurir20 GRIDsync_doc_kurir20 grid[pid=GRIDsync_doc_kurir20]")[0];
