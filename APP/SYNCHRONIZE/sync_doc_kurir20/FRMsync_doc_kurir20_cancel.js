...
Ext.define("TDK.SYNCHRONIZE.sync_doc_kurir20.FRMsync_doc_kurir20_cancel", {
  extend: "Ext.window.Window",
  alias: "widget.FRMsync_doc_kurir20_cancel",
  reference: "FRMsync_doc_kurir20_cancel",
  title: "Proses Cancel Synchronize KURIR20",
  modal: true,
  closeAction: "destroy",
  centered: true,
  autoScroll: true,
  ...
  items: [
    {
      xtype: "grid",
      pid: "GRIDsync_doc_kurir20_cancel",
          ...
          items: [
            {
              ...
              handler: "kurir20_cancel_dokumen",
            },
          ],
        },
      ...
      listeners: {
        afterrender: "GRIDsync_doc_kurir20_cancel_load",
      },
    },
  ],
});
