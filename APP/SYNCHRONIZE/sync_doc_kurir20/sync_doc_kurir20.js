Ext.define("TDK.SYNCHRONIZE.sync_doc_kurir20.sync_doc_kurir20", {
  extend: "Ext.form.Panel",
  alias: "widget.sync_doc_kurir20",
  reference: "sync_doc_kurir20",
  config: {},
  requires: ["TDK.SYNCHRONIZE.sync_doc_kurir20.GRIDsync_doc_kurir20", "TDK.SYNCHRONIZE.sync_doc_kurir20.Csync_doc_kurir20"],
  constructor: function (config) {
    return this.callParent(arguments);
  },
  //untuk include controller
  controller: "Csync_doc_kurir20",
  initComponent: function () {
    Ext.apply(this, {
      xtype: "panel",
      pid: "panelsync_doc_kurir20",
      layout: "card",
      frame: false,
      border: false,
      items: [{ xtype: "GRIDsync_doc_kurir20" }],
      dockedItems: [
        {
          xtype: "toolbar",
          dock: "top",
          items: [
            ...
            { xtype: "button", pid: "btprocess_sync", icon: vconfig.getstyle + "icon/table_refresh.png", tooltip: "Sinkronisasi Data KURIR20" },
            ...
            "-",
            "->",
            { xtype: "button", text: "Log", pid: "btlog_kurir20", icon: vconfig.getstyle + "icon/Book%201.ico", tooltip: "Log Dokumen KURIR20" },
          ],
          // other options....
        },
      ],
