Ext.define("NJC.REPORTS.ext_rpt_mesin_stationary.GRIDext_rpt_mesin_stationary", {
  extend: "Ext.form.Panel",
  alias: "widget.GRIDext_rpt_mesin_stationary",
  reference: "GRIDext_rpt_mesin_stationary",
  frame: false,
  border: true,
  autoScroll: true,
  ...
  items: [
    {
      xtype: "grid",
      pid: "GRIDext_rpt_mesin_stationary",
      ...
      store: {
        ...
        proxy: {
          ...
          url: vconfig.service_api + "ext_rpt_mesin_stationary/ext_rpt_mesin_stationarys",
          extraParams: {
            method: "read_to_grid",
          },
          reader: {
        ...
        listeners: {
          beforeload: function (store, operation, eOpts) {
            try {
              var VIDCOMPANY = Ext.ComponentQuery.query("ext_rpt_mesin_stationary combobox[name=CBO_SOURCE]")[0];
              var VFROMDATE = Ext.ComponentQuery.query("ext_rpt_mesin_stationary datefield[name=tfromdate]")[0];
              var VTODATE = Ext.ComponentQuery.query("ext_rpt_mesin_stationary datefield[name=ttodate]")[0];
