Ext.define("TDK.REPORTS.ext_rpt_item_sisa_scrap.GRIDext_rpt_item_sisa_scrap", {
  extend: "Ext.form.Panel",
  alias: "widget.GRIDext_rpt_item_sisa_scrap",
  reference: "GRIDext_rpt_item_sisa_scrap",
  frame: false,
  border: true,
  autoScroll: true,
  ...
  items: [
    {
      xtype: "grid",
      pid: "GRIDext_rpt_item_sisa_scrap",
      ...
      store: {
        ...
        proxy: {
          ...
          url: vconfig.service_api + "ext_rpt_item_sisa_scrap/ext_rpt_item_sisa_scraps",
          extraParams: {
            method: "read_to_grid",
          },
          reader: {
        ...
        listeners: {
          beforeload: function (store, operation, eOpts) {
            try {
              var VIDCOMPANY = Ext.ComponentQuery.query("ext_rpt_item_sisa_scrap combobox[name=CBO_SOURCE]")[0];
              var VFROMDATE = Ext.ComponentQuery.query("ext_rpt_item_sisa_scrap datefield[name=tfromdate]")[0];
              var VTODATE = Ext.ComponentQuery.query("ext_rpt_item_sisa_scrap datefield[name=ttodate]")[0];
