Ext.define("NJC.REPORTS.int_rpt_pengeluaran_aw_wh.GRIDint_rpt_pengeluaran_aw_wh", {
  extend: "Ext.form.Panel",
  alias: "widget.GRIDint_rpt_pengeluaran_aw_wh",
  reference: "GRIDint_rpt_pengeluaran_aw_wh",
  frame: false,
  border: true,
  autoScroll: true,
  ...
  items: [
    {
      xtype: "grid",
      pid: "GRIDint_rpt_pengeluaran_aw_wh",
      ...
      store: {
        ...
        proxy: {
          ...
          url: vconfig.service_api + "int_rpt_pengeluaran_aw_wh/int_rpt_pengeluaran_aw_whs",
          extraParams: {
            method: "read_to_grid",
          },
          reader: {
        ...
        listeners: {
          beforeload: function (store, operation, eOpts) {
            try {
              var VFROMDATE = Ext.ComponentQuery.query("int_rpt_pengeluaran_aw_wh datefield[name=tfromdate]")[0];
              var VTODATE = Ext.ComponentQuery.query("int_rpt_pengeluaran_aw_wh datefield[name=ttodate]")[0];
