Ext.define("NJC.REPORTS.int_rpt_pemasukan.GRIDint_rpt_pemasukan", {
  extend: "Ext.form.Panel",
  alias: "widget.GRIDint_rpt_pemasukan",
  reference: "GRIDint_rpt_pemasukan",
  frame: false,
  border: true,
  autoScroll: true,
  ...
  items: [
    {
      ...
      store: {
        ...
        proxy: {
          ...
          url: vconfig.service_api + "int_rpt_pemasukan/int_rpt_pemasukans",
          extraParams: {
            method: "read_to_grid",
          },
          reader: {
        ...
        listeners: {
          beforeload: function (store, operation, eOpts) {
            try {
              var VFROMDATE = Ext.ComponentQuery.query("int_rpt_pemasukan datefield[name=tfromdate]")[0];
              var VTODATE = Ext.ComponentQuery.query("int_rpt_pemasukan datefield[name=ttodate]")[0];
      ...
      columns: [
        ...
        { sortable: true, width: 200, filter: { xtype: "textfield" }, header: "NOMOR PENERIMAAN", dataIndex: "NOMOR_BUKTI_PENERIMAAN_BARANG" },
        { sortable: true, width: 200, filter: { xtype: "textfield" }, header: "TANGGAL PENERIMAAN", dataIndex: "TANGGAL_BUKTI_PENERIMAAN_BARANG" },
        { sortable: true, width: 200, filter: { xtype: "textfield" }, header: "SUPPLIER", dataIndex: "SUPPLIER" },
