...
Ext.define("TDK.INVENTORY_PLB.inv_wip_control_aw.FRMwip_list_production_aw", {
  extend: "Ext.window.Window",
  alias: "widget.FRMwip_list_production_aw",
  reference: "FRMwip_list_production_aw",
  ...
  items: [
    {
      ...
      items: [
        {
          xtype: "grid",
          pid: "GRIDFRMwip_list_production_aw",
    ...
    },
    {
      ...
      items: [
        {
          xtype: "grid",
          pid: "GRIDFRMwip_list_production_aw_itempart",
          emptyText: "No Matching Records",
          autoScroll: true,
          flex: 1,
          plugins: ["filterfield"],
  ...
  dockedItems: [
    {
      ...
      items: [
        ...
        { xtype: "datefield", labelWidth: 60, width: 180, fieldLabel: "From Date", name: "FRMwip_list_production_aw_from_date", fieldCls: "fieldinput", readOnly: false, format: "Y-m-d", value: new Date() },
        { xtype: "button", text: "Refresh", pid: "FRMwip_list_production_aw_btrefresh", icon: vconfig.getstyle + "icon/update.ico", tooltip: "Refresh Data" },
        "-",
        { xtype: "button", text: "Synchronize WIP BC Dokumen", pid: "FRMwip_list_production_aw_getbc", icon: vconfig.getstyle + "icon/two%20displays.ico", tooltip: "Synchronize Data" },
      ],
    },
  ],
  listeners: {
