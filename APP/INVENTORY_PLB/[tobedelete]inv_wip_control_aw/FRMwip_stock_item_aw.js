...
Ext.define("TDK.INVENTORY_PLB.inv_wip_control_aw.FRMwip_stock_item_aw", {
  extend: "Ext.window.Window",
  alias: "widget.FRMwip_stock_item_aw",
  reference: "FRMwip_stock_item_aw",
  title: "Stock Item",
  modal: true,
  closeAction: "hide",
  centered: true,
  ...
  dockedItems: [
    {
      ...
      items: [
        ...
        { xtype: "button", text: "Refresh", pid: "FRMwip_stock_item_aw_btrefresh", icon: vconfig.getstyle + "icon/update.ico", tooltip: "Refresh Data" },
      ],
    },
  ],
  listeners: {
