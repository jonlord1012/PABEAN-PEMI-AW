...
Ext.define("TDK.INVENTORY_PLB.inv_wip_control_aw.FRMwip_list_bchistory_aw", {
  extend: "Ext.window.Window",
  alias: "widget.FRMwip_list_bchistory_aw",
  reference: "FRMwip_list_bchistory_aw",
  title: "BC History",
  modal: true,
  closeAction: "hide",
  centered: true,
  ...
  items: [
    {
      ...
      items: [
        {
          xtype: "grid",
          pid: "GRIDFRMwip_list_bchistory_aw_header",
    ...
    },
    {
      ...
      items: [
        {
          xtype: "grid",
          pid: "GRIDFRMwip_list_bchistory_aw_detail",
          emptyText: "No Matching Records",
          autoScroll: true,
          flex: 2,
          plugins: ["filterfield"],
          ...
          store: {
            ...
            listeners: {
              beforeload: function (store, operation, eOpts) {
                try {
                  var GRIDheader = Ext.ComponentQuery.query("FRMwip_list_bchistory_aw grid[pid=GRIDFRMwip_list_bchistory_aw_header]")[0];
