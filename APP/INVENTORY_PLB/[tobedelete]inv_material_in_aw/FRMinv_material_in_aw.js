...
Ext.define("TDK.INVENTORY_PLB.inv_material_in_aw.FRMinv_material_in_aw", {
                  ...
                  items: [
                    {
                      ...
                      store: new Ext.data.Store({
                        data: [
                          { DEFCODE: "bicc", DEFNAME: "Sumber Data BICC" },
  ...
  dockedItems: [
    {
      ...
      items: [
        { xtype: "tbspacer", width: 10 },
        {
          ...
          tooltip: "Save Data",
          handler: "FRMinv_material_in_aw_btsave_click",
        },
      ],
    },
  ],
