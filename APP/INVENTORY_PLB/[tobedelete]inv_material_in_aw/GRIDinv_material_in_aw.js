Ext.define("TDK.INVENTORY_PLB.inv_material_in_aw.GRIDinv_material_in_aw", {
  extend: "Ext.form.Panel",
  alias: "widget.GRIDinv_material_in_aw",
  reference: "GRIDinv_material_in_aw",
  frame: false,
  border: false,
  autoScroll: true,
  ...
  items: [
    {
      ...
      listeners: {
        afterrender: "GRIDinv_material_in_aw_load",
      },
    },
  ],
});
