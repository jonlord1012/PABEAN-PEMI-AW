Ext.define("TDK.INVENTORY_PLB.inv_material_in_aw.inv_material_in_aw", {
  extend: "Ext.form.Panel",
  alias: "widget.inv_material_in_aw",
  reference: "inv_material_in_aw",
  config: {},
  requires: ["TDK.INVENTORY_PLB.inv_material_in_aw.GRIDinv_material_in_aw", "TDK.INVENTORY_PLB.inv_material_in_aw.Cinv_material_in_aw"],
  ...
  initComponent: function () {
    Ext.apply(this, {
      xtype: "panel",
      pid: "panelinv_material_in_aw",
      layout: "card",
      frame: false,
      border: false,
      items: [{ xtype: "GRIDinv_material_in_aw" }],
      dockedItems: [
        {
          xtype: "toolbar",
          height: 30,
