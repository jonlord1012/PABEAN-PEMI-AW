Ext.define("TDK.INVENTORY_PLB.inv_material_in_aw.receiving_detail.dokumenceisa.dokumenceisa_detail", {
  extend: "Ext.form.Panel",
  alias: "widget.dokumenceisa_detail",
  reference: "dokumenceisa_detail",
  frame: false,
  border: true,
  autoScroll: true,
  layout: { type: "vbox", pack: "start", align: "stretch" },
  requires: ["TDK.INVENTORY_AW.inv_material_in_aw.receiving_detail.dokumenceisa.Cdokumenceisa"],
  ...
  dockedItems: [
    {
      ...
      items: [
        "-",
        {
          ...
          handler: function () {
            var GRID = Ext.ComponentQuery.query("dokumenceisa_detail grid[pid=GRIDdokumenceisa_detail]")[0];
            GRID.getStore().load();
          },
        },
      ],
