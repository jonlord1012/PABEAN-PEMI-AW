Ext.define("TDK.INVENTORY_PLB.inv_material_in_aw.receiving_detail.dokumenceisa.dokumenceisa_kemasan", {
  extend: "Ext.form.Panel",
  alias: "widget.dokumenceisa_kemasan",
  reference: "dokumenceisa_kemasan",
  frame: false,
  border: true,
  autoScroll: true,
  ...
  dockedItems: [
    {
      ...
      items: [
        "-",
        {
          ...
          handler: function () {
            var GRID = Ext.ComponentQuery.query("dokumenceisa_kemasan grid[pid=GRIDdokumenceisa_kemasan]")[0];
            GRID.getStore().load();
          },
        },
      ],
