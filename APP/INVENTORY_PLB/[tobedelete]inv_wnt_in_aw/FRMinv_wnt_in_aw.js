...
Ext.define("TDK.INVENTORY_AW.inv_wnt_in_aw.FRMinv_wnt_in_aw", {
  extend: "Ext.window.Window",
  alias: "widget.FRMinv_wnt_in_aw",
  reference: "FRMinv_wnt_in_aw",
  ...
  dockedItems: [
    {
      ...
      items: [
        { xtype: "tbspacer", width: 10 },
        {
          xtype: "button",
          text: "Save",
          pid: "FRMinv_wnt_in_aw_btsave",
          icon: vconfig.getstyle + "icon/save.gif",
          tooltip: "Save Data",
          handler: "FRMinv_wnt_in_aw_btsave_click",
        },
      ],
    },
  ],
