Ext.define("TDK.INVENTORY_AW.inv_wnt_in_aw.inv_wnt_in_aw", {
  extend: "Ext.form.Panel",
  alias: "widget.inv_wnt_in_aw",
  reference: "inv_wnt_in_aw",
  config: {},
  requires: ["TDK.INVENTORY_AW.inv_wnt_in_aw.GRIDinv_wnt_in_aw", "TDK.INVENTORY_AW.inv_wnt_in_aw.Cinv_wnt_in_aw"],
  ...
  initComponent: function () {
    Ext.apply(this, {
      xtype: "panel",
      pid: "panelinv_wnt_in_aw",
      layout: "card",
      frame: false,
      border: false,
      items: [{ xtype: "GRIDinv_wnt_in_aw" }],
      dockedItems: [
        {
          xtype: "toolbar",
          height: 30,
