...
Ext.define("TDK.INVENTORY_AW.inv_wnt_in_aw.FRMinv_wnt_in_aw_pis", {
  extend: "Ext.window.Window",
  alias: "widget.FRMinv_wnt_in_aw_pis",
  reference: "FRMinv_wnt_in_aw_pis",
          ...
          store: {
            ...
            listeners: {
              beforeload: function (store, operation, eOpts) {
                try {
                  var vdate = Ext.ComponentQuery.query("FRMinv_wnt_in_aw_pis datefield[name=TANGGAL_RCV]")[0];
                  operation.setParams({
