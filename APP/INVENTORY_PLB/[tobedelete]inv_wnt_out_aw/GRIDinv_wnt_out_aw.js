Ext.define("TDK.INVENTORY_AW.inv_wnt_out_aw.GRIDinv_wnt_out_aw", {
  extend: "Ext.form.Panel",
  alias: "widget.GRIDinv_wnt_out_aw",
  reference: "GRIDinv_wnt_out_aw",
  frame: false,
  border: false,
  autoScroll: true,
  ...
  dockedItems: [
    {
      ...
      height: 30,
      dock: "top",
      items: [{ xtype: "button", text: "New Input", pid: "GRIDinv_wnt_out_aw_btnew", icon: vconfig.getstyle + "icon/add.png", tooltip: "New" }],
      // other options....
    },
  ],
  listeners: {
    afterrender: "GRIDinv_wnt_out_aw_load",
  },
});
