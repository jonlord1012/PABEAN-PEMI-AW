Ext.define("NJC.INVENTORY_PLB.goods_in.receiving_detail.GRIDreceiving_aw_detail_trans", {
  ...
  items: [
    {
      ...
      columns: [
        ...
        { header: "TRANS NO", dataIndex: "TRANS_NO", sortable: true, width: 200, filter: { xtype: "textfield" } },
        { header: "TRANS DATE", dataIndex: "TRANS_DATE", sortable: true, width: 100, filter: { xtype: "textfield" } },
        ...
        {
          header: "QTY INVOICE", dataIndex: "QTY_INVOICE", sortable: true, width: 100, align: "right", renderer: "formatqty", filter: { xtype: "textfield" }, summaryType: "sum",
          summaryRenderer: function (value, summaryData, dataIndex) {
            return '<span style="font-weight:bold;font-size:11px;">' + Ext.util.Format.number(value, "0,000.00/i") + "</span>";
          },
        },
        {
          header: "QTY RECEIVED", dataIndex: "QTY_RECEIVED", sortable: true, width: 100, align: "right", renderer: "formatqty", filter: { xtype: "textfield" }, summaryType: "sum",
          summaryRenderer: function (value, summaryData, dataIndex) {
            return '<span style="font-weight:bold;font-size:11px;">' + Ext.util.Format.number(value, "0,000.00/i") + "</span>";
          },
        },
        ...
        /*
        { header: "PARTNO", dataIndex: "PART_NO", sortable: true, width: 100 },
        { header: "LOT NO", dataIndex: "LOT_NO", sortable: true, width: 100 },
        { header: "QTY RECEIVED", dataIndex: "QTY_RECEIVED", sortable: true, width: 100 },
        { header: "QTY INVOICE", dataIndex: "QTY_INVOICE", sortable: true, width: 100 },
        { header: "CURRENT RACK", dataIndex: "CURRENT_RACK", sortable: true, width: 100 },
        */
      ],
      bbar: {
        xtype: "pagingtoolbar",
    ...
    },
    {
      ...
      columns: [
        ...
        { header: "INVOICE NO", dataIndex: "INVOICE_NO", sortable: true, width: 100, filter: { xtype: "textfield" } },
        { header: "ARTICLE CODE", dataIndex: "ARTICLE_CODE", sortable: true, width: 100, filter: { xtype: "textfield" } },
        { header: "PARTNO", dataIndex: "PART_NO", sortable: true, width: 150, filter: { xtype: "textfield" } },
        { header: "LOT NO", dataIndex: "LOT_NO", sortable: true, width: 150, filter: { xtype: "textfield" } },
        {
          header: "QTY RECEIVED", dataIndex: "QTY_RECEIVED", sortable: true, width: 100, filter: { xtype: "textfield" }, summaryType: "sum",
          summaryRenderer: function (value, summaryData, dataIndex) {
            return '<span style="font-weight:bold;font-size:11px;">' + Ext.util.Format.number(value, "0,000.00/i") + "</span>";
          },
        },
        {
          header: "QTY INVOICE", dataIndex: "QTY_INVOICE", sortable: true, width: 100, filter: { xtype: "textfield" },
        },
        { header: "RECEIVED RACK", dataIndex: "CURRENT_RACK", sortable: true, width: 200, filter: { xtype: "textfield" } },
        /*
