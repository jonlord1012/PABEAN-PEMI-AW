...
Ext.define("NJC.INVENTORY_PLB.goods_in.FRMinv_material_in_aw", {
  extend: "Ext.window.Window",
  alias: "widget.FRMinv_material_in_aw",
  reference: "FRMinv_material_in_aw",
          ...
          items: [
            {
              ...
              items: [
                ...
                },
                {
                  ...
                  layout: "hbox",
                  items: [
                    { xtype: "datefield", labelWidth: 100, width: 220, fieldLabel: "Tgl & No Daftar", name: "TANGGAL_DAFTAR", fieldCls: "fieldlock", format: "Y-m-d", readOnly: true, hidden: true },
                    { xtype: "textfield", width: 170, name: "NOMOR_DAFTAR", fieldCls: "fieldlock", readOnly: true, enforceMaxLength: true, emptyText: "Nomor Daftar", hidden: true },
                    /*
          ...
          store: {
            ...
            listeners: {
              beforeload: function (store, operation, eOpts) {
                var me = this;
                var invNo = Ext.ComponentQuery.query("FRMinv_material_in_aw field[pid=INVOICE_NO]")[0].value;
                operation.setParams({
                  INVOICE_NO: invNo,
                });
              },
          ...
          columns: [
            ...
            },
            {
              ...
              columns: [
                ...
                { sortable: true, width: 100, filter: { xtype: "textfield" }, header: "TANGGALDOKUMEN", dataIndex: "TANGGALDOKUMEN", renderer: "formatDate", },
                ...
                { sortable: true, width: 100, align: "right", filter: { xtype: "textfield" }, header: "JUMLAHSATUAN", dataIndex: "JUMLAHSATUAN" },
              ],
  ...
  dockedItems: [
    {
      ...
      items: [
        { xtype: "tbspacer", width: 10 },
        {
          xtype: "button",
          text: "Save",
          pid: "FRMinv_material_in_aw_btsave",
        ...
        { xtype: "tbspacer", width: 10 },
        {
          xtype: "button",
          text: "POSTING",
          pid: "FRMinv_material_in_aw_btposting",
