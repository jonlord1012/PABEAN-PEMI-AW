...
Ext.define("NJC.INVENTORY_PLB.goods_in.FRMinv_goods_in_binloc", {
  extend: "Ext.window.Window",
  alias: "widget.FRMinv_goods_in_binloc",
  reference: "FRMinv_goods_in_binloc",
          ...
          store: {
            ...
            listeners: {
              beforeload: function (store, operation, eOpts) {
                try {
                  var vdate = Ext.ComponentQuery.query("FRMinv_goods_in_binloc datefield[name=TANGGAL_RCV]")[0];
                  operation.setParams({
  ...
  dockedItems: [
    {
      ...
      items: [
        ...
        { xtype: "button", text: "Process Synchronize", pid: "binloc_synchronize", icon: vconfig.getstyle + "icon/update.ico", tooltip: "Process Synchronize" },
      ],
    },
    {
      xtype: "toolbar",
