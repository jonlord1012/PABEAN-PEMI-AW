...
Ext.define("NJC.INVENTORY_PLB.goods_in.receiving_detail_goods_in", {
          ...
          items: [
            {
                  ...
                  children: [
                    {
                      ...
                      expanded: true,
                      children: [
                        { leaf: true, text: "Receiving Detail", icon: vconfig.getstyle + "icon/doc.png", allowclick: true, modulename: "receiving_detail", controlname: "GRIDreceiving_aw_detail_trans" },
                        { leaf: true, text: "Sumber Data", icon: vconfig.getstyle + "icon/doc.png", allowclick: true, modulename: "receiving_detail", controlname: "GRIDreceiving_aw_sumber_data" },
                      ],
                    },
              ...
              listeners: {
                itemclick: "receiving_detail_goods_in_link_click",
              },
            },
          ],
        },
