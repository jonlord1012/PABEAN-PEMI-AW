Ext.define("NJC.INVENTORY_PLB.goods_in.dokumenpabean.dokumenpabean_detail", {
  ...
  requires: [],
  // requires: ["NJC.SYNCHRONIZE.goods_in.dokumenpabean.Cdokumenpabean"],
  fieldDefaults: {
    labelAlign: "left",
    labelWidth: 90,
    margin: "0 10 5 0",
  ...
  items: [
    {
      ...
      columns: [
        ...
        { sortable: true, width: 200, filter: { xtype: "textfield" }, header: "URAIAN", dataIndex: "URAIAN" },
        { sortable: true, width: 100, filter: { xtype: "textfield" }, header: "JUMLAH_SATUAN", align: "right", renderer: "formatqty", dataIndex: "JUMLAH_SATUAN" },
        { sortable: true, width: 100, filter: { xtype: "textfield" }, header: "HARGA_SATUAN", align: "right", renderer: "formatqty", dataIndex: "HARGA_SATUAN" },
        { sortable: true, width: 100, filter: { xtype: "textfield" }, header: "KODE_SATUAN", dataIndex: "KODE_SATUAN" },
        { sortable: true, width: 100, filter: { xtype: "textfield" }, header: "JUMLAH_KEMASAN", align: "right", renderer: "formatqty", dataIndex: "JUMLAH_KEMASAN" },
        ...
        { sortable: true, width: 100, filter: { xtype: "textfield" }, header: "CIF", align: "right", renderer: "formatqty", dataIndex: "CIF" },
        { sortable: true, width: 100, filter: { xtype: "textfield" }, header: "CIF_RUPIAH", align: "right", renderer: "formatqty", dataIndex: "CIF_RUPIAH" },
        { sortable: true, width: 100, filter: { xtype: "textfield" }, header: "DISKON", align: "right", renderer: "formatqty", dataIndex: "DISKON" },
        { sortable: true, width: 100, filter: { xtype: "textfield" }, header: "FOB", align: "right", renderer: "formatqty", dataIndex: "FOB" },
        { sortable: true, width: 100, filter: { xtype: "textfield" }, header: "FREIGHT", align: "right", renderer: "formatqty", dataIndex: "FREIGHT" },
        { sortable: true, width: 100, filter: { xtype: "textfield" }, header: "NETTO", align: "right", renderer: "formatqty", dataIndex: "NETTO" },
        ...
        // { sortable: true, width: 100, filter: { xtype: "textfield" }, header: "HARGA_BARANG_LDP", align: "right", renderer: "formatqty", dataIndex: "HARGA_BARANG_LDP" },
        // { sortable: true, width: 100, filter: { xtype: "textfield" }, header: "HARGA_INVOICE", align: "right", renderer: "formatqty", dataIndex: "HARGA_INVOICE" },
        // { sortable: true, width: 100, filter: { xtype: "textfield" }, header: "HARGA_PENYERAHAN", align: "right", renderer: "formatqty", dataIndex: "HARGA_PENYERAHAN" },
        ...
        // { sortable: true, width: 100, filter: { xtype: "textfield" }, header: "JUMLAH_BAHAN_BAKU", align: "right", renderer: "formatqty", dataIndex: "JUMLAH_BAHAN_BAKU" },
        ...
        // { sortable: true, width: 100, filter: { xtype: "textfield" }, header: "NILAI_INCOTERM", align: "right", renderer: "formatqty", dataIndex: "NILAI_INCOTERM" },
        // { sortable: true, width: 100, filter: { xtype: "textfield" }, header: "NILAI_PABEAN", align: "right", renderer: "formatqty", dataIndex: "NILAI_PABEAN" },
