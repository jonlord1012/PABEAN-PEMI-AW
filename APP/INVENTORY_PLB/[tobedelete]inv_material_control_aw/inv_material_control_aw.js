Ext.define("TDK.INVENTORY_PLB.inv_material_control_aw.inv_material_control_aw", {
  extend: "Ext.form.Panel",
  alias: "widget.inv_material_control_aw",
  reference: "inv_material_control_aw",
  config: {},
  requires: [
    //
    ...
    "TDK.INVENTORY_PLB.inv_material_control_aw.Cinv_material_control_aw",
  ],
  ...
  initComponent: function () {
    Ext.apply(this, {
      xtype: "panel",
      pid: "panelinv_material_control_aw",
      layout: "card",
      frame: false,
      border: false,
      items: [
        {
          ...
          items: [
            {
              xtype: "dataview",
              pid: "dataview_inv_material_control_aw",
              plugins: {
