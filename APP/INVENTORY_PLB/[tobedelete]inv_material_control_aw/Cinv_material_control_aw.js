Ext.define("TDK.INVENTORY_PLB.inv_material_control_aw.Cinv_material_control_aw", {
  extend: "Ext.app.ViewController",
  alias: "controller.Cinv_material_control_aw",
  init: function (view) {
    this.control({
      "inv_material_control_aw dataview": { itemClick: this.Dodataview_click },
  ...
  Dodataview_click: function (dv, rec, e, index, el) {
    try {
      ...
      COMP.run.getmodulepopup(vfname, "TDK.INVENTORY_PLB.inv_material_control_aw." + vfname, mainpanel);
    } catch (ex) {
      COMP.TipToast.toast("Error", ex.message, { cls: "danger", delay: 2000 });
    }
  },
  FRMimc_stock_item_aw_btrefresh_click: function () {
    try {
      var me = this;
      ...
      var GRIDstock_bydocument = Ext.ComponentQuery.query("FRMimc_stock_item_aw grid[pid=GRIDstock_bydocument]")[0];
      var GRIDitem_receiving = Ext.ComponentQuery.query("FRMimc_stock_item_aw grid[pid=GRIDitem_receiving]")[0];
      var GRIDitem_out = Ext.ComponentQuery.query("FRMimc_stock_item_aw grid[pid=GRIDitem_out]")[0];
  ...
  FRMimc_list_memo_selling_aw_btrefresh_click: function () {
    try {
      var me = this;
      var GRIDmemo_selling = Ext.ComponentQuery.query("FRMimc_list_memo_selling_aw grid[pid=GRIDmemo_selling]")[0];
      GRIDmemo_selling.getStore().load();
    } catch (ex) {
      COMP.TipToast.toast("Error", ex.message, { cls: "danger", delay: 2000 });
    }
  },
  FRMimc_list_memo_scrap_aw_btrefresh_click: function () {
    try {
      var me = this;
      var GRIDmemo_scrap = Ext.ComponentQuery.query("FRMimc_list_memo_scrap_aw grid[pid=GRIDmemo_scrap]")[0];
      GRIDmemo_scrap.getStore().load();
    } catch (ex) {
      COMP.TipToast.toast("Error", ex.message, { cls: "danger", delay: 2000 });
    }
  },
  FRMimc_outstanding_receiving_aw_btrefresh_click: function () {
    try {
      var me = this;
      ...
      var GRIDoutreceiving_item = Ext.ComponentQuery.query("FRMimc_outstanding_receiving_aw grid[pid=GRIDoutreceiving_item]")[0];
      GRIDoutreceiving_item.getStore().removeAll();
    } catch (ex) {
      COMP.TipToast.toast("Error", ex.message, { cls: "danger", delay: 2000 });
    }
  },
  FRMimc_stock_itempending_aw_btrefresh_click: function () {
    try {
      var me = this;
      var GRIDstock_itempending = Ext.ComponentQuery.query("FRMimc_stock_itempending_aw grid[pid=GRIDstock_itempending]")[0];
      GRIDstock_itempending.getStore().load();
    } catch (ex) {
      COMP.TipToast.toast("Error", ex.message, { cls: "danger", delay: 2000 });
    }
  },
  FRMimc_stock_item_aw_GRIDmutasi_stock_itemclick: function (cmp, rec) {
    try {
      var me = this;
      var GRIDstock_bydocument = Ext.ComponentQuery.query("FRMimc_stock_item_aw grid[pid=GRIDstock_bydocument]")[0];
  ...
  FRMimc_list_memo_selling_aw_GRIDmemo_selling_itemclick: function (cmp, rec) {
    try {
      var me = this;
      var GRIDmemo_selling_item = Ext.ComponentQuery.query("FRMimc_list_memo_selling_aw grid[pid=GRIDmemo_selling_item]")[0];
      GRIDmemo_selling_item.getStore().load();
    } catch (ex) {
      COMP.TipToast.toast("Error", ex.message, { cls: "danger", delay: 2000 });
    }
  },
  FRMimc_list_memo_scrap_aw_GRIDmemo_scrap_itemclick: function (cmp, rec) {
    try {
      var me = this;
      var GRIDmemo_scrap_item = Ext.ComponentQuery.query("FRMimc_list_memo_scrap_aw grid[pid=GRIDmemo_scrap_item]")[0];
      GRIDmemo_scrap_item.getStore().load();
    } catch (ex) {
      COMP.TipToast.toast("Error", ex.message, { cls: "danger", delay: 2000 });
    }
  },
  FRMimc_outstanding_receiving_aw_GRIDoutreceiving_header_itemclick: function (cmp, rec) {
    try {
      var me = this;
      var GRIDoutreceiving_item = Ext.ComponentQuery.query("FRMimc_outstanding_receiving_aw grid[pid=GRIDoutreceiving_item]")[0];
      ...
      Ext.MessageBox.confirm(
        ...
        function (button) {
          if (button === "yes") {
            ...
            var hasil = COMP.run.getservice(vconfig.service_api + "inv_material_control_aw/inv_material_control_aw", params, "POST", me.var_global.jwt);
  ...
  btcancel_memo_scrap: function (xgrid, rowIndex) {
    try {
      var me = this;
      var GRIDmemo_selling_item = Ext.ComponentQuery.query("FRMimc_list_memo_scrap_aw grid[pid=GRIDmemo_scrap_item]")[0];
      var GRIDmemo_selling = Ext.ComponentQuery.query("FRMimc_list_memo_scrap_aw grid[pid=GRIDmemo_scrap]")[0];
      var vdt = xgrid.getStore().getAt(rowIndex).data;
      xgrid.getSelectionModel().select(rowIndex);
      Ext.MessageBox.confirm(
        "Cancel Memo Scrap",
  ...
  FRMimc_report_stock_aw_btrefresh_click: function () {
    try {
      var GRIDreport_stock = Ext.ComponentQuery.query("FRMimc_report_stock_aw grid[pid=GRIDreport_stock]")[0];
      GRIDreport_stock.getStore().load();
    } catch (ex) {
      COMP.TipToast.toast("Error", ex.message, { cls: "danger", delay: 2000 });
    }
  },
  FRMimc_report_stock_aw_btsearch_click: function () {
    try {
     /*
      var FRM_MAIN = Ext.ComponentQuery.query("FRMimc_report_stock_aw form")[0];
  ...
  FRMimc_report_summary_aw_btrefresh_click: function () {
    try {
      var GRIDreport_summary = Ext.ComponentQuery.query("FRMimc_report_summary_aw grid[pid=GRIDreport_summary]")[0];
      GRIDreport_summary.getStore().load();
    } catch (ex) {
      COMP.TipToast.toast("Error", ex.message, { cls: "danger", delay: 2000 });
    }
  },
  FRMimc_report_summary_aw_btsearch_click: function () {
    try {
     /*
      var FRM_MAIN = Ext.ComponentQuery.query("FRMimc_report_summary_aw form")[0];
      var dtval = FRM_MAIN.getValues(false, false, false, true);
      if (dtval.tfromdate === null) {
        COMP.TipToast.toast("Error", "Pilih tanggal Start lebih dulu", { cls: "danger", delay: 2000 });
        return;
