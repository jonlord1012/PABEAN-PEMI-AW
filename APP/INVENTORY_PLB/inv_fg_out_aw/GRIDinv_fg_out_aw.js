Ext.define("TDK.INVENTORY_AW.inv_fg_out_aw.GRIDinv_fg_out_aw", {
  extend: "Ext.form.Panel",
  alias: "widget.GRIDinv_fg_out_aw",
  reference: "GRIDinv_fg_out_aw",
  frame: false,
  border: false,
  autoScroll: true,
  ...
  listeners: {
    afterrender: "GRIDinv_fg_out_aw_load",
  },
});
