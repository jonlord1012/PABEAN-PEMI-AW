...
Ext.define("TDK.INVENTORY_AW.inv_wip_out_aw.FRMinv_wip_out_aw", {
  extend: "Ext.window.Window",
  alias: "widget.FRMinv_wip_out_aw",
  reference: "FRMinv_wip_out_aw",
  ...
  dockedItems: [
    {
      ...
      items: [
        { xtype: "tbspacer", width: 10 },
        {
          xtype: "button",
          text: "Save",
          pid: "FRMinv_wip_out_aw_btsave",
          icon: vconfig.getstyle + "icon/save.gif",
          tooltip: "Save Data",
          handler: "FRMinv_wip_out_aw_btsave_click",
        },
      ],
    },
  ],
