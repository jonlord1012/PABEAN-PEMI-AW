Ext.define("TDK.INVENTORY_AW.inv_wip_out_aw.GRIDinv_wip_out_aw", {
  extend: "Ext.form.Panel",
  alias: "widget.GRIDinv_wip_out_aw",
  reference: "GRIDinv_wip_out_aw",
  frame: false,
  border: false,
  autoScroll: true,
  ...
  items: [
    {
      ...
      columns: [
        ...
        },
        {
          text: "DOKUMEN",
          columns: [
            { header: "RECEIPT_DATE", dataIndex: "RECEIPT_DATE", sortable: true, width: 100, filter: { xtype: "textfield" } },
            ...
            { header: "BC TYPE", dataIndex: "BC_TYPE", sortable: true, width: 50, filter: { xtype: "textfield" } },
      ...
      listeners: {
        afterrender: "GRIDinv_wip_out_aw_load",
      },
    },
  ],
});
