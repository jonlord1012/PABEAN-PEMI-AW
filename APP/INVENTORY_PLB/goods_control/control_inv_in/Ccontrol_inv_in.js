Ext.define("NJC.INVENTORY_PLB.inv_material_control_aw.control_inv_in.Ccontrol_inv_in", {
  ...
  control_inv_in_tracing_link_click: function (cmp, dt) {
    try {
      ...
      var cls = "NJC.INVENTORY_PLB.inv_material_control_aw.control_inv_in" + "." + vmodulecontrol;
