...
Ext.define("NJC.INVENTORY_PLB.inv_material_control_aw.FRMimc_stock_itempending_aw", {
  extend: "Ext.window.Window",
  alias: "widget.FRMimc_stock_itempending_aw",
  reference: "FRMimc_stock_itempending_aw",
  ...
  dockedItems: [
    {
      ...
      items: [
        ...
        { xtype: "button", text: "Refresh", pid: "FRMimc_stock_itempending_aw_btrefresh", icon: vconfig.getstyle + "icon/update.ico", tooltip: "Refresh Data" },
      ],
    },
  ],
  listeners: {
