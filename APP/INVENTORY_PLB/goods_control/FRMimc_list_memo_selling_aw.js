...
Ext.define("NJC.INVENTORY_PLB.inv_material_control_aw.FRMimc_list_memo_selling_aw", {
  extend: "Ext.window.Window",
  alias: "widget.FRMimc_list_memo_selling_aw",
  reference: "FRMimc_list_memo_selling_aw",
  title: "Memo Selling",
  modal: true,
  closeAction: "hide",
  centered: true,
              ...
              items: [
                {
                  ...
                  handler: "btcancel_memo_selling",
                  tooltip: "Cancel Memo Selling Dokumen",
                },
              ],
            },
            ...
            listeners: {
              beforeload: function (store, operation, eOpts) {
                try {
                  ...
                  var vdt = GRIDmemo_selling.getSelectionModel().getSelection()[0];
                  if (vdt) {
                    operation.setParams({
                      method: "memo_selling_byitem",
  ...
  dockedItems: [
    {
      ...
      items: [
        ...
        { xtype: "button", text: "Refresh", pid: "FRMimc_list_memo_selling_aw_btrefresh", icon: vconfig.getstyle + "icon/update.ico", tooltip: "Refresh Data" },
      ],
    },
  ],
  listeners: {
