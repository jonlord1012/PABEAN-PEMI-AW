...
Ext.define("NJC.INVENTORY_PLB.inv_material_control_aw.FRMimc_list_memo_scrap_aw", {
  extend: "Ext.window.Window",
  alias: "widget.FRMimc_list_memo_scrap_aw",
  reference: "FRMimc_list_memo_scrap_aw",
  title: "Memo Scrap",
  modal: true,
  closeAction: "hide",
  centered: true,
  ...
  dockedItems: [
    {
      ...
      items: [
        ...
        { xtype: "button", text: "Refresh", pid: "FRMimc_list_memo_scrap_aw_btrefresh", icon: vconfig.getstyle + "icon/update.ico", tooltip: "Refresh Data" },
      ],
    },
  ],
  listeners: {
