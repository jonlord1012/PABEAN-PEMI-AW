...
Ext.define("NJC.INVENTORY_PLB.goods_control.FRMimc_history", {
  extend: "Ext.window.Window",
  alias: "widget.FRMimc_history",
  reference: "FRMimc_history",
  title: "BC History",
  modal: true,
  closeAction: "hide",
  centered: true,
      ...
      items: [
        {
          ...
          store: {
            ...
            listeners: {
              beforeload: function (store, operation, eOpts) {
                try {
                  var GRIDheader = Ext.ComponentQuery.query("FRMimc_history grid[pid=GRIDFRMwip_list_bchistory_header]")[0];
