...
Ext.define("TDK.INVENTORY_AW.inv_wip_in_aw.FRMinv_wip_in_aw_pis", {
  extend: "Ext.window.Window",
  alias: "widget.FRMinv_wip_in_aw_pis",
  reference: "FRMinv_wip_in_aw_pis",
          ...
          store: {
            ...
            listeners: {
              beforeload: function (store, operation, eOpts) {
                try {
                  var vdate = Ext.ComponentQuery.query("FRMinv_wip_in_aw_pis datefield[name=TANGGAL_RCV]")[0];
                  operation.setParams({
