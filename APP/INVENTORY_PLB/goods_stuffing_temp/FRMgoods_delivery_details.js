                    ...
                    listeners: {
                      beforeload: function (store, operation, eOpts) {
                        try {
                          ...
                          var labelInvoice = Ext.ComponentQuery.query("FRMgoods_delivery_details field[pid=INVOICE_NO]")[0];
                          var labelCustomer = Ext.ComponentQuery.query("FRMgoods_delivery_details field[pid=CODE_CUSTOMER]")[0];
              ...
              items: [
                {
                  ...
                  columns: [
                    ...
                    { header: "NO BUKTI", dataIndex: "NO_BUKTI", sortable: true, width: 200, filter: { xtype: "textfield" } },
                    ...
                    { header: "QTY", dataIndex: "QTY_PICKING", sortable: true, width: 100, renderer: "formatqty", filter: { xtype: "textfield" } },
                    /*
                ...
                },
                {
                  ...
                  columns: [
                    { xtype: "rownumberer", width: 50 },
                    { sortable: true, width: 200, filter: { xtype: "textfield" }, header: "NO DRAFT", dataIndex: "NO_DRAFT" },
                    { sortable: true, width: 150, filter: { xtype: "textfield" }, header: "NO BUKTI", dataIndex: "NO_BUKTI" },
                    { sortable: true, width: 100, filter: { xtype: "textfield" }, header: "TANGGAL", dataIndex: "TANGGAL" },
                    { sortable: true, width: 180, filter: { xtype: "textfield" }, header: "KODE BARANG", dataIndex: "KODE_BARANG_INVOICE" },
  ...
  dockedItems: [
    {
      ...
      items: [
        { xtype: "tbspacer", width: 10 },
        {
          xtype: "button",
          text: "Save",
          pid: "FRM_goods_delivery_btsave",
          icon: vconfig.getstyle + "icon/save.gif",
          tooltip: "Save Data",
          handler: "FRM_goods_delivery_btsave_click",
        },
      ],
    },
  ],
