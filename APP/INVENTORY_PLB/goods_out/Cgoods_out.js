Ext.define("NJC.INVENTORY_PLB.goods_out.Cgoods_out", {
  extend: "Ext.app.ViewController",
  alias: "controller.Cgoods_out",
  init: function (view) {
    this.control({
      "goods_out [pid=out_to_production_bicc]": { click: this.out_to_production_bicc_click },
      "goods_out [pid=out_to_production_manual_aw]": { click: this.out_to_production_manual_aw_click },
      "goods_out [pid=out_to_memo_scrap_aw]": { click: this.out_to_memo_scrap_aw_click },
      "goods_out [pid=out_to_memo_selling_aw]": { click: this.out_to_memo_selling_aw_click },

      "goods_out [pid=btrefresh_main]": { click: this.btrefresh_main_click },
  ...
  btrefresh_main_click: function () {
    try {
      var me = this;
      var GRID = Ext.ComponentQuery.query("GRIDgoods_out grid[pid=GRIDgoods_out]")[0];
      GRID.getStore().load();
    } catch (ex) {
      COMP.TipToast.toast("Error", ex.message, { cls: "danger", delay: 2000 });
    }
  ...
  out_to_production_bicc_click: function () {
    try {
      ...
      COMP.run.getmodulepopup("FRMout_toproduction_bicc", "NJC.INVENTORY_PLB.goods_out.FRMout_toproduction_bicc", mainpanel);
    } catch (ex) {
      COMP.TipToast.toast("Error", ex.message, { cls: "danger", delay: 2000 });
    }
  },
  out_to_production_manual_aw_click: function () {
    try {
      var me = this;
      var mainpanel = Ext.ComponentQuery.query("mainpage")[0];
      COMP.run.getmodulepopup("FRMout_toproduction_manual_aw", "NJC.INVENTORY_PLB.goods_out.FRMout_toproduction_manual_aw", mainpanel);
    } catch (ex) {
      COMP.TipToast.toast("Error", ex.message, { cls: "danger", delay: 2000 });
    }
  },
  ...
  out_to_memo_scrap_aw_click: function () {
    try {
      var me = this;
      var mainpanel = Ext.ComponentQuery.query("mainpage")[0];
      COMP.run.getmodulepopup("FRMout_toscrap_mt_aw", "NJC.INVENTORY_PLB.goods_out.FRMout_toscrap_mt_aw", mainpanel);
    } catch (ex) {
      COMP.TipToast.toast("Error", ex.message, { cls: "danger", delay: 2000 });
    }
  },
  out_to_memo_selling_aw_click: function () {
    try {
      var me = this;
      var mainpanel = Ext.ComponentQuery.query("mainpage")[0];
      COMP.run.getmodulepopup("FRMout_toselling_mt_aw", "NJC.INVENTORY_PLB.goods_out.FRMout_toselling_mt_aw", mainpanel);
    } catch (ex) {
      COMP.TipToast.toast("Error", ex.message, { cls: "danger", delay: 2000 });
    }
  },
  out_toprod_btselectpart_aw_click: function () {
    try {
      ...
      var popup = Ext.define("NJC.INVENTORY_PLB.inv_material_in.popup_list_outtoprod_selectpart", {
        ...
        items: [
          {
            ...
            store: {
              ...
              proxy: {
                ...
                url: vconfig.service_api + "goods_out/goods_outs",
                extraParams: {
  ...
  FRMout_toproduction_manual_aw_btsave_click: function () {
    try {
      ...
      var GRIDMAIN = Ext.ComponentQuery.query("goods_out GRIDgoods_out grid[pid=GRIDgoods_out]")[0];
      ...
      Ext.MessageBox.confirm(
        ...
        function (button) {
          if (button === "yes") {
            ...
            var hasil = COMP.run.getservice(vconfig.service_api + "goods_out/goods_out", params, "POST", me.var_global.jwt);
  ...
  toproduction_link_click: function (cmp, dt) {
    try {
      ...
      var cls = "NJC.INVENTORY_PLB.goods_out." + vdt.module + "." + id + "." + id;
  ...
  popup_itempart: function (FRM, vdt_form, GRIDitem) {
    try {
      ...
      var popup = Ext.define("NJC.INVENTORY_PLB.goods_out.popup_itempart", {
        extend: "Ext.window.Window",
  ...
  btdetail_aw_rows_select_invoice: function (xgrid, rowIndex) {
    try {
      ...
      var mainpanel = Ext.ComponentQuery.query("mainpage")[0];
      var popup = Ext.define("NJC.INVENTORY_PLB.goods_out.FRMout_toproduction_bicc.popup_selectinvoice", {
        extend: "Ext.window.Window",
