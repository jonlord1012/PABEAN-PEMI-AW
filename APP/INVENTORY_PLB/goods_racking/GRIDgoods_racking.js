Ext.define("NJC.INVENTORY_PLB.goods_racking.GRIDgoods_racking", {
  extend: "Ext.form.Panel",
  alias: "widget.GRIDgoods_racking",
  reference: "GRIDgoods_racking",
  frame: false,
  border: false,
  autoScroll: true,
  ...
  items: [
    {
      ...
      columns: [
        ...
        },
        {
          ...
          columns: [
            ...
            { header: "MPQ", dataIndex: "PART_MPQ", sortable: true, renderer: "formatqty", width: 65, filter: { xtype: "textfield" } },
            { header: "RACK", dataIndex: "RACK_NAME", sortable: true, width: 170, filter: { xtype: "textfield" } },
      ...
      listeners: {
        afterrender: "GRIDgoods_racking_load",
      },
    },
  ],
});
