...
Ext.define("TDK.SPAREPART.msp_item_torque.FRMmsp_item_torque", {
  extend: "Ext.window.Window",
  alias: "widget.FRMmsp_item_torque",
  reference: "FRMmsp_item_torque",
  ...
  listeners: {
    afterrender: "FRMmsp_item_torque_load",
  },
});
