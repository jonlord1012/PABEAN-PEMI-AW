Ext.define("NJC.EXIM.bcin_40.GRIDbcin_40", {
  extend: "Ext.form.Panel",
  alias: "widget.GRIDbcin_40",
  reference: "GRIDbcin_40",
  frame: false,
  border: false,
  ...
  items: [
    {
      ...
      store: {
        ...
        proxy: {
          ...
          url: vconfig.service_api + "bcin_40/bcin_40s",
          extraParams: {
            method: "read_data",
          },
          reader: {
        ...
        listeners: {
          beforeload: function (store, operation, eOpts) {
            try {
              var CBO_FILTERKEY = Ext.ComponentQuery.query("bcin_40 combobox[name=CBO_FILTERKEY]")[0];
              operation.setParams({
