Ext.define("TDK.EXIM.bcin_262.GRIDbcin_262", {
  extend: "Ext.form.Panel",
  alias: "widget.GRIDbcin_262",
  reference: "GRIDbcin_262",
  frame: false,
  border: false,
  autoScroll: true,
  ...
  //         url: vconfig.service_api + "bcin_262/bcin_262s",
  //         reader: {
  //           type: "json",
  //           rootProperty: "Rows",
  ...
  //           try {
  //             var CBO_FILTERKEY = Ext.ComponentQuery.query("bcin_262 combobox[name=CBO_FILTERKEY]")[0];
  //             operation.setParams({
