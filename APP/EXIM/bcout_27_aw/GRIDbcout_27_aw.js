Ext.define("NJC.EXIM.bcout_27_aw.GRIDbcout_27_aw", {
  extend: "Ext.form.Panel",
  alias: "widget.GRIDbcout_27_aw",
  reference: "GRIDbcout_27_aw",
  frame: false,
  border: false,
  autoScroll: true,
  ...
  items: [
    {
      ...
      store: {
        ...
        proxy: {
          ...
          url: vconfig.service_api + "bcout_27/bcout_27s",
          extraParams: {
            method: "read_to_grid",
          },
          reader: {
        ...
        listeners: {
          beforeload: function (store, operation, eOpts) {
            try {
              var CBO_FILTERKEY = Ext.ComponentQuery.query("bcout_27_aw combobox[name=CBO_FILTERKEY]")[0];
              operation.setParams({
      ...
      columns: [
        ...
        { header: "BC TYPE", dataIndex: "BC_TYPE", sortable: true, flex: 1, filter: { xtype: "textfield" } },
        //{ header: "SOURCE", dataIndex: "MODE_SOURCE", sortable: true, width: 65, filter: { xtype: "textfield" } },
        { header: "INVOICE", dataIndex: "EDS_ORDER_NO", sortable: true, flex: 1, filter: { xtype: "textfield" } },
        { header: "INV DATE", dataIndex: "EDS_ORDER_DATE", sortable: true, flex: 1, filter: { xtype: "textfield" } },
        { header: "NOMOR DAFTAR", dataIndex: "NOMOR_DAFTAR", sortable: true, flex: 1, filter: { xtype: "textfield" } },
        { header: "AJU DATE", dataIndex: "TANGGAL_DAFTAR", sortable: true, flex: 1, filter: { xtype: "textfield" }, renderer: "formatDate" },
        { header: "NO AJU", dataIndex: "NOMOR_AJU", sortable: true, flex: 1, filter: { xtype: "textfield" } },
        { header: "AJU DATE", dataIndex: "TANGGAL_AJU", sortable: true, flex: 1, filter: { xtype: "textfield" }, renderer: "formatDate" },
        ...
        { header: "PENGUSAHA", dataIndex: "PENGUSAHA", sortable: true, flex: 1, filter: { xtype: "textfield" } },
        { header: "PENERIMA", dataIndex: "PENERIMA", sortable: true, flex: 1, filter: { xtype: "textfield" } },
      ],
      bbar: {
        xtype: "pagingtoolbar",
        displayInfo: true,
