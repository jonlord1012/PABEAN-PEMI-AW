Ext.define("NJC.EXIM.bcout_41_aw.GRIDbcout_41_aw", {
    extend: "Ext.form.Panel",
    alias: "widget.GRIDbcout_41_aw",
    reference: "GRIDbcout_41_aw",
    frame: false,
    border: false,
    autoScroll: true,
        ...
        store: {
          ...
          listeners: {
            beforeload: function (store, operation, eOpts) {
              try {
                var CBO_FILTERKEY = Ext.ComponentQuery.query("bcout_41_aw combobox[name=CBO_FILTERKEY]")[0];
                operation.setParams({
