...
Ext.define("TDK.EXIM.bcin_kurir20.FRMbcin_kurir20_dokumen", {
  extend: "Ext.window.Window",
  alias: "widget.FRMbcin_kurir20_dokumen",
  reference: "FRMbcin_kurir20_dokumen",
  title: "Input Dokumen",
  modal: true,
  closeAction: "destroy",
  centered: true,
      ...
      items: [
        {
          ...
          listeners: {
            afterrender: function (grid, record, e) {
              var GRIDinput_dokumen = Ext.ComponentQuery.query("FRMbcin_kurir20 grid[pid=GRIDbcin_kurir20_input_dokumen]")[0];
