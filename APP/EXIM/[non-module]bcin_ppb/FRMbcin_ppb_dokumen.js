...
Ext.define("TDK.EXIM.bcin_ppb.FRMbcin_ppb_dokumen", {
  extend: "Ext.window.Window",
  alias: "widget.FRMbcin_ppb_dokumen",
  reference: "FRMbcin_ppb_dokumen",
  title: "",
  modal: true,
  closeAction: "destroy",
  centered: true,
      ...
      items: [
        {
          ...
          listeners: {
            afterrender: function (grid, record, e) {
              var GRIDinput_dokumen = Ext.ComponentQuery.query("FRMbcin_ppb grid[pid=GRIDinput_dokumen]")[0];
