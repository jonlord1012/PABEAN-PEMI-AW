Ext.define("TDK.EXIM.bcin_ppb.GRIDbcin_ppb", {
  extend: "Ext.form.Panel",
  alias: "widget.GRIDbcin_ppb",
  reference: "GRIDbcin_ppb",
  frame: false,
  border: false,
  autoScroll: true,
  ...
  items: [
    {
      ...
      store: {
        ...
        proxy: {
          ...
          url: vconfig.service_api + "bcin_ppb/bcin_ppbs",
          reader: {
            type: "json",
            rootProperty: "Rows",
        ...
        listeners: {
          beforeload: function (store, operation, eOpts) {
            try {
              var CBO_FILTERKEY = Ext.ComponentQuery.query("bcin_ppb combobox[name=CBO_FILTERKEY]")[0];
              operation.setParams({
