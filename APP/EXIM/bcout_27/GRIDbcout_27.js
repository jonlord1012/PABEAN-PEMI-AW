Ext.define("NJC.EXIM.bcout_27.GRIDbcout_27", {
    extend: "Ext.form.Panel",
    alias: "widget.GRIDbcout_27",
    reference: "GRIDbcout_27",
    frame: false,
    border: false,
    autoScroll: true,
        ...
        store: {
          ...
          listeners: {
            beforeload: function (store, operation, eOpts) {
              try {
                var CBO_FILTERKEY = Ext.ComponentQuery.query("bcout_27 combobox[name=CBO_FILTERKEY]")[0];
                operation.setParams({
