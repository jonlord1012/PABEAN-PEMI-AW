Ext.define("NJC.EXIM.bcout_27.GRIDbarang", {
    ...
    "filterfield",
    {
      ...
      widget: {
        ...
        columns: [
          ...
          { header: "KODE BARANG", dataIndex: "KODEBARANG", sortable: true, width: 100, hidden: false, filter: { xtype: "textfield" } },
          { header: "URAIAN", dataIndex: "URAIAN", sortable: true, width: 250, hidden: false, filter: { xtype: "textfield" } },
          ...
          { header: "KODE SATUAN", dataIndex: "KODESATUAN", sortable: true, width: 100, hidden: false, filter: { xtype: "textfield" } },
          ...
          { header: "SERIBARANG ASAL", dataIndex: "SERIBARANGASAL", sortable: true, width: 100, hidden: false, filter: { xtype: "textfield" } },
  ...
  columns: [
    ...
    { header: "Seri Barang", dataIndex: "SERIBARANG", sortable: true, width: 70, hidden: false, filter: { xtype: "textfield" } },
    { header: "Uraian", dataIndex: "URAIAN", sortable: true, width: 250, hidden: false, filter: { xtype: "textfield" } },
    { header: "Tipe", dataIndex: "TIPE", sortable: true, width: 150, hidden: false, filter: { xtype: "textfield" } },
