Ext.define("TDK.EXIM.bcout_28_ftz.Cbcout_28_ftz", {
  extend: "Ext.app.ViewController",
  alias: "controller.Cbcout_28_ftz",
  init: function (view) {
    this.control({
      "bcout_28_ftz GRIDbcout_28_ftz button[pid=btnew]": { click: this.btnew_click },
      "bcout_28_ftz grid[pid=GRIDbcout_28_ftz]": { itemdblclick: this.GRIDbcout_28_ftz_itemdblclick },
      "FRMbcout_28_ftz button[pid=bttambah_dokumen]": { click: this.bttambah_dokumen_click },
      "FRMbcout_28_ftz button[pid=btsearch]": { click: this.btsearch_click },
      "FRMbcout_28_ftz button[pid=btinput_item_detail]": { click: this.btinput_item_detail_click },
      "FRMbcout_28_ftz button[pid=btinput_item_impor]": { click: this.btinput_item_impor_click },
      "FRMbcout_28_ftz button[pid=btinput_item_lokal]": { click: this.btinput_item_lokal_click },
      "FRMbcout_28_ftz_item_detail button[pid=btedit_dokumen_item_detail]": { click: this.btedit_dokumen_item_detail_click },
      "FRMbcout_28_ftz_item_lokal button[pid=btedit_dokumen_item_lokal]": { click: this.btedit_dokumen_item_lokal_click },
      "FRMbcout_28_ftz_item_impor button[pid=btedit_dokumen_item_impor]": { click: this.btedit_dokumen_item_impor_click },

      "FRMbcout_28_ftz_item_detail button[pid=btinput_bea_masuk_tambahan]": { click: this.btinput_bea_masuk_tambahan_click },
      "FRMbcout_28_ftz_item_impor button[pid=btinput_bea_masuk_tambahan]": { click: this.btinput_bea_masuk_tambahan_click },
  ...
  GRIDbcout_28_FTZ_load: function () {
    try {
      ...
      var GRID = Ext.ComponentQuery.query("bcout_28_FTZ GRIDbcout_28_FTZ grid[pid=GRIDbcout_28_FTZ]")[0];
      GRID.reconfigure(STGRIDnew);
    } catch (ex) {
      COMP.TipToast.toast("Error", ex.message, { cls: "danger", delay: 2000 });
    }
  },
  GRIDbcout_28_FTZ_itemdblclick: function (cmp, rec) {
    try {
      var me = this;
      var mainpanel = Ext.ComponentQuery.query("mainpage")[0];
      var vdt = rec.data;
      var load_edit = COMP.run.getmodulepopup("FRMbcout_28_FTZ", "TDK.EXIM.bcout_28_FTZ.FRMbcout_28_FTZ", mainpanel);
      if (load_edit) {
        var FRM = Ext.ComponentQuery.query("FRMbcout_28_FTZ")[0];
  ...
  btnew_click: function () {
    try {
      ...
      COMP.run.getmodulepopup("FRMbcout_28_FTZ", "TDK.EXIM.bcout_28_FTZ.FRMbcout_28_FTZ", mainpanel);
    } catch (ex) {
      COMP.TipToast.toast("Error", ex.message, { cls: "danger", delay: 2000 });
    }
  },
  FRMbcout_28_FTZ_load: function (frm) {
    try {
      var FRM = frm.query("form")[0];
      FRM.getForm().reset();
    } catch (ex) {
  ...
  btsearch_click: function (btn) {
    try {
      var me = this;
      var mainpanel = Ext.ComponentQuery.query("mainpage")[0];
      var popup = Ext.define("TDK.EXIM.bcout_28_FTZ.popup_btsearch", {
            ...
            listeners: {
              itemdblclick: function (grid, rec) {
                switch (btn.vdata.modulename) {
                  case "kantorpabean":
                    var FRM = Ext.ComponentQuery.query("FRMbcout_28_FTZ form")[0];
  ...
  bttambah_dokumen_click: function () {
    try {
      ...
      var mainpanel = Ext.ComponentQuery.query("mainpage")[0];
      var popup = Ext.define("TDK.EXIM.bcout_28_FTZ.popup_btadddokumen", {
        extend: "Ext.window.Window",
