Ext.define("NJC.EXIM.bcout_28.GRIDbcout_28", {
    extend: "Ext.form.Panel",
    alias: "widget.GRIDbcout_28",
    reference: "GRIDbcout_28",
    frame: false,
    border: false,
    autoScroll: true,
    ...
    items: [
      {
        ...
        store: {
          ...
          proxy: {
            ...
            url: vconfig.service_api + "bcout_28/bcout_28s",
            extraParams: {
              method: "read_data",
            },
            reader: {
          ...
          listeners: {
            beforeload: function (store, operation, eOpts) {
              try {
                var CBO_FILTERKEY = Ext.ComponentQuery.query("bcout_28 combobox[name=CBO_FILTERKEY]")[0];
                operation.setParams({
