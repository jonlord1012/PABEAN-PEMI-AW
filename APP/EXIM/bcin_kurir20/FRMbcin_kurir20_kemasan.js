...
Ext.define("TDK.EXIM.bcin_kurir20.FRMbcin_kurir20_kemasan", {
  extend: "Ext.window.Window",
  alias: "widget.FRMbcin_kurir20_kemasan",
  reference: "FRMbcin_kurir20_kemasan",
      ...
      items: [
        {
          ...
          listeners: {
            afterrender: function (grid, record, e) {
              var GRIDinput_dokumen = Ext.ComponentQuery.query("FRMbcin_kurir20 grid[pid=GRIDinput_dokumen]")[0];
