Ext.define("TDK.EXIM.bcin_kurir20.GRIDbcin_kurir20", {
  extend: "Ext.form.Panel",
  alias: "widget.GRIDbcin_kurir20",
  reference: "GRIDbcin_kurir20",
  frame: false,
  border: false,
  autoScroll: true,
  ...
  //         url: vconfig.service_api + "bcin_kurir20/bcin_kurir20s",
  //         reader: {
  //           type: "json",
  //           rootProperty: "Rows",
  ...
  //           try {
  //             var CBO_FILTERKEY = Ext.ComponentQuery.query("bcin_kurir20 combobox[name=CBO_FILTERKEY]")[0];
  //             operation.setParams({
