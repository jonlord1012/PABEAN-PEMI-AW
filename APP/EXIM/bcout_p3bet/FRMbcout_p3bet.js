...
Ext.define("NJC.EXIM.bcout_p3bet.FRMbcout_p3bet", {
  extend: "Ext.window.Window",
  alias: "widget.FRMbcout_p3bet",
  reference: "FRMbcout_p3bet",
  title: "Header Dokumen BC P3BET",
  modal: true,
  closeAction: "destroy",
  centered: true,
  requires: [
    //
    "NJC.EXIM.bcout_p3bet.Cbcout_p3bet",
  ],
                          ...
                          handler: function () {
                            try {
                              ...
                              var GRIDpelabuhan = Ext.create(
                                "NJC.EXIM.bcout_p3bet.GRIDentitas",
                                {
                                  listeners: {
                  ...
                  items: [
                    {
                      ...
                      items: [
                        {
                          xtype: "grid",
                          pid: "GRIDbcout_p3bet_pengangkut",
                            ...
                            //
                            {
                              ...
                              handler: function () {
                                try {
                                  ...
                                  console.log(vdt);
                                  var GRIDpengangkut = this.up("grid[pid=GRIDbcout_p3bet_pengangkut]");
                        ...
                        { xtype: "textfield", width: 200, name: "KODE_PEL_MUATNAME", fieldCls: "fieldlock", readOnly: true },
                        {
                          ...
                          handler: function () {
                            try {
                              ...
                              var FRM = me.up("form");
                              var GRIDpelabuhan = Ext.create(
                                "NJC.EXIM.bcout_p3bet.GRIDpelabuhan",
                                {
                                  listeners: {
                                    itemdblClick: function (cmp, rec) {
                                      FRM.getForm().setValues({
                          ...
                          tbar: [
                            {
                              ...
                              handler: function () {
                                try {
                                  var FRM = this.up("form");
                                  var vdt = FRM.getValues(false, false, false, true);
                                  var GRID = this.up("grid[pid=GRIDbcout_p3bet_kontainer]");
                                  GRID.getStore().add({
                                    ID: 0,
                                    SERI: 0,
                                    KODEUKURANKONTAINER: "",
                          ...
                          tbar: [
                            {
                              ...
                              handler: function () {
                                try {
                                  var FRM = this.up("form");
                                  var vdt = FRM.getValues(false, false, false, true);
                                  var GRID = this.up("grid[pid=GRIDbcout_p3bet_kemasan]");
                                  GRID.getStore().add({
                                    JUMLAHKEMASAN: 0,
                                    SERI: 0,
                                    KODEKEMASAN: "",
                              ...
                              handler: function () {
                                try {
                                  ...
                                  var GRIDdokumen = Ext.create(
                                    "NJC.EXIM.bcout_p3bet.GRIDdokumen",
                                    {
                                      listeners: {
                                        itemdblClick: function (cmp, rec) {
                                          var me = this;
                                          var GRID = Ext.ComponentQuery.query("FRMbcout_p3bet grid[pid=GRIDbcout_p3bet_dokumen]")[0];
                              ...
                              handler: function () {
                                try {
                                  var GRIDbarang = Ext.create(
                                    "NJC.EXIM.bcout_p3bet.GRIDbarang",
                                    {
                                      //
                                    },
                                    this
  ...
  dockedItems: [
    {
      xtype: "toolbar",
      pid: "toolbar_FRMbcout_p3bet",
      height: 30,
      dock: "top",
      items: [
        { xtypeL: "tbspacer", width: 5 },
        { xtype: "button", text: "Cancel Dokumen", id: "btcancel_dokumen", pid: "btcancel_dokumen", icon: vconfig.getstyle + "icon/delete.ico", tooltip: "Cancel Dokumen BC P3BET", handler: "btcancel_click" },
        { xtype: "button", text: "Update Dokumen", id: "btsimpan_draft", pid: "btsimpan_draft", icon: vconfig.getstyle + "icon/save.gif", tooltip: "Proses Update Dokumen BC P3BET", handler: "btupdate_click" },
        { xtype: "button", text: "Kunci Perubahan Dokumen", id: "btposting_click", pid: "btposting_click", icon: vconfig.getstyle + "icon/lock.png", tooltip: "Proses Lock Dokumen BC P3BET", handler: "btposting_click" },
        "-",
