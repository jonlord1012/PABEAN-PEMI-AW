Ext.define("NJC.EXIM.bcout_p3bet.GRIDbcout_p3bet", {
    extend: "Ext.form.Panel",
    alias: "widget.GRIDbcout_p3bet",
    reference: "GRIDbcout_p3bet",
    frame: false,
    border: false,
    autoScroll: true,
    ...
    items: [
      {
        ...
        store: {
          ...
          proxy: {
            ...
            url: vconfig.service_api + "bcout_p3bet/bcout_p3bets",
            extraParams: {
              method: "read_data",
            },
            reader: {
          ...
          listeners: {
            beforeload: function (store, operation, eOpts) {
              try {
                var CBO_FILTERKEY = Ext.ComponentQuery.query("bcout_p3bet combobox[name=CBO_FILTERKEY]")[0];
                operation.setParams({
