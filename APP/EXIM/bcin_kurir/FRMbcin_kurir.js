...
Ext.define("TDK.EXIM.bcin_kurir.FRMbcin_kurir", {
  extend: "Ext.window.Window",
  alias: "widget.FRMbcin_kurir",
  reference: "FRMbcin_kurir",
  title: "",
  modal: true,
  closeAction: "destroy",
  centered: true,
                      ...
                      tbar: [
                        {
                          ...
                          handler: function () {
                            var GRID = Ext.ComponentQuery.query("FRMbcin_kurir grid[pid=GRIDbcin_kurir_kontainer]")[0];
                            var rec = {
                          ...
                          editor: {
                            ...
                            listeners: {
                              select: function (cmp, rec) {
                                var GRID = Ext.ComponentQuery.query("FRMbcin_kurir grid[pid=GRIDbcin_kurir_kemasan]")[0];
  ...
  dockedItems: [],
  listeners: {
    afterrender: "FRMbcin_kurir_load",
  },
});
