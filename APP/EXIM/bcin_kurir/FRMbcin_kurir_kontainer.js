...
Ext.define("TDK.EXIM.bcin_kurir.FRMbcin_kurir_kontainer", {
  extend: "Ext.window.Window",
  alias: "widget.FRMbcin_kurir_kontainer",
  reference: "FRMbcin_kurir_kontainer",
  title: "Input Nomor, Ukuran dan Tipe Peti Kemas",
  modal: true,
  closeAction: "destroy",
  centered: true,
  autoScroll: false,
      ...
      items: [
        {
          ...
          listeners: {
            afterrender: function (grid, record, e) {
              var GRIDinput_kontainer = Ext.ComponentQuery.query("FRMbcin_kurir grid[pid=GRIDinput_kontainer]")[0];
