Ext.define("NJC.EXIM.bcout_30.GRIDbcout_30", {
    extend: "Ext.form.Panel",
    alias: "widget.GRIDbcout_30",
    reference: "GRIDbcout_30",
    frame: false,
    border: false,
    autoScroll: true,
    ...
    items: [
      {
        ...
        store: {
          ...
          proxy: {
            ...
            url: vconfig.service_api + "bcout_30/bcout_30s",
            extraParams: {
              method: "read_data",
            },
            reader: {
          ...
          listeners: {
            beforeload: function (store, operation, eOpts) {
              try {
                var CBO_FILTERKEY = Ext.ComponentQuery.query("bcout_30 combobox[name=CBO_FILTERKEY]")[0];
                operation.setParams({
