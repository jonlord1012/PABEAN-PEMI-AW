...
Ext.define("NJC.EXIM.bcout_30.FRMbcout_30", {
  extend: "Ext.window.Window",
  alias: "widget.FRMbcout_30",
  reference: "FRMbcout_30",
  title: "Header Dokumen BC 30",
  modal: true,
  closeAction: "destroy",
  centered: true,
  requires: [
    //
    "NJC.EXIM.bcout_30.Cbcout_30",
  ],
                            ...
                            //
                            {
                              ...
                              handler: function () {
                                try {
                                  ...
                                  console.log(vdt);
                                  var GRIDpengangkut = this.up("grid[pid=GRIDbcout_30_pengangkut]");
                        ...
                        { xtype: "textfield", width: 200, name: "KODE_PEL_MUATNAME", fieldCls: "fieldlock", readOnly: true },
                        {
                          ...
                          handler: function () {
                            try {
                              ...
                              var FRM = me.up("form");
                              var GRIDpelabuhan = Ext.create(
                                "NJC.EXIM.bcout_30.GRIDpelabuhan",
                                {
                                  listeners: {
                                    itemdblClick: function (cmp, rec) {
                                      FRM.getForm().setValues({
                          ...
                          tbar: [
                            {
                              ...
                              handler: function () {
                                try {
                                  var FRM = this.up("form");
                                  var vdt = FRM.getValues(false, false, false, true);
                                  var GRID = this.up("grid[pid=GRIDbcout_30_kontainer]");
                                  GRID.getStore().add({
                                    ID: 0,
                                    SERI: 0,
                                    KODEUKURANKONTAINER: "",
                          ...
                          tbar: [
                            {
                              ...
                              handler: function () {
                                try {
                                  var FRM = this.up("form");
                                  var vdt = FRM.getValues(false, false, false, true);
                                  var GRID = this.up("grid[pid=GRIDbcout_30_kemasan]");
                                  GRID.getStore().add({
                                    JUMLAHKEMASAN: 0,
                                    SERI: 0,
                                    KODEKEMASAN: "",
                              ...
                              handler: function () {
                                try {
                                  ...
                                  var GRIDdokumen = Ext.create(
                                    "NJC.EXIM.bcout_30.GRIDdokumen",
                                    {
                                      listeners: {
                                        itemdblClick: function (cmp, rec) {
                                          var me = this;
                                          var GRID = Ext.ComponentQuery.query("FRMbcout_30 grid[pid=GRIDbcout_30_dokumen]")[0];
