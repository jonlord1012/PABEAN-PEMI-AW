...
Ext.define("NJC.EXIM.bcout_30.FRMbcout_30_dokumen", {
  extend: "Ext.window.Window",
  alias: "widget.FRMbcout_30_dokumen",
  reference: "FRMbcout_30_dokumen",
  title: "",
  modal: true,
  closeAction: "destroy",
  centered: true,
      ...
      items: [
        {
          ...
          listeners: {
            afterrender: function (grid, record, e) {
              var GRIDinput_dokumen = Ext.ComponentQuery.query("FRMbcout_30 grid[pid=GRIDbcout_30_input_dokumen]")[0];
