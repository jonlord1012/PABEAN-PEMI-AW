...
Ext.define("NJC.EXIM.bcout_25.FRMbcout_25_dokumen", {
  extend: "Ext.window.Window",
  alias: "widget.FRMbcout_25_dokumen",
  reference: "FRMbcout_25_dokumen",
  title: "Input Dokumen",
  modal: true,
  closeAction: "destroy",
  centered: true,
      ...
      items: [
        {
          ...
          listeners: {
            afterrender: function (grid, record, e) {
              var GRIDinput_dokumen = Ext.ComponentQuery.query("FRMbcout_25 grid[pid=GRIDinput_dokumen]")[0];
