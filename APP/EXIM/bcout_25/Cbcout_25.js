Ext.define("NJC.EXIM.bcout_25.Cbcout_25", {
  extend: "Ext.app.ViewController",
  alias: "controller.Cbcout_25",
  init: function (view) {
    this.control({
      "bcout_25 button[pid=btrefresh]": { click: this.btrefresh_click },
      "bcout_25 combobox[name=CBO_FILTERKEY]": { select: this.btrefresh_click },
      "FRMbcout_25 button[pid=bttambah_dokumen]": { click: this.bttambah_dokumen_click },
      "FRMbcout_25 button[pid=btsearch]": { click: this.btsearch_click },
    });
    this.listen({
      store: {},
    });
  ...
  renderpage: function () {
    try {
      console.log("load Controller Cbcout_25");
    } catch (ex) {
  ...
  btdetail_rows_click: function (xgrid, rowIndex) {
    try {
      ...
      COMP.run.getmodulepopup("FRMbcout_25", "NJC.EXIM.bcout_25.FRMbcout_25", mainpanel);
    } catch (ex) {
      COMP.TipToast.toast("Error", ex.message, { cls: "danger", delay: 2000 });
    }
  },
  FRMbcout_25_load: function (cmp) {
    try {
      var me = this;
      var mainpanel = Ext.ComponentQuery.query("mainpage")[0];
      var FRM = cmp.query("form")[0];
      var GRIDdokumen = cmp.query("form grid[pid=GRIDbcout_25_input_dokumen]")[0];
      var GRIDbarang = cmp.query("form grid[pid=GRIDbcout_25_input_item]")[0];
      ...
      var hasil = COMP.run.getservice(vconfig.service_api + "bcout_25/bcout_25", params, "POST", me.var_global.jwt);
  ...
  FRMbcout_25_btcancel_click: function () {
    try {
      var popup = Ext.ComponentQuery.query("FRMbcout_25")[0];
      var GRID = Ext.ComponentQuery.query("bcout_25 GRIDbcout_25 grid[pid=GRIDbcout_25]")[0];
      var FRM_MAIN = Ext.ComponentQuery.query("FRMbcout_25 form")[0];
  ...
  FRMbcout_25_btsendtoceisa_click: function () {
    try {
  ...
  edit_detailbarang_click: function (xgrid, rowIndex) {
    try {
      ...
      var me = this;
      var mainpanel = Ext.ComponentQuery.query("mainpage")[0];
      COMP.run.getmodulepopup("FRMbcout_25_item", "NJC.EXIM.bcout_25.FRMbcout_25_item", mainpanel);
    } catch (ex) {
      COMP.TipToast.toast("Error", ex.message, { cls: "danger", delay: 2000 });
    }
  },
  FRMbcout_25_item_load: function (cmp) {
    try {
      var me = this;
      var mainpanel = Ext.ComponentQuery.query("mainpage")[0];
      var FRM = cmp.query("form")[0];
      ...
      var GRIDitem = Ext.ComponentQuery.query("FRMbcout_25 form grid[pid=GRIDbcout_25_input_item]")[0];
  ...
  btsearch_click: function (btn) {
    try {
      var me = this;
      var mainpanel = Ext.ComponentQuery.query("mainpage")[0];
      var popup = Ext.define("NJC.EXIM.bcout_25.popup_btsearch", {
  ...
  bttambah_dokumen_click: function () {
    try {
      ...
      var mainpanel = Ext.ComponentQuery.query("mainpage")[0];
      var popup = Ext.define("NJC.EXIM.bcout_25.popup_btadddokumen", {
        extend: "Ext.window.Window",
