Ext.define("NJC.EXIM.bcout_25.GRIDbcout_25", {
  extend: "Ext.form.Panel",
  alias: "widget.GRIDbcout_25",
  reference: "GRIDbcout_25",
  frame: false,
  border: false,
  autoScroll: true,
  ...
  items: [
    {
      ...
      //     url: vconfig.service_api + "bcout_25/bcout_25s",
      //     reader: {
      //       type: "json",
      //       rootProperty: "Rows",
