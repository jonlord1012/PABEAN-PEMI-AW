...
Ext.define("NJC.EXIM.bcout_25.FRMbcout_25_item_impor", {
  extend: "Ext.window.Window",
  alias: "widget.FRMbcout_25_item_impor",
  reference: "FRMbcout_25_item_impor",
  ...
  bodyStyle: "background:#FFFFFF;background-color:#FFFFFF",      
        ...
        items: [
        { xtype: "textfield", labelWidth: 75, width: 100, fieldLabel: "Status", name: "", fieldCls: "fieldlock", readOnly: true },
            ...
            items: [
            {
                ...
                items: [
                {
                    ...
                    { xtype: "tbspacer", height: 10 },
                    {
                        ...
                        { xtype: "tbspacer", width: 10 },
                        { xtype: "displayfield", labelWidth: 150, value:"BC 2.3", name: "", readOnly: true },
                        ...
                        { xtype: "tbspacer", width: 10 },
                        { xtype: "displayfield", labelWidth: 150, value:"KPU TANJUNG PRIOK", name: "", readOnly: true },
                        { xtype: "tbspacer", width: 10 },
                        ],
                    },
                    { xtype: "tbspacer", height: 10 },
            ...
            },
            {
                ...
                items: [
                {
                    ...
                    items: [
                    {
                        ...
                        layout: "hbox",
                        items: [
                        { xtype: "textfield", labelWidth: 100, width: 250, fieldLabel: "Harga CIF USD", name: "", fieldCls: "fieldinput", readOnly: true },
                        { xtype: "tbspacer", width: 10 },
                        { xtype: "textfield", labelWidth: 100, width: 250, fieldLabel: "NDPBM", name: "", fieldCls: "fieldinput", readOnly: true },
                        { xtype: "tbspacer", width: 65 },
                        { xtype: "textfield", labelWidth: 100, width: 250, fieldLabel: "CIF Rp", name: "", fieldCls: "fieldinput", readOnly: true },
                        ],
                    },
                    { xtype: "tbspacer", height: 10 },
                    {
                        ...
                        { xtype: "tbspacer", width: 10 },
                        { xtype: "displayfield", labelWidth: 50, width: 55, value: "PIECE", name: "", readOnly: true},
                        { xtype: "tbspacer", width: 65 },
            ...
            },
            {
                ...
                items: [
                {
                    ...
                    items: [
                    {
                        ...
                        layout: "hbox",
                        items: [
                        { xtype: "textfield", labelWidth: 80, width:200, fieldLabel: "BM Brg Jadi", name: "", fieldCls: "fieldinput", readOnly: true },
                        { xtype: "tbspacer", width: 10 },
                        {
                            xtype: "button",
                    ...
                    { xtype: "tbspacer", height: 10 },
                    {
                        ...
                        layout: "hbox",
                        items: [
                        { xtype: "textfield", labelWidth: 80, width:150, fieldLabel: "PPN", name: "", fieldCls: "fieldinput", readOnly: true },
                        { xtype: "tbspacer", width: 10 },
                    ...
                    { xtype: "tbspacer", height: 10 },
                    {
                        ...
                        layout: "hbox",
                        items: [
                        { xtype: "textfield", labelWidth: 80, width:150, fieldLabel: "PPnBM", name: "", fieldCls: "fieldinput", readOnly: true },
                        { xtype: "tbspacer", width: 10 },
                        { xtype: "displayfield", labelWidth: 50, width: 20, value: "%", name: "", readOnly: true},
                        { xtype: "tbspacer", width: 5 },
                        {
                    ...
                    { xtype: "tbspacer", height: 10 },
                    {
                        ...
                        layout: "hbox",
                        items: [
                        { xtype: "textfield", labelWidth: 80, width:150, fieldLabel: "Jumlah Satuan", name: "", fieldCls: "fieldinput", readOnly: true },
                        { xtype: "tbspacer", width: 10 },
                        {
                            xtype: "combobox",
                            name: "",
                        ...
                        { xtype: "tbspacer", width: 10 },
                        { xtype: "textfield", labelWidth: 80, width:155, fieldLabel: "", name: "", fieldCls: "fieldinput", readOnly: true },
                        { xtype: "tbspacer", width: 10 },
                        ],
                    },
                    ],
