Ext.define("NJC.EXIM.bcout_ppb.Cbcout_ppb", {
  ...
  GRIDbcout_25_itemdblclick: function (cmp, rec) {
    try {
      ...
      var vdt = rec.data;
      var load_edit = COMP.run.getmodulepopup("FRMbcout_25", "NJC.EXIM.bcout_25.FRMbcout_25", mainpanel);
      if (load_edit) {
  ...
  btinput_item_lokal_click: function () {
    try {
      ...
      COMP.run.getmodulepopup("FRMbcout_25_item_lokal", "NJC.EXIM.bcout_25.FRMbcout_25_item_lokal", mainpanel);
    } catch (ex) {
      COMP.TipToast.toast("Error", ex.message, { cls: "danger", delay: 2000 });
    }
  },
  btinput_item_impor_click: function () {
    try {
      ...
      COMP.run.getmodulepopup("FRMbcout_25_item_impor", "NJC.EXIM.bcout_25.FRMbcout_25_item_impor", mainpanel);
    } catch (ex) {
      COMP.TipToast.toast("Error", ex.message, { cls: "danger", delay: 2000 });
    }
  },
  btinput_item_detail_click: function () {
    try {
      ...
      COMP.run.getmodulepopup("FRMbcout_25_item_detail", "NJC.EXIM.bcout_25.FRMbcout_25_item_detail", mainpanel);
    } catch (ex) {
      COMP.TipToast.toast("Error", ex.message, { cls: "danger", delay: 2000 });
    }
  },
  btinput_bea_masuk_tambahan_click: function () {
    try {
      ...
      COMP.run.getmodulepopup("FRMbcout_25_bea_masuk_tambahan", "NJC.EXIM.bcout_25.FRMbcout_25_bea_masuk_tambahan", mainpanel);
    } catch (ex) {
      COMP.TipToast.toast("Error", ex.message, { cls: "danger", delay: 2000 });
    }
  },
