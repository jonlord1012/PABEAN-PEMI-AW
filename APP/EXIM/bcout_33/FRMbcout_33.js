...
Ext.define("NJC.EXIM.bcout_33.FRMbcout_33", {
  extend: "Ext.window.Window",
  alias: "widget.FRMbcout_33",
  reference: "FRMbcout_33",
  title: "Header Dokumen BC 33",
  modal: true,
  closeAction: "destroy",
  centered: true,
  requires: [
    //
    "NJC.EXIM.bcout_33.Cbcout_33",
  ],
  controller: "Cbcout_33",
  //y: -110,
  bodyPadding: "5 5 5 5",
                            ...
                            //
                            {
                              ...
                              handler: function () {
                                try {
                                  ...
                                  console.log(vdt);
                                  var GRIDpengangkut = this.up("grid[pid=GRIDbcout_33_pengangkut]");
                        ...
                        { xtype: "textfield", width: 200, name: "KODE_PEL_MUATNAME", fieldCls: "fieldlock", readOnly: true },
                        {
                          ...
                          handler: function () {
                            try {
                              ...
                              var FRM = me.up("form");
                              var GRIDpelabuhan = Ext.create(
                                "NJC.EXIM.bcout_33.GRIDpelabuhan",
                                {
                                  listeners: {
                                    itemdblClick: function (cmp, rec) {
                                      FRM.getForm().setValues({
                          ...
                          tbar: [
                            {
                              ...
                              handler: function () {
                                try {
                                  var FRM = this.up("form");
                                  var vdt = FRM.getValues(false, false, false, true);
                                  var GRID = this.up("grid[pid=GRIDbcout_33_kontainer]");
                                  GRID.getStore().add({
                                    ID: 0,
                                    SERI: 0,
                                    KODEUKURANKONTAINER: "",
                          ...
                          tbar: [
                            {
                              ...
                              handler: function () {
                                try {
                                  var FRM = this.up("form");
                                  var vdt = FRM.getValues(false, false, false, true);
                                  var GRID = this.up("grid[pid=GRIDbcout_33_kemasan]");
                                  GRID.getStore().add({
                                    JUMLAHKEMASAN: 0,
                                    SERI: 0,
                                    KODEKEMASAN: "",
                              ...
                              handler: function () {
                                try {
                                  ...
                                  var GRIDdokumen = Ext.create(
                                    "NJC.EXIM.bcout_33.GRIDdokumen",
                                    {
                                      listeners: {
                                        itemdblClick: function (cmp, rec) {
                                          var me = this;
                                          var GRID = Ext.ComponentQuery.query("FRMbcout_33 grid[pid=GRIDbcout_33_dokumen]")[0];
  ...
  dockedItems: [
    {
      xtype: "toolbar",
      pid: "toolbar_FRMbcout_33",
      height: 30,
      dock: "top",
      items: [
        { xtypeL: "tbspacer", width: 5 },
        { xtype: "button", text: "Cancel Dokumen", id: "btcancel_dokumen", pid: "btcancel_dokumen", icon: vconfig.getstyle + "icon/delete.ico", tooltip: "Cancel Dokumen BC 33", handler: "btcancel_click" },
        { xtype: "button", text: "Update Dokumen", id: "btsimpan_draft", pid: "btsimpan_draft", icon: vconfig.getstyle + "icon/save.gif", tooltip: "Proses Update Dokumen BC 33", handler: "btupdate_click" },
        { xtype: "button", text: "Kunci Perubahan Dokumen", id: "btposting_click", pid: "btposting_click", icon: vconfig.getstyle + "icon/lock.png", tooltip: "Proses Lock Dokumen BC 33", handler: "btposting_click" },
        "-",
