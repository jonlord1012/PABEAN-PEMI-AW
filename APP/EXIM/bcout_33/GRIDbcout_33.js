Ext.define("NJC.EXIM.bcout_33.GRIDbcout_33", {
    extend: "Ext.form.Panel",
    alias: "widget.GRIDbcout_33",
    reference: "GRIDbcout_33",
    frame: false,
    border: false,
    autoScroll: true,
    ...
    items: [
      {
        ...
        store: {
          ...
          proxy: {
            ...
            url: vconfig.service_api + "bcout_33/bcout_33s",
            extraParams: {
              method: "read_data",
            },
            reader: {
          ...
          listeners: {
            beforeload: function (store, operation, eOpts) {
              try {
                var CBO_FILTERKEY = Ext.ComponentQuery.query("bcout_33 combobox[name=CBO_FILTERKEY]")[0];
                operation.setParams({
