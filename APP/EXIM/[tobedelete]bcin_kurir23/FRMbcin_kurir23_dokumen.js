...
Ext.define("TDK.EXIM.bcin_kurir23.FRMbcin_kurir23_dokumen", {
  extend: "Ext.window.Window",
  alias: "widget.FRMbcin_kurir23_dokumen",
  reference: "FRMbcin_kurir23_dokumen",
  title: "",
  modal: true,
  closeAction: "destroy",
  centered: true,
      ...
      items: [
        {
          ...
          listeners: {
            afterrender: function (grid, record, e) {
              var GRIDinput_dokumen = Ext.ComponentQuery.query("FRMbcin_kurir23 grid[pid=GRIDbcin_kurir23_input_dokumen]")[0];
