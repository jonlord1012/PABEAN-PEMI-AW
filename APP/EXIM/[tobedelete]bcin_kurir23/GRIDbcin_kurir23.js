Ext.define("TDK.EXIM.bcin_kurir23.GRIDbcin_kurir23", {
  extend: "Ext.form.Panel",
  alias: "widget.GRIDbcin_kurir23",
  reference: "GRIDbcin_kurir23",
  frame: false,
  border: false,
  autoScroll: true,
  ...
  //         url: vconfig.service_api + "bcin_kurir23/bcin_kurir23s",
  //         reader: {
  //           type: "json",
  //           rootProperty: "Rows",
  ...
  //           try {
  //             var CBO_FILTERKEY = Ext.ComponentQuery.query("bcin_kurir23 combobox[name=CBO_FILTERKEY]")[0];
  //             operation.setParams({
