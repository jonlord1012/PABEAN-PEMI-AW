Ext.define("NJC.EXIM.bcout_25_aw.GRIDbcout_25_aw", {
    extend: "Ext.form.Panel",
    alias: "widget.GRIDbcout_25_aw",
    reference: "GRIDbcout_25_aw",
    frame: false,
    border: false,
    autoScroll: true,
    ...
    items: [
      {
        ...
        store: {
          ...
          proxy: {
            ...
            url: vconfig.service_api + "bcout_25_aw/bcout_25_aws",
            extraParams: {
              method: "read_data",
            },
            reader: {
          ...
          listeners: {
            beforeload: function (store, operation, eOpts) {
              try {
                var CBO_FILTERKEY = Ext.ComponentQuery.query("bcout_25_aw combobox[name=CBO_FILTERKEY]")[0];
                operation.setParams({
