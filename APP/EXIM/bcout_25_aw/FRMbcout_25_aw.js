...
Ext.define("NJC.EXIM.bcout_25_aw.FRMbcout_25_aw", {
  extend: "Ext.window.Window",
  alias: "widget.FRMbcout_25_aw",
  reference: "FRMbcout_25_aw",
  title: "Header Dokumen BC 25 ( AW )",
  modal: true,
  closeAction: "destroy",
  centered: true,
  requires: [
    //
    "NJC.EXIM.bcout_25_aw.Cbcout_25_aw",
  ],
  controller: "Cbcout_25_aw",
  //y: -110,
  bodyPadding: "5 5 5 5",
                          ...
                          handler: function () {
                            try {
                              ...
                              var GRIDpelabuhan = Ext.create(
                                "NJC.EXIM.bcout_25_aw.GRIDentitas",
                                {
                                  listeners: {
                  ...
                  items: [
                    {
                      ...
                      items: [
                        {
                          xtype: "grid",
                          pid: "GRIDbcout_25_aw_pengangkut",
                            ...
                            //
                            {
                              ...
                              handler: function () {
                                try {
                                  ...
                                  console.log(vdt);
                                  var GRIDpengangkut = this.up("grid[pid=GRIDbcout_25_aw_pengangkut]");
                        ...
                        { xtype: "textfield", width: 200, name: "KODE_PEL_MUATNAME", fieldCls: "fieldlock", readOnly: true },
                        {
                          ...
                          handler: function () {
                            try {
                              ...
                              var FRM = me.up("form");
                              var GRIDpelabuhan = Ext.create(
                                "NJC.EXIM.bcout_25_aw.GRIDpelabuhan",
                                {
                                  listeners: {
                                    itemdblClick: function (cmp, rec) {
                                      FRM.getForm().setValues({
                          ...
                          tbar: [
                            {
                              ...
                              handler: function () {
                                try {
                                  var FRM = this.up("form");
                                  var vdt = FRM.getValues(false, false, false, true);
                                  var GRID = this.up("grid[pid=GRIDbcout_25_aw_kontainer]");
                                  GRID.getStore().add({
                                    ID: 0,
                                    SERI: 0,
                                    KODEUKURANKONTAINER: "",
                          ...
                          tbar: [
                            {
                              ...
                              handler: function () {
                                try {
                                  var FRM = this.up("form");
                                  var vdt = FRM.getValues(false, false, false, true);
                                  var GRID = this.up("grid[pid=GRIDbcout_25_aw_kemasan]");
                                  GRID.getStore().add({
                                    JUMLAHKEMASAN: 0,
                                    SERI: 0,
                                    KODEKEMASAN: "",
                  ...
                  items: [
                    {
                      ...
                      items: [
                        ...
                        },
                        {
                          ...
                          layout: "hbox",
                          items: [
                            { xtype: "textfield", labelWidth: 120, width: 200, fieldLabel: "Tujuan", name: "KODE_TUJUAN_PLB", fieldCls: "fieldinput", readOnly: true },
                            { xtype: "textfield", width: 200, name: "URAIAN_TUJUAN_PLB", fieldCls: "fieldlock", readOnly: true },
                            {
                              xtype: "button",
                              pid: "btsearch",
                              margin: "5 5 5 5",
                              ...
                              handler: function () {
                                try {
                                  ...
                                  var popup = Ext.create(
                                    "Ext.window.Window",
                                    {
                                      alias: "widget.popup_tujuanplb",
                                      reference: "popup_tujuanplb",
                                      title: "Pilih Tujuan",
                                      modal: true,
                                      closeAction: "destroy",
                                      centered: true,
                                      ...
                                      items: [
                                        {
                                          ...
                                          store: {
                                            ...
                                            proxy: {
                                              ...
                                              headers: { Authorization: "Bearer " + localStorage.getItem("ST_NJC_JWT_PLB") },
                                              actionMethods: { read: "POST" },
                                              url: vconfig.service_api + "tujuanplb/tujuanplbs",
                                              reader: {
                                                type: "json",
                                                rootProperty: "Rows",
                                                totalProperty: "TotalRows",
                                          ...
                                          columns: [
                                            { xtype: "rownumberer", width: 40 },
                                            { sortable: true, width: 100, filter: { xtype: "textfield" }, header: "Kode Tujuan", dataIndex: "KODE_TUJUAN_PLB" },
                                            { sortable: true, width: 230, filter: { xtype: "textfield" }, header: "Nama Tujuan", dataIndex: "URAIAN_TUJUAN_PLB" },
                                          ],
                                          bbar: {
                                            xtype: "pagingtoolbar",
                                            displayInfo: true,
                                          ...
                                          listeners: {
                                            itemdblClick: function (cmp, rec) {
                                              try {
                                                var FRM = me.up("form");
                                                FRM.getForm().setValues({
                                                  KODE_TUJUAN_PLB: rec.data.KODE_TUJUAN_PLB,
                                                  URAIAN_TUJUAN_PLB: rec.data.URAIAN_TUJUAN_PLB,
                                                });
                                                console.log(FRM)
                                                popup.close();
                                              } catch (ex) {
                      ...
                      items: [
                        ...
                        },
                        {
                          ...
                          items: [
                            ...
                            { xtype: "textfield", width: 250, name: "URAIAN_TPS", fieldCls: "fieldlock", readOnly: false },
                            {
                              xtype: "button",
                              pid: "btsearch",
                              margin: "5 5 5 5",
                              ...
                              handler: function () {
                                try {
                                  ...
                                  var GRIDdokumen = Ext.create(
                                    "NJC.EXIM.bcout_25_aw.GRIDdokumen",
                                    {
                                      listeners: {
                                        itemdblClick: function (cmp, rec) {
                                          console.log(rec.data)
                                          var me = this;
                                          var GRID = Ext.ComponentQuery.query("FRMbcout_25_aw grid[pid=GRIDbcout_25_aw_dokumen]")[0];
                              ...
                              handler: function () {
                                try {
                                  var GRIDbarang = Ext.create(
                                    "NJC.EXIM.bcout_25_aw.GRIDbarang",
                                    {
                                      //
                                    },
                                    this
  ...
  dockedItems: [
    {
      xtype: "toolbar",
      pid: "toolbar_FRMbcout_25_aw",
      height: 30,
      dock: "top",
      items: [
        { xtypeL: "tbspacer", width: 5 },
        { xtype: "button", text: "Cancel Dokumen", id: "btcancel_dokumen", pid: "btcancel_dokumen", icon: vconfig.getstyle + "icon/delete.ico", tooltip: "Cancel Dokumen BC 25", handler: "btcancel_click" },
        { xtype: "button", text: "Update Dokumen", id: "btsimpan_draft", pid: "btsimpan_draft", icon: vconfig.getstyle + "icon/save.gif", tooltip: "Proses Update Dokumen BC 25", handler: "btupdate_click" },
        { xtype: "button", text: "Kunci Perubahan Dokumen", id: "btposting_click", pid: "btposting_click", icon: vconfig.getstyle + "icon/lock.png", tooltip: "Proses Lock Dokumen BC 25", handler: "btposting_click" },
        "-",
