Ext.define("TDK.EXIM.bcout_261.GRIDbcout_261", {
  extend: "Ext.form.Panel",
  alias: "widget.GRIDbcout_261",
  reference: "GRIDbcout_261",
  frame: false,
  border: false,
  autoScroll: true,
  ...
  //         url: vconfig.service_api + "bcout_261/bcout_261s",
  //         reader: {
  //           type: "json",
  //           rootProperty: "Rows",
  ...
  //           try {
  //             var CBO_FILTERKEY = Ext.ComponentQuery.query("bcout_261 combobox[name=CBO_FILTERKEY]")[0];
  //             operation.setParams({
