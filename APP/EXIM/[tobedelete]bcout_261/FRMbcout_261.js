...
Ext.define("TDK.EXIM.bcout_261.FRMbcout_261", {
  extend: "Ext.window.Window",
  alias: "widget.FRMbcout_261",
  reference: "FRMbcout_261",
  title: "Header Dokumen BC 261",
  modal: true,
  closeAction: "destroy",
  centered: true,
  autoScroll: true,
  controller: "Cbcout_261",
  //y: -110,
  bodyPadding: "5 5 5 5",
                    ...
                    },
                    {
                      ...
                      items: [
                        ...
                        { xtype: "textfield", width: 200, name: "KODE_TUJUAN_PENGIRIMANNAME", fieldCls: "fieldlock", readOnly: true },
                        {
                          ...
                          pid: "btsearch",
                          vdata: {
                            modulename: "tujuanpengiriman261",
                  ...
                  items: [
                    {
                      xtype: "container",
                      layout: "hbox",
                      items: [{ xtype: "textfield", labelWidth: 100, width: 480, fieldLabel: "5. NPWP", name: "ID_PENERIMA_BARANG", fieldCls: "fieldlock", readOnly: true }],
                    },
                    {
                      xtype: "container",
                      layout: "hbox",
                      items: [
                        { xtype: "textfield", labelWidth: 100, width: 450, fieldLabel: "6. Nama", name: "NAMA_PENERIMA_BARANG", fieldCls: "fieldinput", readOnly: true },
                      ],
                    },
                    {
                      xtype: "container",
                      layout: "hbox",
                      items: [{ xtype: "textfield", labelWidth: 100, width: 480, fieldLabel: "7. Alamat", name: "ALAMAT_PENERIMA_BARANG", fieldCls: "fieldlock", readOnly: true }],
                    },
                  ],
                },
                {
                      ...
                      items: [
                        {
                          ...
                          fieldLabel: "14. Jenis Sarana Pengangkut",
                          labelWidth: 160,
                          width: 350,
                          displayField: "MERGE",
                      ...
                      tbar: [
                        {
                          ...
                          handler: function () {
                            var GRID = Ext.ComponentQuery.query("FRMbcout_261 grid[pid=GRIDbcout_261_kontainer]")[0];
                            var rec = {
                      ...
                      items: [
                        {
                          ...
                          layout: "hbox",
                          items: [
                            { xtype: "textfield", labelWidth: 130, width: 350, fieldLabel: "8. Packing List", name: "NOMOR_PACKING_LIST", fieldCls: "fieldinput", readOnly: true },
                        ...
                        },
                        {
                          ...
                          layout: "hbox",
                          items: [
                            { xtype: "textfield", labelWidth: 130, width: 350, fieldLabel: "9. Fasilitas Impor", name: "IMPOR_NOMOR_DOKUMEN", fieldCls: "fieldinput", readOnly: true },
                        ...
                        },
                        {
                          ...
                          items: [
                            {
                              xtype: "grid",
                              pid: "GRIDbcout_261_input_dokumen",
                              emptyText: "No Matching Records",
                              width: 665,
                              height: 230,
                          ...
                          tbar: [
                            {
                              ...
                              text: "10. Surat Keputusan/Dokumen Lainnya",
                          ...
                          editor: {
                            ...
                            listeners: {
                              select: function (cmp, rec) {
                                var GRID = Ext.ComponentQuery.query("FRMbcout_261 grid[pid=GRIDbcout_261_kemasan]")[0];
  ...
  dockedItems: [
    {
      ...
      items: [
        ...
        { xtype: "button", text: "Cancel Dokumen", pid: "btcancel_dokumen", icon: vconfig.getstyle + "icon/delete.ico", tooltip: "Cancel Dokumen BC 261", handler: "FRMbcout_261_btcancel_click" },
        { xtype: "button", text: "Update Dokumen", pid: "btsimpan_draft", icon: vconfig.getstyle + "icon/save.gif", tooltip: "Proses Update Dokumen BC 261", handler: "FRMbcout_261_btupdate_click" },
        { xtype: "button", text: "Kunci Perubahan Dokumen", pid: "btlock_draft", icon: vconfig.getstyle + "icon/lock.png", tooltip: "Proses Lock Dokumen BC 261", handler: "FRMbcout_261_btlock_click" },
        "-",
        { xtype: "button", text: "Send To Ceisa", pid: "btgenerate_draft", icon: vconfig.getstyle + "icon/up.ico", tooltip: "Kirim Dokumen Ke Aplikasi Ceisa", handler: "FRMbcout_261_btsendtoceisa_click" },
        { xtype: "button", text: "Get From Ceisa", pid: "btgenerate_draft", icon: vconfig.getstyle + "icon/down.ico", tooltip: "Sinkronisasi Dokumen dari Aplikasi Ceisa", handler: "FRMbcout_261_btgetfromceisa_click" },
      ],
      // other options....
    },
  ],
  listeners: {
    afterrender: "FRMbcout_261_load",
  },
});
