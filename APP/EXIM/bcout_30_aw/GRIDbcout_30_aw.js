Ext.define("NJC.EXIM.bcout_30_aw.GRIDbcout_30_aw", {
    extend: "Ext.form.Panel",
    alias: "widget.GRIDbcout_30_aw",
    reference: "GRIDbcout_30_aw",
    frame: false,
    border: false,
    autoScroll: true,
    ...
    items: [
      {
        ...
        store: {
          ...
          proxy: {
            ...
            url: vconfig.service_api + "bcout_30_aw/bcout_30_aws",
            extraParams: {
              method: "read_data",
            },
            reader: {
          ...
          listeners: {
            beforeload: function (store, operation, eOpts) {
              try {
                var CBO_FILTERKEY = Ext.ComponentQuery.query("bcout_30_aw combobox[name=CBO_FILTERKEY]")[0];
                operation.setParams({
