Ext.define("TDK.EXIM.bcout_25.Cbcout_25", {
  extend: "Ext.app.ViewController",
  alias: "controller.Cbcout_25",
  init: function (view) {
    this.control({
      "bcout_25 GRIDbcout_25 button[pid=btnew]": { click: this.btnew_click },
      "bcout_25 grid[pid=GRIDbcout_25]": { itemdblclick: this.GRIDbcout_25_itemdblclick },
      ...
      "FRMbcout_25 button[pid=btinput_item_detail]": { click: this.btinput_item_detail_click },
      "FRMbcout_25 button[pid=btinput_item_impor]": { click: this.btinput_item_impor_click },
      "FRMbcout_25 button[pid=btinput_item_lokal]": { click: this.btinput_item_lokal_click },
      "FRMbcout_25_item_detail button[pid=btedit_dokumen_item_detail]": { click: this.btedit_dokumen_item_detail_click },
      "FRMbcout_25_item_lokal button[pid=btedit_dokumen_item_lokal]": { click: this.btedit_dokumen_item_lokal_click },
      "FRMbcout_25_item_impor button[pid=btedit_dokumen_item_impor]": { click: this.btedit_dokumen_item_impor_click },

      "FRMbcout_25_item_detail button[pid=btinput_bea_masuk_tambahan]": { click: this.btinput_bea_masuk_tambahan_click },
      "FRMbcout_25_item_impor button[pid=btinput_bea_masuk_tambahan]": { click: this.btinput_bea_masuk_tambahan_click },
