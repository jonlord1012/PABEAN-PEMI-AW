Ext.define("NJC.EXIM.bcout_41.GRIDbcout_41", {
    extend: "Ext.form.Panel",
    alias: "widget.GRIDbcout_41",
    reference: "GRIDbcout_41",
    frame: false,
    border: false,
    autoScroll: true,
    ...
    items: [
      {
        ...
        store: {
          ...
          proxy: {
            ...
            url: vconfig.service_api + "bcout_41/bcout_41s",
            extraParams: {
              method: "read_data",
            },
            reader: {
          ...
          listeners: {
            beforeload: function (store, operation, eOpts) {
              try {
                var CBO_FILTERKEY = Ext.ComponentQuery.query("bcout_41 combobox[name=CBO_FILTERKEY]")[0];
                operation.setParams({
