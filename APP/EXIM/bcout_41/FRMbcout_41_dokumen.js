...
Ext.define("NJC.EXIM.bcout_41.FRMbcout_41_dokumen", {
  extend: "Ext.window.Window",
  alias: "widget.FRMbcout_41_dokumen",
  reference: "FRMbcout_41_dokumen",
  title: "Input Dokumen",
  modal: true,
  closeAction: "destroy",
  centered: true,
      ...
      items: [
        {
          ...
          listeners: {
            afterrender: function (grid, record, e) {
              var GRIDinput_dokumen = Ext.ComponentQuery.query("FRMbcout_41 grid[pid=GRIDbcout_41_input_dokumen]")[0];
