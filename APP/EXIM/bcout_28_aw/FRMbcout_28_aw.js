...
Ext.define("NJC.EXIM.bcout_28_aw.FRMbcout_28_aw", {
  extend: "Ext.window.Window",
  alias: "widget.FRMbcout_28_aw",
  reference: "FRMbcout_28_aw",
  title: "Header Dokumen BC 28 AW",
  modal: true,
  closeAction: "destroy",
  centered: true,
  autoScroll: false,
  controller: "Cbcout_28_aw",
  //y: -110,
  bodyPadding: "5 5 5 5",
                      ...
                      tbar: [
                        {
                          ...
                          handler: function () {
                            var GRID = Ext.ComponentQuery.query("FRMbcin_28_aw grid[pid=GRIDbcin_28_aw_kontainer]")[0];
                            var rec = {
                      ...
                      tbar: [
                        {
                          ...
                          handler: function () {
                            var GRID = Ext.ComponentQuery.query("FRMbcin_28_aw grid[pid=GRIDbcin_28_aw_kemasan]")[0];
                            var rec = {
                              JUMLAH_KEMASAN: "",
                              KODE_JENIS_KEMASAN: "",
                              KETERANGAN: "",
                      ...
                      items: [
                        ...
                        },
                        {
                          ...
                          items: [
                            {
                              xtype: "grid",
                              pid: "GRIDbcin_28_aw_input_dokumen",
                              emptyText: "No Matching Records",
                              width: 625,
                              height: 230,
  ...
  dockedItems: [
    {
      ...
      items: [
        ...
        { xtype: "button", text: "Cancel Dokumen", pid: "btcancel_dokumen", icon: vconfig.getstyle + "icon/delete.ico", tooltip: "Cancel Dokumen BC 28 AW", handler: "FRMbcout_28_aw_btcancel_click" },
        { xtype: "button", text: "Update Dokumen", pid: "btsimpan_draft", icon: vconfig.getstyle + "icon/save.gif", tooltip: "Proses Update Dokumen BC 28 AW", handler: "FRMbcout_28_aw_btupdate_click" },
        { xtype: "button", text: "Kunci Perubahan Dokumen", pid: "btlock_draft", icon: vconfig.getstyle + "icon/lock.png", tooltip: "Proses Lock Dokumen BC 28 AW", handler: "FRMbcout_28_aw_btlock_click" },
        "-",
        { xtype: "button", text: "Send To Ceisa", pid: "btgenerate_draft", icon: vconfig.getstyle + "icon/up.ico", tooltip: "Kirim Dokumen Ke Aplikasi Ceisa", handler: "FRMbcout_28_aw_btsendtoceisa_click" },
        { xtype: "button", text: "Get From Ceisa", pid: "btgenerate_draft", icon: vconfig.getstyle + "icon/down.ico", tooltip: "Sinkronisasi Dokumen dari Aplikasi Ceisa", handler: "FRMbcout_28_aw_btgetfromceisa_click" },
      ],
      // other options....
    },
  ],
