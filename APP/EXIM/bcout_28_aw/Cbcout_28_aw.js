Ext.define("NJC.EXIM.bcout_28_aw.Cbcout_28_aw", {
  extend: "Ext.app.ViewController",
  alias: "controller.Cbcout_28_aw",
  init: function (view) {
    this.control({
      "bcout_28_aw button[pid=btrefresh]": { click: this.btrefresh_click },
      "bcout_28_aw combobox[name=CBO_FILTERKEY]": { select: this.btrefresh_click },
      "FRMbcout_28_aw button[pid=bttambah_dokumen]": { click: this.bttambah_dokumen_click },
      "FRMbcout_28_aw button[pid=btsearch]": { click: this.btsearch_click },
    });
    this.listen({
      store: {},
    });
  ...
  renderpage: function () {
    try {
      console.log("load Controller Cbcout_28_aw");
    } catch (ex) {
  ...
  btrefresh_click: function () {
    try {
      var GRID = Ext.ComponentQuery.query("bcout_28_aw GRIDbcout_28_aw grid[pid=GRIDbcout_28_aw]")[0];
      GRID.getStore().load();
    } catch (ex) {
      COMP.TipToast.toast("Error", ex.message, { cls: "danger", delay: 2000 });
    }
  ...
  btdetail_rows_click: function (xgrid, rowIndex) {
    try {
      ...
      COMP.run.getmodulepopup("FRMbcout_28_aw", "NJC.EXIM.bcout_28_aw.FRMbcout_28_aw", mainpanel);
    } catch (ex) {
      COMP.TipToast.toast("Error", ex.message, { cls: "danger", delay: 2000 });
    }
  },
  FRMbcout_28_aw_load: function (cmp) {
    try {
      var me = this;
      var mainpanel = Ext.ComponentQuery.query("mainpage")[0];
      var FRM = cmp.query("form")[0];
      var GRIDkontainer = cmp.query("form grid[pid=GRIDbcout_28_aw_kontainer]")[0];
      var GRIDkemasan = cmp.query("form grid[pid=GRIDbcout_28_aw_kemasan]")[0];
      var GRIDdokumen = cmp.query("form grid[pid=GRIDbcout_28_aw_input_dokumen]")[0];
      var GRIDbarang = cmp.query("form grid[pid=GRIDbcout_28_aw_input_item]")[0];
      ...
      var hasil = COMP.run.getservice(vconfig.service_api + "bcout_28_aw/bcout_28_aw", params, "POST", me.var_global.jwt);
  ...
  FRMbcout_28_aw_btcancel_click: function () {
    try {
      var popup = Ext.ComponentQuery.query("FRMbcout_28_aw")[0];
      var GRID = Ext.ComponentQuery.query("bcout_28_aw GRIDbcout_28_aw grid[pid=GRIDbcout_28_aw]")[0];
      var FRM_MAIN = Ext.ComponentQuery.query("FRMbcout_28_aw form")[0];
  ...
  FRMbcout_28_aw_btsendtoceisa_click: function () {
    try {
  ...
  edit_detailbarang_click: function (xgrid, rowIndex) {
    try {
      ...
      var me = this;
      var mainpanel = Ext.ComponentQuery.query("mainpage")[0];
      COMP.run.getmodulepopup("FRMbcout_28_aw_item", "NJC.EXIM.bcout_28_aw.FRMbcout_28_aw_item", mainpanel);
    } catch (ex) {
      COMP.TipToast.toast("Error", ex.message, { cls: "danger", delay: 2000 });
    }
  },
  FRMbcout_28_aw_item_load: function (cmp) {
    try {
      var me = this;
      var mainpanel = Ext.ComponentQuery.query("mainpage")[0];
      var FRM = cmp.query("form")[0];
      ...
      var GRIDitem = Ext.ComponentQuery.query("FRMbcout_28_aw form grid[pid=GRIDbcout_28_aw_input_item]")[0];
  ...
  btsearch_click: function (btn) {
    try {
      var me = this;
      var mainpanel = Ext.ComponentQuery.query("mainpage")[0];
      var popup = Ext.define("NJC.EXIM.bcout_28_aw.popup_btsearch", {
            ...
            listeners: {
              itemdblclick: function (grid, rec) {
                switch (btn.vdata.modulename) {
                  case "negara":
                    var FRM = Ext.ComponentQuery.query("FRMbcout_28_aw form")[0];
  ...
  bttambah_dokumen_click: function () {
    try {
      ...
      var griddokumen = Ext.ComponentQuery.query("FRMbcout_28_aw grid[pid=GRIDbcout_28_aw_input_dokumen]")[0];

      var mainpanel = Ext.ComponentQuery.query("mainpage")[0];
      var popup = Ext.define("NJC.EXIM.bcout_28_aw.popup_btadddokumen", {
        extend: "Ext.window.Window",
