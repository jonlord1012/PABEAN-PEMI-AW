Ext.define("NJC.EXIM.bcout_28_aw.bcout_28_aw", {
  extend: "Ext.form.Panel",
  alias: "widget.bcout_28_aw",
  reference: "bcout_28_aw",
  config: {},
  requires: ["NJC.EXIM.bcout_28_aw.GRIDbcout_28_aw", "NJC.EXIM.bcout_28_aw.Cbcout_28_aw"],
  ...
  initComponent: function () {
    Ext.apply(this, {
      xtype: "panel",
      pid: "panelbcout_28_aw",
      layout: "card",
      frame: false,
      border: false,
      items: [{ xtype: "GRIDbcout_28_aw" }],
      dockedItems: [
        {
          xtype: "toolbar",
          height: 30,
