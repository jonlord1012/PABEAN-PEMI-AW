...
Ext.define("NJC.EXIM.bcout_28_aw.FRMbcout_28_dokumen_aw", {
  extend: "Ext.window.Window",
  alias: "widget.FRMbcout_28_dokumen_aw",
  reference: "FRMbcout_28_dokumen_aw",
  title: "",
  modal: true,
  closeAction: "destroy",
  centered: true,
      ...
      items: [
        {
          ...
          listeners: {
            afterrender: function (grid, record, e) {
              var GRIDinput_dokumen = Ext.ComponentQuery.query("FRMbcout_28_aw grid[pid=GRIDbcout_28_input_dokumen_aw]")[0];
