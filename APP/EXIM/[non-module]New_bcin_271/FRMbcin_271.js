...
Ext.define("TDK.EXIM.bcin_271.FRMbcin_271", {
                  ...
                  items: [
                    {
                      ...
                      layout: "hbox",
                      items: [
                        { xtype: "textfield", labelWidth: 130, width: 200, fieldLabel: "KANTOR ASAL", name: "KODE_KANTOR", fieldCls: "fieldinput", readOnly: true },
                    ...
                    },
                    {
                      ...
                      layout: "hbox",
                      items: [
                        { xtype: "textfield", labelWidth: 130, width: 200, fieldLabel: "KANTOR TUJUAN", name: "KODE_KANTOR_TUJUAN", fieldCls: "fieldinput", readOnly: true },
                    ...
                    },
                    {
                      ...
                      layout: "hbox",
                      items: [
                        { xtype: "textfield", labelWidth: 130, width: 200, fieldLabel: "JENIS TPB ASAL", name: "KODE_JENIS_TPB", fieldCls: "fieldinput", readOnly: true },
                    ...
                    },
                    {
                      ...
                      layout: "hbox",
                      items: [
                        { xtype: "textfield", labelWidth: 130, width: 200, fieldLabel: "JENIS TPB TUJUAN", name: "KODE_TUJUAN_TPB", fieldCls: "fieldinput", readOnly: true },
                  ...
                  items: [
                    {
                      ...
                      items: [
                        {
                          xtype: "textfield",labelWidth: 130,width: 350,fieldLabel: "21. No. Segel",name: "",fieldCls: "fieldinput",readOnly: true,emptyText: "",
                        },
                        {
                          xtype: "textfield",labelWidth: 130,width: 350,fieldLabel: "22. Jenis",name: "",fieldCls: "fieldinput",readOnly: true,emptyText: "",
                        },
                        {
                          xtype: "textfield",labelWidth: 130,width: 510,fieldLabel: "23. Catatan BC Tujuan",name: "",fieldCls: "fieldinput",readOnly: true,emptyText: "",
                        },
                      ],
                    },
                  ],
