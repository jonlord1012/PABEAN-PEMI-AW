...
Ext.define("TDK.EXIM.bcin_262.FRMbcin_262_dokumen", {
  extend: "Ext.window.Window",
  alias: "widget.FRMbcin_262_dokumen",
  reference: "FRMbcin_262_dokumen",
  title: "",
  modal: true,
  closeAction: "destroy",
  centered: true,
      ...
      items: [
        {
          ...
          listeners: {
            afterrender: function (grid, record, e) {
              var GRIDinput_dokumen = Ext.ComponentQuery.query("FRMbcin_262 grid[pid=GRIDinput_dokumen]")[0];
