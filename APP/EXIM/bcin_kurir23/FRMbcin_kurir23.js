...
Ext.define("TDK.EXIM.bcin_kurir23.FRMbcin_kurir23", {
  extend: "Ext.window.Window",
  alias: "widget.FRMbcin_kurir23",
  reference: "FRMbcin_kurir23",
  title: "Header Dokumen BC Kurir 23",
  modal: true,
  closeAction: "destroy",
  centered: true,
  autoScroll: false,
                  ...
                  items: [
                    {
                      ...
                      layout: "hbox",
                      items: [
                        { xtype: "textfield", labelWidth: 100, width: 140, fieldLabel: "STATUS CEISA", name: "KODE_STATUS", fieldCls: "fieldlock", readOnly: false },
              ...
              items: [
                ...
                },
                {
                  ...
                  items: [
                    {
                      xtype: "grid",
                      pid: "GRIDbcin_kurir23_kontainer",
                      ...
                      tbar: [
                        {
                          ...
                          handler: function () {
                            var GRID = Ext.ComponentQuery.query("FRMbcin_kurir23 grid[pid=GRIDbcin_kurir23_kontainer]")[0];
                            var rec = {
                          ...
                          editor: {
                            ...
                            listeners: {
                              select: function (cmp, rec) {
                                var GRID = Ext.ComponentQuery.query("FRMbcin_kurir23 grid[pid=GRIDbcin_kurir23_kemasan]")[0];
                      ...
                      items: [
                        ...
                        },
                        {
                          ...
                          items: [
                            {
                              xtype: "grid",
                              pid: "GRIDbcin_kurir23_input_dokumen",
                              emptyText: "No Matching Records",
                              width: 665,
                              height: 230,
                  ...
                  items: [
                    ...
                    },
                    {
                      ...
                      items: [
                        {
                          xtype: "grid",
                          pid: "GRIDbcin_kurir23_input_item",
                          emptyText: "No Matching Records",
                          width: 665,
                          height: 480,
                          plugins: ["filterfield"],
  ...
  dockedItems: [
    {
      ...
      items: [
        ...
        { xtype: "button", text: "Cancel Dokumen", pid: "btcancel_dokumen", icon: vconfig.getstyle + "icon/delete.ico", tooltip: "Cancel Dokumen BC Kurir 23", handler: "FRMbcin_kurir23_btcancel_click" },
        { xtype: "button", text: "Update Dokumen", pid: "btsimpan_draft", icon: vconfig.getstyle + "icon/save.gif", tooltip: "Proses Update Dokumen BC Kurir 23", handler: "FRMbcin_kurir23_btupdate_click" },
        { xtype: "button", text: "Kunci Perubahan Dokumen", pid: "btlock_draft", icon: vconfig.getstyle + "icon/lock.png", tooltip: "Proses Lock Dokumen BC Kurir 23", handler: "FRMbcin_kurir23_btlock_click" },
        "-",
        { xtype: "button", text: "Send To Ceisa", pid: "btgenerate_draft", icon: vconfig.getstyle + "icon/up.ico", tooltip: "Kirim Dokumen Ke Aplikasi Ceisa", handler: "FRMbcin_kurir23_btsendtoceisa_click" },
        { xtype: "button", text: "Get From Ceisa", pid: "btgenerate_draft", icon: vconfig.getstyle + "icon/down.ico", tooltip: "Sinkronisasi Dokumen dari Aplikasi Ceisa", handler: "FRMbcin_kurir23_btgetfromceisa_click" },
      ],
      // other options....
    },
  ],
  listeners: {
    afterrender: "FRMbcin_kurir23_load",
  },
});
