Ext.define("NJC.EXIM.bcin_16.GRIDbcin_16", {
  extend: "Ext.form.Panel",
  alias: "widget.GRIDbcin_16",
  reference: "GRIDbcin_16",
  frame: false,
  border: false,
  ...
  items: [
    {
      ...
      store: {
        ...
        proxy: {
          ...
          url: vconfig.service_api + "bcin_16/bcin_16s",
		  extraParams: {
            method: "read_data",
          },
          reader: {
        ...
        listeners: {
          beforeload: function (store, operation, eOpts) {
            try {
              var CBO_FILTERKEY = Ext.ComponentQuery.query("bcin_16 combobox[name=CBO_FILTERKEY]")[0];
              operation.setParams({
