...
Ext.define("NJC.EXIM.bcin_271.FRMbcin_271_dokumen", {
  extend: "Ext.window.Window",
  alias: "widget.FRMbcin_271_dokumen",
  reference: "FRMbcin_271_dokumen",
  title: "",
  modal: true,
  closeAction: "destroy",
  centered: true,
      ...
      items: [
        {
          ...
          listeners: {
            afterrender: function (grid, record, e) {
              var GRIDinput_dokumen = Ext.ComponentQuery.query("FRMbcin_271 grid[pid=GRIDbcin_271_input_dokumen]")[0];
