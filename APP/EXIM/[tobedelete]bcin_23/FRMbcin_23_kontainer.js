...
Ext.define("TDK.EXIM.bcin_23.FRMbcin_23_kontainer", {
  extend: "Ext.window.Window",
  alias: "widget.FRMbcin_23_kontainer",
  reference: "FRMbcin_23_kontainer",
  title: "",
  modal: true,
  closeAction: "destroy",
  centered: true,
      ...
      items: [
        {
          ...
          listeners: {
            afterrender: function (grid, record, e) {
              var GRIDinput_kontainer = Ext.ComponentQuery.query("FRMbcin_23 grid[pid=GRIDinput_kontainer]")[0];
