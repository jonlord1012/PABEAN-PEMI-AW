      ...
      items: [
        {
          ...
          items: [
            ...
            { xtype: "textfield", fieldLabel: "Kode Dokumen", name: "KODE_DOKUMEN_PABEAN", labelWidth: 90, labelAlign: "right", width: 130, fieldCls: "fieldlock", readOnly: true },
                  ...
                  items: [
                    {
                      ...
                      columns: [
                        { header: "Seri", dataIndex: "SERI_KEMASAN", sortable: true, width: 80 },
                        { header: "Jumlah", dataIndex: "JUMLAH_KEMASAN", sortable: true, width: 80, editor: { xtype: "textfield" } },
                        { header: "Kode", dataIndex: "KODE_JENIS_KEMASAN", sortable: true, width: 80, editor: { xtype: "textfield" } },
                        { header: "Merk", dataIndex: "MERK_KEMASAN", sortable: true, flex: 1 },
                      ],
                    },
                  ],
                },
                      ...
                      items: [
                        {
                          ...
                          items: [
                            //
                            { xtype: "textfield", labelWidth: 100, width: 180, fieldLabel: "Kode Incoterm", name: "KODE_CARA_BAYAR", fieldCls: "fieldlock", readOnly: true, emptyText: "Incoterm" },
                          ],
                        },
                        {
                          xtype: "container",
                          ...
                          items: [
                            //
                            { xtype: "textfield", labelWidth: 100, width: 180, fieldLabel: "Kode Tutup PU", name: "KODE_TUTUP_PU", fieldCls: "fieldlock", readOnly: true, emptyText: "Tutup PU" },
                          ],
                        },
                        {
                          xtype: "container",
                          layout: "hbox",
                          items: [
                            { xtype: "textfield", labelWidth: 100, width: 300, fieldLabel: "Nomor Bc 11", name: "NOMOR_BC11", fieldCls: "fieldinput", readOnly: false },
                        ...
                        },
                        {
                          ...
                          layout: "hbox",
                          items: [
                            { xtype: "textfield", labelWidth: 100, width: 300, fieldLabel: "Sub Pos Bc 11", name: "SUBPOS_BC11", fieldCls: "fieldinput", readOnly: false },
                          ...
                          items: [
                            {
                              ...
                              columns: [
                                ...
                                { header: "Kode Dokumen", dataIndex: "KODE_JENIS_DOKUMEN", sortable: true, width: 110, filter: { xtype: "textfield" } },
                                {
                                  header: "Nomor",
                  ...
                  items: [
                    {
                      ...
                      layout: "hbox",
                      items: [
                        { xtype: "textfield", labelWidth: 60, width: 120, fieldLabel: "Valuta", name: "KODE_VALUTA", fieldCls: "fieldlock", readOnly: true },
