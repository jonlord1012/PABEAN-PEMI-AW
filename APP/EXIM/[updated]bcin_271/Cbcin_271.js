                ...
                if (val.success == "true") {
                  ...
                  if (val.B_HEADER !== null) {
                    ...
                    FRM.getForm().setValues({
                      ...
                      KODE_JENIS_TPB: B_HEADER.KODE_JENIS_TPB,
                      KODE_TUJUAN_PENGIRIMAN: B_HEADER.KODE_TUJUAN_PENGIRIMAN,
                      ASAL_DATA: B_HEADER.ASAL_DATA,
                      SERI: B_HEADER.SERI,
                      KODE_DOKUMEN_PABEAN: B_HEADER.KODE_DOKUMEN_PABEAN,
                      MODE_SOURCE: B_HEADER.MODE_SOURCE,
                      ID_COMPANY: B_HEADER.ID_COMPANY,
                      TANGGAL_AJU: B_HEADER.TANGGAL_AJU ? moment(B_HEADER.TANGGAL_AJU).format("YYYY-MM-DD") : "",
                      NOMOR_DAFTAR: B_HEADER.NOMOR_DAFTAR,
                      TANGGAL_DAFTAR: B_HEADER.TANGGAL_DAFTAR ? moment(B_HEADER.TANGGAL_AJU).format("YYYY-MM-DD") : "",
                    });
                  }
                  ...
                  if (val.B_ENTITAS !== null) {
                    ...
                    Ext.Array.each(B_ENTITAS, function (rec) {
                      if (rec.SERIENTITAS === 1) {
                        FRM.getForm().setValues({
                          ENTITAS1_SERIENTITAS: rec.SERIENTITAS,
                      ...
                      if (rec.SERIENTITAS === 2) {
                        FRM.getForm().setValues({
                          ENTITAS2_KODESTATUS: rec.KODESTATUS,
                          ENTITAS2_SERIENTITAS: rec.SERIENTITAS,
                          ENTITAS2_NAMAENTITAS: rec.NAMAENTITAS,
                          ENTITAS2_ALAMATENTITAS: rec.ALAMATENTITAS,
                          ENTITAS2_KODENEGARA: rec.KODENEGARA,
                          ENTITAS2_NIBENTITAS: rec.NIBENTITAS,
                          ENTITAS2_KODEJENISAPI: rec.KODEJENISAPI,
                          ENTITAS2_NOMORIDENTITAS: rec.NOMORIDENTITAS,
                        });
                      }
                      if (rec.SERIENTITAS === 3) {
                        FRM.getForm().setValues({
                          ENTITAS3_SERIENTITAS: rec.SERIENTITAS,
                  ...
                  if (val.B_PUNGUTAN !== null) {
                    ...
                    Ext.Array.each(B_PUNGUTAN, function (rec) {
                      if (rec.EDS_NOMOR_AJU) {
                        FRM.getForm().setValues({
                          KODE_JENIS_PUNGUTAN: rec.KODEJENISPUNGUTAN,
                          NILAI_PUNGUTAN: rec.NILAIPUNGUTAN,
                          KODE_FASILITAS_TARIF: rec.KODEFASILITASTARIF,
                        });
                      }
                    });
                  }
