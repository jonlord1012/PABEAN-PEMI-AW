...
Ext.define("NJC.EXIM.bcin_23.FRMbcin_23_dokumen", {
  extend: "Ext.window.Window",
  alias: "widget.FRMbcin_23_dokumen",
  reference: "FRMbcin_23_dokumen",
  title: "",
  modal: true,
  closeAction: "destroy",
  centered: true,
      ...
      items: [
        {
          ...
          listeners: {
            afterrender: function (grid, record, e) {
              var GRIDinput_dokumen = Ext.ComponentQuery.query("FRMbcin_23 grid[pid=GRIDbcin_23_input_dokumen]")[0];
