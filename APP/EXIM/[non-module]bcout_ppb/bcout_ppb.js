Ext.define("TDK.EXIM.bcout_ppb.bcout_ppb", {
  extend: "Ext.form.Panel",
  alias: "widget.bcout_ppb",
  reference: "bcout_ppb",
  config: {},
  requires: ["TDK.EXIM.bcout_ppb.GRIDbcout_ppb", "TDK.EXIM.bcout_ppb.Cbcout_ppb"],
  constructor: function (config) {
    return this.callParent(arguments);
  },
  //untuk include controller
  controller: "Cbcout_ppb",
