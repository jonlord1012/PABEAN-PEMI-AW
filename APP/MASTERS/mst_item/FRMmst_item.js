...
Ext.define("TDK.MASTERS.mst_item.FRMmst_item", {
          ...
          items: [
                {
                  ...
                  items: [
                    ...
                    { xtype: "textfield", labelWidth: 120, width: 400, fieldLabel: "PART SAP NO", name: "PART_SAPNO", fieldCls: "fieldinput", maxLength: 70, readOnly: false},
                ...
                },
                {
                  ...
                  items :[
                    //{ xtype: "textfield", labelWidth: 120, width: 400, fieldLabel: "NOMOR HS", name: "NOMOR_HS", fieldCls: "fieldinput", maxLength: 30, readOnly: false },
                    {
                      ...
                      layout: "hbox",
                      items: [
                        { xtype: "textfield", labelWidth: 120, width: 370, fieldLabel: "NOMOR HS", name: "NOMOR_HS", fieldCls: "fieldinput", readOnly: true},
                        {
                          xtype: "button",
                          pid: "btsearch",
  ...
  listeners: {
    afterrender: "GRIDFRMmst_item_parths_load",
  },
});
