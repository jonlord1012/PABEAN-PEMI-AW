Ext.define("TDK.MASTERS.mst_item.GRIDmst_item", {
  ...
  items: [
    {
      ...
      columns: [
        ...
        { header: "PART SAP NO", dataIndex:"PART_SAPNO", sortable: true, width: 160, filter: { xtype: "textfield" } },
        { header: "NOMOR HS", dataIndex:"NOMOR_HS", sortable: true, width: 160, filter: { xtype: "textfield" } },
        ...
        { header: "PART MIN QTY", dataIndex:"PART_MIN_QTY", renderer: "formatAmount", align: "right", sortable: true, width: 100, filter: { xtype: "textfield" } },
        ...
        { header: "PART CONSUMABLE", dataIndex:"PART_CONSUMABLE", sortable: true, width: 80, filter: { xtype: "textfield" } },
        { header: "PART SVC LEVEL", dataIndex:"PART_SVC_LEVEL", renderer: "formatAmount", align: "right", sortable: true, width: 100, filter: { xtype: "textfield" } },
        { header: "RACK NO", dataIndex:"RACK_NO", sortable: true, width: 100, filter: { xtype: "textfield" } },
        { header: "IS BOM", dataIndex:"IS_BOM", sortable: true, width: 80, filter: { xtype: "textfield" } },
        { header: "IS PARTLIST", dataIndex:"IS_PARTLIST", sortable: true, width: 80, filter: { xtype: "textfield" } },
        { header: "IS AUTO OUT", dataIndex:"IS_AUTO_OUT", sortable: true, width: 80, filter: { xtype: "textfield" } },
