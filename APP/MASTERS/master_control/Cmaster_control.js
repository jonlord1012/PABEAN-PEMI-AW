Ext.define('TDK.masters.master_control.Cmaster_control', {
    ...
    renderpage: function () {
        try {
            ...
            var vlinkto = tabconfig.xfunctions_linkto !== null ? tabconfig.xfunctions_linkto : vconfig.service_api + '/dummyservice/home/api/' + tabconfig.xfunctions_name + '/' + tabconfig.xfunctions_name;
