Ext.define("NJC.MASTERS.mst_item_comp.uom_part.uom_part", {
  extend: "Ext.form.Panel",
  alias: "widget.uom_part",
  reference: "uom_part",
  config: {},
  requires: ["NJC.MASTERS.mst_item_comp.uom_part.Cuom_part", "NJC.MASTERS.mst_item_comp.uom_part.FRMuom_part"],
  constructor: function (config) {
    return this.callParent(arguments);
  },
  //untuk include controller
  controller: "Cuom_part",
