Ext.define("NJC.MASTERS.mst_item_comp.group_part.group_part", {
  extend: "Ext.form.Panel",
  alias: "widget.group_part",
  reference: "group_part",
  config: {},
  requires: ["NJC.MASTERS.mst_item_comp.group_part.Cgroup_part", "NJC.MASTERS.mst_item_comp.group_part.FRMgroup_part"],
  constructor: function (config) {
    return this.callParent(arguments);
  },
  //untuk include controller
  controller: "Cgroup_part",
  initComponent: function () {
    Ext.apply(this, {
      xtype: "panel",
      pid: "panel_group_part",
      layout: "card",
      frame: false,
      border: false,
      items: [{ xtype: "FRMgroup_part" }],
      dockedItems: [
        {
          xtype: "toolbar",
          height: 30,
