Ext.define("NJC.MASTERS.mst_item_comp.best_part.FRMbest_part", {
  extend: "Ext.form.Panel",
  alias: "widget.FRMbest_part",
  reference: "FRMbest_part",
  border: false,
  frame: false,
  ...
  items: [
          ...
          items: [
            {
              ...
              items: [
                { xtype: "numberfield", name: "ID", hidden: true, value: 0 },
                {
                  ...
                  layout: "hbox",
                  bodyPadding: "0 0 0 0",
                  items: [{ xtype: "textfield", labelWidth: 120, width: 400, fieldLabel: "Type Name", name: "MODE_CODE", fieldCls: "fieldinput", maxLength: 255, readOnly: false }],
                },
                {
                  xtype: "container",
                  layout: "hbox",
    ...
    },
    {
      ...
      columns: [
        ...
        { header: "Type Name", dataIndex: "MODE_CODE", sortable: true, width: 300, filter: { xtype: "textfield" } },
