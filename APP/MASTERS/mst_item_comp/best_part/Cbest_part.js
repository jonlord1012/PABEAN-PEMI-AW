Ext.define("NJC.MASTERS.mst_item_comp.best_part.Cbest_part", {
  extend: "Ext.app.ViewController",
  alias: "controller.Cbest_part",
  init: function (view) {
    this.control({
      "best_part FRMbest_part grid[pid=GRIDbest_part]": { itemdblclick: this.GRIDbest_part_itemdblclick },
      "best_part button[pid=btnew_input]": { click: this.btnew_input_click },
      "best_part button[pid=btsave]": { click: this.btsave_click },
      "best_part button[pid=btdelete]": { click: this.btdelete_click },
    });
    this.var_global = {
  ...
  btnew_input_click: function () {
    try {
      var FRM = Ext.ComponentQuery.query("FRMbest_part form")[0];
  ...
  GRIDbest_part_itemdblclick: function (cmp, rec) {
    try {
      var FRM = Ext.ComponentQuery.query("FRMbest_part form")[0];
      var MAIN_dtval = FRM.getValues(false, false, false, true);
  ...
  btsave_click: function () {
    try {
      var me = this;
      var FRM = Ext.ComponentQuery.query("FRMbest_part form")[0];
      var GRID = Ext.ComponentQuery.query("FRMbest_part grid[pid=GRIDbest_part]")[0];
      var MAIN_dtval = FRM.getValues(false, false, false, true);
