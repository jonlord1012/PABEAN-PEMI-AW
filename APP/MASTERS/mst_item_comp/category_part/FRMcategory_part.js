Ext.define("NJC.MASTERS.mst_item_comp.category_part.FRMcategory_part", {
  extend: "Ext.form.Panel",
  alias: "widget.FRMcategory_part",
  reference: "FRMcategory_part",
  border: false,
  frame: false,
  ...
  items: [
          ...
          items: [
            {
              ...
              items: [
                { xtype: "numberfield", name: "ID", hidden: true, value: 0 },
                {
                  ...
                  layout: "hbox",
                  bodyPadding: "0 0 0 0",
                  items: [{ xtype: "textfield", labelWidth: 120, width: 300, fieldLabel: "Category Name", name: "MODE_CODE", fieldCls: "fieldinput", maxLength: 255, readOnly: false }],
                },
                {
                  xtype: "container",
                  layout: "hbox",
    ...
    },
    {
      ...
      columns: [
        ...
        { header: "Category Name", dataIndex: "MODE_CODE", sortable: true, width: 300, filter: { xtype: "textfield" } },
