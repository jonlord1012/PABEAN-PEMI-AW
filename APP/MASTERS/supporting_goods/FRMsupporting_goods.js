...
Ext.define("NJC.MASTERS.supporting_goods.FRMsupporting_goods", {
  extend: "Ext.window.Window",
  alias: "widget.FRMsupporting_goods",
  reference: "FRMsupporting_goods",
  ...
  items: [
    ...
    },
    {
      ...
      items: [
        {
          xtype: "grid",
          pid: "GRIDFRMsupporting_goods_parths",
  ...
  listeners: {
    afterrender: "GRIDFRMsupporting_goods_parths_load",
  },
});
