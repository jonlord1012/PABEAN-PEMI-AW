...
Ext.define("NJC.STOCK_OPNAME.sto_goods.FRMsto_goods_input", {
	extend: "Ext.window.Window",
	alias: "widget.FRMsto_goods_input",
	reference: "FRMsto_goods_input",
	title: "Input STO GOODS",
	modal: true,
	closeAction: "hide",
	...
	dockedItems: [
	{
        ...
        //
			...
			"-",
			{ xtype: "datefield", labelWidth: 100, width: 220, fieldLabel: "Tanggal Receiving", name: "TANGGAL_RCV_STO_GOODS", fieldCls: "fieldinput", readOnly: false, format: "Y-m-d", value: new Date() },
			"-",
			{ xtype: "tbspacer", width: 10, text: "-" },
			{ xtype: "button", text: "Process Synchronize", pid: "sto_goods_synchronize", icon: vconfig.getstyle + "icon/update.ico", tooltip: "Process Synchronize" },
			],
	},
	],
});