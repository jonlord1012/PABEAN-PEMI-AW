...
Ext.define("TDK.INVENTORY.inv_fg_out.FRMinv_fg_out", {
  extend: "Ext.window.Window",
  alias: "widget.FRMinv_fg_out",
  reference: "FRMinv_fg_out",
  ...
  dockedItems: [
    {
      ...
      items: [
        { xtype: "tbspacer", width: 10 },
        {
          xtype: "button",
          text: "Save",
          pid: "FRMinv_fg_out_btsave",
          icon: vconfig.getstyle + "icon/save.gif",
          tooltip: "Save Data",
          handler: "FRMinv_fg_out_btsave_click",
        },
      ],
    },
  ],
