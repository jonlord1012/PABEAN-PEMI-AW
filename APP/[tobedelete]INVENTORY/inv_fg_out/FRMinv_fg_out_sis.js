...
Ext.define("TDK.INVENTORY.inv_fg_out.FRMinv_fg_out_sis", {
  extend: "Ext.window.Window",
  alias: "widget.FRMinv_fg_out_sis",
  reference: "FRMinv_fg_out_sis",
      ...
      items: [
        {
          ...
          store: {
            ...
            listeners: {
              beforeload: function (store, operation, eOpts) {
                try {
                  var vdate = Ext.ComponentQuery.query("FRMinv_fg_out_sis datefield[name=RegisterDate]")[0];
                  operation.setParams({
          ...
          columns: [
            ...
            { sortable: true, width: 65, filter: { xtype: "textfield" }, header: "SUPPLIER", dataIndex: "SUPPLIER_CODE" },
            { sortable: true, width: 120, filter: { xtype: "textfield" }, header: "INVOICE", dataIndex: "INVOICE_NO" },
            ...
            { sortable: true, width: 200, filter: { xtype: "textfield" }, header: "PART INT", dataIndex: "SUMBER_PARTNO" },
            { sortable: true, width: 100, align: "right", renderer: "formatqty", header: "SOURCE QTY", dataIndex: "SUMBER_QTY" },
  ...
  dockedItems: [
    {
      ...
      items: [
        ...
        "-",
        { xtype: "datefield", labelWidth: 100, width: 220, fieldLabel: "Tanggal Pengiriman", name: "RegisterDate", fieldCls: "fieldinput", readOnly: false, format: "Y-m-d", value: new Date() },
        "-",
        { xtype: "tbspacer", width: 10, text: "-" },
        { xtype: "button", text: "Process Synchronize", pid: "btsave", icon: vconfig.getstyle + "icon/update.ico", tooltip: "Save Data" },
      ],
    },
  ],
});
