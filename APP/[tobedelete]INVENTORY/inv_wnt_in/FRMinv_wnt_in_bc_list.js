...
Ext.define("TDK.INVENTORY.inv_wnt_in.FRMinv_wnt_in_bc_list", {
    extend: "Ext.window.Window",
    alias: "widget.FRMinv_wnt_in_bc_list",
    reference: "FRMinv_wnt_in_bc_list",
    ...
    items: [
        {
            ...
            listeners: {
                itemdblclick: "GRIDFRMinv_wnt_in_bc_list_dblclick",
                afterrender: "GRIDFRMinv_wnt_in_bc_list_load",
            },
            bbar: {
                xtype: "pagingtoolbar",
                displayInfo: true,
