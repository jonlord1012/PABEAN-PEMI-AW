Ext.define("TDK.INVENTORY.inv_material_return.GRIDinv_material_return", {
  extend: "Ext.form.Panel",
  alias: "widget.GRIDinv_material_return",
  reference: "GRIDinv_material_return",
  frame: false,
  border: false,
  autoScroll: true,
  ...
  // ],
  // listeners: {
  //   afterrender: "GRIDinv_material_return_load",
  // },
});
