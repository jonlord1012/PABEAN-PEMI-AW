...
Ext.define("TDK.INVENTORY.inv_material_control.FRMimc_stock_itempending", {
  extend: "Ext.window.Window",
  alias: "widget.FRMimc_stock_itempending",
  reference: "FRMimc_stock_itempending",
  title: "Stock Item/Part Material Pending",
  modal: true,
  closeAction: "hide",
  centered: true,
  autoScroll: true,
  ...
  dockedItems: [
    {
      ...
      items: [
        ...
        { xtype: "button", text: "Refresh", pid: "FRMimc_stock_itempending_btrefresh", icon: vconfig.getstyle + "icon/update.ico", tooltip: "Refresh Data" },
      ],
    },
  ],
  listeners: {
