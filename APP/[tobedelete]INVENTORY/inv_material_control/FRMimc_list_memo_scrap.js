...
Ext.define("TDK.INVENTORY.inv_material_control.FRMimc_list_memo_scrap", {
  extend: "Ext.window.Window",
  alias: "widget.FRMimc_list_memo_scrap",
  reference: "FRMimc_list_memo_scrap",
  title: "Memo Scrap",
  modal: true,
  closeAction: "hide",
  centered: true,
  ...
  dockedItems: [
    {
      ...
      items: [
        ...
        { xtype: "button", text: "Refresh", pid: "FRMimc_list_memo_scrap_btrefresh", icon: vconfig.getstyle + "icon/update.ico", tooltip: "Refresh Data" },
      ],
    },
  ],
  listeners: {
