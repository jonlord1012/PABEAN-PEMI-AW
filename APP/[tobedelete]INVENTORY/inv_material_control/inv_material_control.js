Ext.define("TDK.INVENTORY.inv_material_control.inv_material_control", {
  extend: "Ext.form.Panel",
  alias: "widget.inv_material_control",
  reference: "inv_material_control",
  config: {},
  requires: [
    //
    ...
    "TDK.INVENTORY.inv_material_control.Cinv_material_control",
  ],
      ...
      items: [
        {
          ...
          items: [
            {
              xtype: "dataview",
              pid: "dataview_inv_material_control",
              plugins: {
