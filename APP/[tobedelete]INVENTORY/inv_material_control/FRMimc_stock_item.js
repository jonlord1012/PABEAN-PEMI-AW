...
Ext.define("TDK.INVENTORY.inv_material_control.FRMimc_stock_item", {
  extend: "Ext.window.Window",
  alias: "widget.FRMimc_stock_item",
  reference: "FRMimc_stock_item",
  title: "Stock Item",
  modal: true,
  closeAction: "hide",
  centered: true,
  ...
  dockedItems: [
    {
      ...
      items: [
        ...
        { xtype: "button", text: "Refresh", pid: "FRMimc_stock_item_btrefresh", icon: vconfig.getstyle + "icon/update.ico", tooltip: "Refresh Data" },
      ],
    },
  ],
  listeners: {
