...
Ext.define("TDK.INVENTORY.inv_material_control.FRMimc_outstanding_receiving", {
  extend: "Ext.window.Window",
  alias: "widget.FRMimc_outstanding_receiving",
  reference: "FRMimc_outstanding_receiving",
  ...
  dockedItems: [
    {
      ...
      items: [
        ...
        { xtype: "button", text: "Refresh", pid: "FRMimc_outstanding_receiving_btrefresh", icon: vconfig.getstyle + "icon/update.ico", tooltip: "Refresh Data" },
      ],
    },
  ],
  listeners: {
