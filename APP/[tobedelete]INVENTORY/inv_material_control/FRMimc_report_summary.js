...
Ext.define("TDK.INVENTORY.inv_material_control.FRMimc_report_summary", {
  extend: "Ext.window.Window",
  alias: "widget.FRMimc_report_summary",
  reference: "FRMimc_report_summary",
  title: "Report Summary",
  modal: true,
  closeAction: "destroy",
  centered: true,
  autoScroll: true,
  controller: "Cinv_material_control",
  //y: -110,
    ...
    items: [
    {
      ...
      store: {
        ...
        proxy: {
          ...
          url: vconfig.service_api + "imc_report_stock/imc_report_stocks",
          extraParams: {
        ...
        listeners: {
          beforeload: function (store, operation, eOpts) {
            try {
              var VIDCOMPANY = Ext.ComponentQuery.query("FRMimc_report_summary combobox[name=CBO_COMPANY]")[0];
              var VPARTGROUP = Ext.ComponentQuery.query("FRMimc_report_summary combobox[name=CBO_PARTGROUP]")[0];
              var VFROMDATE = Ext.ComponentQuery.query("FRMimc_report_summary monthfield[name=tfromdate]")[0];
              var VTODATE = Ext.ComponentQuery.query("FRMimc_report_summary monthfield[name=ttodate]")[0];
  ...
  dockedItems: [
    {
      ...
      items: [
        ...
        { xtype: "button", text: "Refresh", pid: "FRMimc_report_summary_btrefresh", icon: vconfig.getstyle + "icon/update.ico", tooltip: "Refresh Data" },
        "-",
        {
          xtype: "combobox",
          name: "CBO_COMPANY",
        ...
        "-",
        {
          ...
          items: [
            ...
            {
              xtype: "button",
              pid: "FRMimc_report_summary_btsearch",
              icon: vconfig.getstyle + "icon/search.ico",
              tooltip: "search",
              handler: "FRMimc_report_summary_btsearch"
            },
          ],
        },
        "->",
