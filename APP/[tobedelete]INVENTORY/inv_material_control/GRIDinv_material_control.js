Ext.define("TDK.INVENTORY.inv_material_control.GRIDinv_material_control", {
  extend: "Ext.form.Panel",
  alias: "widget.GRIDinv_material_control",
  reference: "GRIDinv_material_control",
  frame: false,
  border: false,
  autoScroll: true,
