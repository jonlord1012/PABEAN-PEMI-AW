Ext.define("TDK.INVENTORY.inv_material_control.control_inv_in.FRMhr_out_prod", {
  extend: "Ext.form.Panel",
  alias: "widget.FRMhr_out_prod",
  reference: "FRMhr_out_prod",
  frame: false,
  border: true,
  autoScroll: true,
  ...
  dockedItems: [
    {
      ...
      items: [
        "-",
        {
          ...
          handler: function () {
            var GRID = Ext.ComponentQuery.query("FRMhr_out_prod grid[pid=GRIDhr_out_prod]")[0];
            GRID.getStore().load();
          },
        },
      ],
