Ext.define("TDK.INVENTORY.inv_material_control.control_inv_in.FRMhr_out_repair", {
  extend: "Ext.form.Panel",
  alias: "widget.FRMhr_out_repair",
  reference: "FRMhr_out_repair",
  frame: false,
  border: true,
  autoScroll: true,
      ...
      store: {
        ...
        listeners: {
          beforeload: function (store, operation, eOpts) {
            try {
              var GRID = Ext.ComponentQuery.query("inv_material_control GRIDinv_material_control grid[pid=GRIDinv_material_control]")[0];
  ...
  dockedItems: [
    {
      ...
      items: [
        "-",
        {
          ...
          handler: function () {
            var GRID = Ext.ComponentQuery.query("FRMhr_out_repair grid[pid=GRIDhr_out_repair]")[0];
            GRID.getStore().load();
          },
        },
      ],
