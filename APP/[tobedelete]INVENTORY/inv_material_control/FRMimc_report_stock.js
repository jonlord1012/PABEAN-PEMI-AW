...
Ext.define("TDK.INVENTORY.inv_material_control.FRMimc_report_stock", {
  extend: "Ext.window.Window",
  alias: "widget.FRMimc_report_stock",
  reference: "FRMimc_report_stock",
      ...
      store: {
        ...
        listeners: {
          beforeload: function (store, operation, eOpts) {
            try {
              var VIDCOMPANY = Ext.ComponentQuery.query("FRMimc_report_stock combobox[name=CBO_COMPANY]")[0];
              var VPARTGROUP = Ext.ComponentQuery.query("FRMimc_report_stock combobox[name=CBO_PARTGROUP]")[0];
              var VFROMDATE = Ext.ComponentQuery.query("FRMimc_report_stock monthfield[name=tfromdate]")[0];
              var VTODATE = Ext.ComponentQuery.query("FRMimc_report_stock monthfield[name=ttodate]")[0];
  ...
  dockedItems: [
    {
      ...
      items: [
        ...
        { xtype: "button", text: "Refresh", pid: "FRMimc_report_stock_btrefresh", icon: vconfig.getstyle + "icon/update.ico", tooltip: "Refresh Data" },
        "-",
        {
          xtype: "combobox",
          name: "CBO_COMPANY",
        ...
        "-",
        {
          ...
          items: [
            ...
            {
              xtype: "button",
              pid: "FRMimc_report_stock_btsearch",
              icon: vconfig.getstyle + "icon/search.ico",
              tooltip: "search",
              handler: "FRMimc_report_stock_btsearch_click"
            },
          ],
        },
        "->",
