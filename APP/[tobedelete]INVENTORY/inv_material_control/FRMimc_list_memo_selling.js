...
Ext.define("TDK.INVENTORY.inv_material_control.FRMimc_list_memo_selling", {
  extend: "Ext.window.Window",
  alias: "widget.FRMimc_list_memo_selling",
  reference: "FRMimc_list_memo_selling",
  title: "Memo Selling",
  modal: true,
  closeAction: "hide",
  centered: true,
  ...
  dockedItems: [
    {
      ...
      items: [
        ...
        { xtype: "button", text: "Refresh", pid: "FRMimc_list_memo_selling_btrefresh", icon: vconfig.getstyle + "icon/update.ico", tooltip: "Refresh Data" },
      ],
    },
  ],
  listeners: {
