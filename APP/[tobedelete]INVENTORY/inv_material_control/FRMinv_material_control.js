...
Ext.define("TDK.INVENTORY.inv_material_control.FRMinv_material_control", {
  extend: "Ext.window.Window",
  alias: "widget.FRMinv_material_control",
  reference: "FRMinv_material_control",
  title: "",
  modal: true,
  closeAction: "destroy",
  centered: true,
  ...
  dockedItems: [],
  listeners: {
    afterrender: "FRMinv_material_control_load",
  },
});
