Ext.define("TDK.INVENTORY.inventory_return.GRIDinventory_return", {
  extend: "Ext.form.Panel",
  alias: "widget.GRIDinventory_return",
  reference: "GRIDinventory_return",
  frame: false,
  border: false,
  autoScroll: true,
  ...
  listeners: {
    afterrender: "GRIDinventory_return_load",
  },
});
