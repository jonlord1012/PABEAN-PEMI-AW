...
Ext.define("TDK.INVENTORY.inv_wip_out.FRMinv_wip_out", {
  extend: "Ext.window.Window",
  alias: "widget.FRMinv_wip_out",
  reference: "FRMinv_wip_out",
  ...
  dockedItems: [
    {
      ...
      items: [
        { xtype: "tbspacer", width: 10 },
        {
          xtype: "button",
          text: "Save",
          pid: "FRMinv_wip_out_btsave",
          icon: vconfig.getstyle + "icon/save.gif",
          tooltip: "Save Data",
          handler: "FRMinv_wip_out_btsave_click",
        },
      ],
    },
  ],
