Ext.define("TDK.INVENTORY.inv_wip_out.dokumen_detail.wp_wip_out_bahanbaku", {
  extend: "Ext.form.Panel",
  alias: "widget.wp_wip_out_bahanbaku",
  reference: "wp_wip_out_bahanbaku",
  frame: false,
  border: true,
  autoScroll: true,
      ...
      store: {
        ...
        listeners: {
          beforeload: function (store, operation, eOpts) {
            try {
              var GRID = Ext.ComponentQuery.query("inv_wip_out GRIDinv_wip_out grid[pid=GRIDinv_wip_out]")[0];
