Ext.define("TDK.INVENTORY.inv_wip_out.dokumen_detail.Cdokumen_detail", {
  extend: "Ext.app.ViewController",
  alias: "controller.Cwipoutdokumen_detail",
  init: function (view) {
    this.control({});
    this.listen({
      store: {},
  ...
  wipout_dokumen_detail_link_click: function (cmp, dt) {
    try {
      var vdt = dt.data;
      ...
      var cls = "TDK.INVENTORY.inv_wip_out." + vmodulename + "." + vmodulecontrol;

      var tabs = Ext.ComponentQuery.query("wipout_dokumen_detail tabpanel[pid=wipout_dokumen_detail_tabpanel]")[0];
