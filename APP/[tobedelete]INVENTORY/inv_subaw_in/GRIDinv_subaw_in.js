Ext.define("TDK.INVENTORY.inv_subaw_in.GRIDinv_subaw_in", {
  extend: "Ext.form.Panel",
  alias: "widget.GRIDinv_subaw_in",
  reference: "GRIDinv_subaw_in",
  frame: false,
  border: false,
  autoScroll: true,
  ...
  listeners: {
    afterrender: "GRIDinv_subaw_in_load",
  },
});
