Ext.define("TDK.INVENTORY.in_wip_control.in_wip_control", {
  extend: "Ext.form.Panel",
  alias: "widget.in_wip_control",
  reference: "in_wip_control",
  config: {},
  requires: [
    //
    ...
    "TDK.INVENTORY.in_wip_control.Cin_wip_control",
  ],
  constructor: function (config) {
    return this.callParent(arguments);
  },
  //untuk include controller
  controller: "Cin_wip_control",
  initComponent: function () {
    Ext.apply(this, {
      xtype: "panel",
      pid: "panelin_wip_control",
      layout: "card",
      frame: false,
      border: false,
      items: [
          ...
          items: [
            {
              ...
              store: {
                ...
                proxy: {
                  ...
                  url: vconfig.service_api + "in_wip_control/in_wip_controls",
                  extraParams: {
                    method: "read_control",
                  },
                  reader: {
