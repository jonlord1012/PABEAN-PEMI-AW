Ext.define("TDK.INVENTORY.inv_wip_return.GRIDinv_wip_return", {
  extend: "Ext.form.Panel",
  alias: "widget.GRIDinv_wip_return",
  reference: "GRIDinv_wip_return",
  frame: false,
  border: false,
  autoScroll: true,
  ...
  listeners: {
    afterrender: "GRIDinv_wip_return_load",
  },
});
