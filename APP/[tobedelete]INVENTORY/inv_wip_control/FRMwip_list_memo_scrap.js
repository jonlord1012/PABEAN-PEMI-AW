...
Ext.define("TDK.INVENTORY.inv_wip_control.FRMwip_list_memo_scrap", {
  extend: "Ext.window.Window",
  alias: "widget.FRMwip_list_memo_scrap",
  reference: "FRMwip_list_memo_scrap",
  title: "Memo Scrap",
  modal: true,
  closeAction: "hide",
  centered: true,
  ...
  dockedItems: [
    {
      ...
      items: [
        ...
        { xtype: "button", text: "Refresh", pid: "FRMwip_list_memo_scrap_btrefresh", icon: vconfig.getstyle + "icon/update.ico", tooltip: "Refresh Data" },
      ],
    },
  ],
  listeners: {
