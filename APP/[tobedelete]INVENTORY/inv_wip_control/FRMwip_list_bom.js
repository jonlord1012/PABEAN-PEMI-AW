...
Ext.define("TDK.INVENTORY.inv_wip_control.FRMwip_list_bom", {
  extend: "Ext.window.Window",
  alias: "widget.FRMwip_list_bom",
  reference: "FRMwip_list_bom",
  ...
  dockedItems: [
    {
      ...
      items: [
        ...
        { xtype: "button", text: "Refresh", pid: "FRMwip_list_bom_btrefresh", icon: vconfig.getstyle + "icon/update.ico", tooltip: "Refresh Data" },
      ],
    },
  ],
  listeners: {
