...
Ext.define("TDK.INVENTORY.inv_wip_control.FRMwip_stock_item", {
  extend: "Ext.window.Window",
  alias: "widget.FRMwip_stock_item",
  reference: "FRMwip_stock_item",
  title: "Stock Item",
  modal: true,
  closeAction: "hide",
  centered: true,
  ...
  dockedItems: [
    {
      ...
      items: [
        ...
        { xtype: "button", text: "Refresh", pid: "FRMwip_stock_item_btrefresh", icon: vconfig.getstyle + "icon/update.ico", tooltip: "Refresh Data" },
      ],
    },
  ],
  listeners: {
