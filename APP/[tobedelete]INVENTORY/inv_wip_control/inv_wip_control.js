Ext.define("TDK.INVENTORY.inv_wip_control.inv_wip_control", {
  extend: "Ext.form.Panel",
  alias: "widget.inv_wip_control",
  reference: "inv_wip_control",
  config: {},
  requires: [
    //
    ...
    "TDK.INVENTORY.inv_wip_control.Cinv_wip_control",
  ],
