Ext.define("TDK.INVENTORY.inventory_in.GRIDinventory_in", {
  extend: "Ext.form.Panel",
  alias: "widget.GRIDinventory_in",
  reference: "GRIDinventory_in",
  frame: false,
  border: false,
  autoScroll: true,
  ...
  // ],
  // listeners: {
  //   afterrender: "GRIDinventory_in_load",
  // },
});
