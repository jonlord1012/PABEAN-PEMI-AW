Ext.define("TDK.INVENTORY.subaw_return.GRIDsubaw_return", {
  extend: "Ext.form.Panel",
  alias: "widget.GRIDsubaw_return",
  reference: "GRIDsubaw_return",
  frame: false,
  border: false,
  autoScroll: true,
  ...
  listeners: {
    afterrender: "GRIDsubaw_return_load",
  },
});
