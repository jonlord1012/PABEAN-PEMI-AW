Ext.define("TDK.INVENTORY.inv_wnt_control.inv_wnt_control", {
  extend: "Ext.form.Panel",
  alias: "widget.inv_wnt_control",
  reference: "inv_wnt_control",
  config: {},
  requires: [
    //
    ...
    "TDK.INVENTORY.inv_wnt_control.Cinv_wnt_control",
  ],
