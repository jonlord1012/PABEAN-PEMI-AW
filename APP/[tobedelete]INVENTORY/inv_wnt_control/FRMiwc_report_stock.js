...
Ext.define("TDK.INVENTORY.inv_wnt_control.FRMiwc_report_stock", {
  extend: "Ext.window.Window",
  alias: "widget.FRMiwc_report_stock",
  reference: "FRMiwc_report_stock",
  title: "Report Stock",
  modal: true,
  closeAction: "destroy",
  centered: true,
    ...
    items: [
    {
      ...
      store: {
        ...
        proxy: {
          ...
          url: vconfig.service_api + "iwc_report_stock/iwc_report_stocks",
          extraParams: {
            method: "read_data",
          },
          reader: {
        ...
        listeners: {
          beforeload: function (store, operation, eOpts) {
            try {
              var VIDCOMPANY = Ext.ComponentQuery.query("FRMiwc_report_stock combobox[name=CBO_COMPANY]")[0];
              var VPARTGROUP = Ext.ComponentQuery.query("FRMiwc_report_stock combobox[name=CBO_PARTGROUP]")[0];
              var VFROMDATE = Ext.ComponentQuery.query("FRMiwc_report_stock monthfield[name=tfromdate]")[0];
              var VTODATE = Ext.ComponentQuery.query("FRMiwc_report_stock monthfield[name=ttodate]")[0];
  ...
  dockedItems: [
    {
      ...
      items: [
        ...
        { xtype: "button", text: "Refresh", pid: "FRMiwc_report_stock_btrefresh", icon: vconfig.getstyle + "icon/update.ico", tooltip: "Refresh Data" },
        "-",
        {
          xtype: "combobox",
          name: "CBO_COMPANY",
        ...
        "-",
        {
          ...
          items: [
            ...
            {
              xtype: "button",
              pid: "FRMiwc_report_stock_btsearch",
              icon: vconfig.getstyle + "icon/search.ico",
              tooltip: "search",
              handler: "FRMiwc_report_stock_btsearch_click"
            },
          ],
        },
        "->",
