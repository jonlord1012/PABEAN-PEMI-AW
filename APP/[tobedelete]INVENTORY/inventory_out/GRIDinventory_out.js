Ext.define("TDK.INVENTORY.inventory_out.GRIDinventory_out", {
  extend: "Ext.form.Panel",
  alias: "widget.GRIDinventory_out",
  reference: "GRIDinventory_out",
  frame: false,
  border: false,
  autoScroll: true,
  ...
  // ],
  // listeners: {
  //   afterrender: "GRIDinventory_out_load",
  // },
});
