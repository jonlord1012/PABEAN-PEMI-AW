...
Ext.define("TDK.INVENTORY.inv_material_in.FRMinv_material_in", {
  extend: "Ext.window.Window",
  alias: "widget.FRMinv_material_in",
  reference: "FRMinv_material_in",
  ...
  dockedItems: [
    {
      ...
      items: [
        { xtype: "tbspacer", width: 10 },
        {
          xtype: "button",
          text: "Save",
          pid: "FRMinv_material_in_btsave",
          icon: vconfig.getstyle + "icon/save.gif",
          tooltip: "Save Data",
          handler: "FRMinv_material_in_btsave_click",
        },
      ],
    },
  ],
