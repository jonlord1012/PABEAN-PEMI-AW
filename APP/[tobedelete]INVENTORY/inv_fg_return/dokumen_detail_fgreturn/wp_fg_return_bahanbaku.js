Ext.define("TDK.INVENTORY.inv_fg_return.dokumen_detail_fgreturn.wp_fg_returnbahanbaku", {
  extend: "Ext.form.Panel",
  alias: "widget.wp_fg_returnbahanbaku",
  reference: "wp_fg_returnbahanbaku",
  frame: false,
  border: true,
  autoScroll: true,
