Ext.define("TDK.INVENTORY.inv_wnt_return.GRIDinv_wnt_return", {
  extend: "Ext.form.Panel",
  alias: "widget.GRIDinv_wnt_return",
  reference: "GRIDinv_wnt_return",
  frame: false,
  border: false,
  autoScroll: true,
  ...
  listeners: {
    afterrender: "GRIDinv_wnt_return_load",
  },
});
