...
Ext.define("TDK.INVENTORY.inv_wip_in.FRMinv_wip_in_pis", {
  extend: "Ext.window.Window",
  alias: "widget.FRMinv_wip_in_pis",
  reference: "FRMinv_wip_in_pis",
          ...
          store: {
            ...
            listeners: {
              beforeload: function (store, operation, eOpts) {
                try {
                  var vdate = Ext.ComponentQuery.query("FRMinv_wip_in_pis datefield[name=TANGGAL_RCV]")[0];
                  operation.setParams({
