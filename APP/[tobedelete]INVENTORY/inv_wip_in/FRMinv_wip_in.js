...
Ext.define("TDK.INVENTORY.inv_wip_in.FRMinv_wip_in", {
  extend: "Ext.window.Window",
  alias: "widget.FRMinv_wip_in",
  reference: "FRMinv_wip_in",
  ...
  dockedItems: [
    {
      ...
      items: [
        { xtype: "tbspacer", width: 10 },
        {
          xtype: "button",
          text: "Save",
          pid: "FRMinv_wip_in_btsave",
          icon: vconfig.getstyle + "icon/save.gif",
          tooltip: "Save Data",
          handler: "FRMinv_wip_in_btsave_click",
        },
      ],
    },
  ],
