Ext.define("TDK.INVENTORY.inv_subaw_out.GRIDinv_subaw_out", {
  extend: "Ext.form.Panel",
  alias: "widget.GRIDinv_subaw_out",
  reference: "GRIDinv_subaw_out",
  frame: false,
  border: false,
  autoScroll: true,
  ...
  listeners: {
    afterrender: "GRIDinv_subaw_out_load",
  },
});
