...
Ext.define("TDK.INVENTORY.inv_material_out.FRMout_toselling_mt", {
  extend: "Ext.window.Window",
  alias: "widget.FRMout_toselling_mt",
  reference: "FRMout_toselling_mt",
  ...
  dockedItems: [
    {
      ...
      items: [
        { xtype: "tbspacer", width: 10 },
        { xtype: "button", text: "Save", pid: "FRMout_toselling_mt_btsave", icon: vconfig.getstyle + "icon/save.gif", tooltip: "Save Data" },
      ],
    },
  ],
  listeners: {
