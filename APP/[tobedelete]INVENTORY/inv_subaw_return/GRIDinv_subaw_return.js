Ext.define("TDK.INVENTORY.inv_subaw_return.GRIDinv_subaw_return", {
  extend: "Ext.form.Panel",
  alias: "widget.GRIDinv_subaw_return",
  reference: "GRIDinv_subaw_return",
  frame: false,
  border: false,
  autoScroll: true,
  ...
  listeners: {
    afterrender: "GRIDinv_subaw_return_load",
  },
});
