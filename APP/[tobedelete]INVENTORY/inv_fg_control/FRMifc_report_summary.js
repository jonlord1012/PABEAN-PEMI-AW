...
Ext.define("TDK.INVENTORY.inv_fg_control.FRMifc_report_summary", {
  extend: "Ext.window.Window",
  alias: "widget.FRMifc_report_summary",
  reference: "FRMifc_report_summary",
    ...
    items: [
    {
      ...
      store: {
        ...
        proxy: {
          ...
          url: vconfig.service_api + "ifc_report_summary/ifc_report_summarys",
          extraParams: {
            method: "read_data",
          },
          reader: {
        ...
        listeners: {
          beforeload: function (store, operation, eOpts) {
            try {
              var VIDCOMPANY = Ext.ComponentQuery.query("FRMifc_report_summary combobox[name=CBO_COMPANY]")[0];
              var VPARTGROUP = Ext.ComponentQuery.query("FRMifc_report_summary combobox[name=CBO_PARTGROUP]")[0];
              var VFROMDATE = Ext.ComponentQuery.query("FRMifc_report_summary monthfield[name=tfromdate]")[0];
              var VTODATE = Ext.ComponentQuery.query("FRMifc_report_summary monthfield[name=ttodate]")[0];
  ...
  dockedItems: [
    {
      ...
      items: [
        ...
        { xtype: "button", text: "Refresh", pid: "FRMifc_report_summary_btrefresh", icon: vconfig.getstyle + "icon/update.ico", tooltip: "Refresh Data" },
        "-",
        {
          xtype: "combobox",
          name: "CBO_COMPANY",
        ...
        "-",
        {
          ...
          items: [
            ...
            {
              xtype: "button",
              pid: "FRMifc_report_summary_btsearch",
              icon: vconfig.getstyle + "icon/search.ico",
              tooltip: "search",
              handler: "FRMifc_report_summary_btsearch"
            },
          ],
        },
        "->",
