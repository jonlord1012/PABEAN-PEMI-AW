...
Ext.define("TDK.INVENTORY.inv_fg_control.FRMifc_list_memo_scrap", {
  extend: "Ext.window.Window",
  alias: "widget.FRMifc_list_memo_scrap",
  reference: "FRMifc_list_memo_scrap",
  title: "Memo Scrap",
  modal: true,
  closeAction: "hide",
  centered: true,
  ...
  dockedItems: [
    {
      ...
      items: [
        ...
        { xtype: "button", text: "Refresh", pid: "FRMifc_list_memo_scrap_btrefresh", icon: vconfig.getstyle + "icon/update.ico", tooltip: "Refresh Data" },
      ],
    },
  ],
  listeners: {
