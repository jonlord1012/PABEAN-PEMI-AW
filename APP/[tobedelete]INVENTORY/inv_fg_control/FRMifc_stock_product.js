...
Ext.define("TDK.INVENTORY.inv_fg_control.FRMifc_stock_product", {
  extend: "Ext.window.Window",
  alias: "widget.FRMifc_stock_product",
  reference: "FRMifc_stock_product",
  title: "Stock Product",
  modal: true,
  closeAction: "hide",
  centered: true,
  ...
  dockedItems: [
    {
      ...
      items: [
        ...
        { xtype: "button", text: "Refresh", pid: "FRMifc_stock_product_btrefresh", icon: vconfig.getstyle + "icon/update.ico", tooltip: "Refresh Data" },
      ],
    },
  ],
  listeners: {
