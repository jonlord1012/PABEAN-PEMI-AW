Ext.define("TDK.INVENTORY.inv_fg_control.inv_fg_control", {
  extend: "Ext.form.Panel",
  alias: "widget.inv_fg_control",
  reference: "inv_fg_control",
  config: {},
  requires: [
    //
    ...
    "TDK.INVENTORY.inv_fg_control.Cinv_fg_control",
  ],
