...
Ext.define("TDK.INVENTORY.inv_fg_in.FRMinv_fg_in_pis", {
  extend: "Ext.window.Window",
  alias: "widget.FRMinv_fg_in_pis",
  reference: "FRMinv_fg_in_pis",
          ...
          store: {
            ...
            listeners: {
              beforeload: function (store, operation, eOpts) {
                try {
                  var vdate = Ext.ComponentQuery.query("FRMinv_fg_in_pis datefield[name=TANGGAL_RCV]")[0];
                  operation.setParams({
