Ext.define("TDK.INVENTORY.inv_fg_in.dokumen_detail_fgin.dokumen_detail_fgin_detail", {
  extend: "Ext.form.Panel",
  alias: "widget.dokumen_detail_fgin_detail",
  reference: "dokumen_detail_fgin_detail",
  frame: false,
  border: true,
  autoScroll: true,
  ...
  items: [
    {
      xtype: "grid",
      pid: "GRIDdokumen_detail_fgin_detail",
