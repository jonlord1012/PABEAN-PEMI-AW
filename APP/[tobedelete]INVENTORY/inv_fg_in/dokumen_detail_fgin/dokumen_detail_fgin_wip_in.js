Ext.define("TDK.INVENTORY.inv_fg_in.dokumen_detail_fgin.dokumen_detail_fgin_wip_in", {
  extend: "Ext.form.Panel",
  alias: "widget.dokumen_detail_fgin_wip_in",
  reference: "dokumen_detail_fgin_wip_in",
  frame: false,
  border: true,
  autoScroll: true,
  ...
  items: [
    {
      xtype: "grid",
      pid: "GRIDdokumen_detail_fgin_wip_in",
