Ext.define("TDK.INVENTORY.inv_fg_in.dokumen_detail_fgin.dokumen_detail_fgin_bom", {
  extend: "Ext.form.Panel",
  alias: "widget.dokumen_detail_fgin_bom",
  reference: "dokumen_detail_fgin_bom",
  frame: false,
  border: true,
  autoScroll: true,
  ...
  items: [
    {
      xtype: "grid",
      pid: "GRIDdokumen_detail_fgin_bom",
