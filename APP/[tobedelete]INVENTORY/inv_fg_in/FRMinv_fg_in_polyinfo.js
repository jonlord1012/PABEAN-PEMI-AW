...
Ext.define("TDK.INVENTORY.inv_fg_in.FRMinv_fg_in_polyinfo", {
  extend: "Ext.window.Window",
  alias: "widget.FRMinv_fg_in_polyinfo",
  reference: "FRMinv_fg_in_polyinfo",
  ...
  items: [
    {
      ...
      items: [
        {
          xtype: "grid",
          pid: "GRIDFRMinv_fg_in_polyinfo_header",
    ...
    },
    {
      ...
      items: [
        {
          xtype: "grid",
          pid: "GRIDFRMinv_fg_in_polyinfo_detail",
          emptyText: "No Matching Records",
          autoScroll: true,
          flex: 1,
          plugins: ["filterfield"],
  ...
  listeners: {
    afterlayout: function (cmp) {
      try {
        ...
        var GRIDheader = cmp.query("grid[pid=GRIDFRMinv_fg_in_polyinfo_header]")[0];
        GRIDheader.getStore().load();

        var GRIDdetail = cmp.query("grid[pid=GRIDFRMinv_fg_in_polyinfo_detail]")[0];
