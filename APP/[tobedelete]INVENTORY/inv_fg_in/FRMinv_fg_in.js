...
Ext.define("TDK.INVENTORY.inv_fg_in.FRMinv_fg_in", {
  extend: "Ext.window.Window",
  alias: "widget.FRMinv_fg_in",
  reference: "FRMinv_fg_in",
  ...
  dockedItems: [
    {
      ...
      items: [
        { xtype: "tbspacer", width: 10 },
        {
          xtype: "button",
          text: "Save",
          pid: "FRMinv_fg_in_btsave",
          icon: vconfig.getstyle + "icon/save.gif",
          tooltip: "Save Data",
          handler: "FRMinv_fg_in_btsave_click",
        },
      ],
    },
  ],
