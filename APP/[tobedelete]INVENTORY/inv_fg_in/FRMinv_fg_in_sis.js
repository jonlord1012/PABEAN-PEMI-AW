...
Ext.define("TDK.INVENTORY.inv_fg_in.FRMinv_fg_in_sis", {
  extend: "Ext.window.Window",
  alias: "widget.FRMinv_fg_in_sis",
  reference: "FRMinv_fg_in_sis",
          ...
          store: {
            ...
            listeners: {
              beforeload: function (store, operation, eOpts) {
                try {
                  var vdate = Ext.ComponentQuery.query("FRMinv_fg_in_sis datefield[name=TANGGAL_RCV]")[0];
                  operation.setParams({
